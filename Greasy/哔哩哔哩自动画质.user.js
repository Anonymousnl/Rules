...
- 触控设备: ${pointerType.isTouchDevice}`);
			if(pointerType.isMouseDevice && !pointerType.isTouchDevice) {
				...
				console.log(`[系统设置] 保留 maxTouchPoints 原值: ${navigator.maxTouchPoints}，原因: ` + `${pointerType.isTouchDevice ? "检测到触控设备" : "无精确鼠标指针"}`);
			}
		}
	} catch (error) {
...
`);
	...
	function createSettingsPanel() {
		...
		panel.innerHTML = `
<h2>画质设置</h2>
<a href="https://github.com/Anonymousnl/Rules/tree/master/Greasy" target="_blank" class="github-link">
