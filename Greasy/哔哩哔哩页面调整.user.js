...
// @downloadURL https://github.com/Anonymousnl/Rules/raw/master/Greasy/%E5%93%94%E5%93%A9%E5%93%94%E5%93%A9%E9%A1%B5%E9%9D%A2%E8%B0%83%E6%95%B4.user.js
// @updateURL   https://github.com/Anonymousnl/Rules/raw/master/Greasy/%E5%93%94%E5%93%A9%E5%93%94%E5%93%A9%E9%A1%B5%E9%9D%A2%E8%B0%83%E6%95%B4.user.js
// ==/UserScript==
...
<style bili-cleaner-css="${v.className}">${v.css}</style>`;
	...
	const shadow = new Shadow(["bili-comments-header-renderer",
...
`
		...
		const commentItems = [
			...
			new CheckboxItem({
				...
				enableFunc: async () => {
					let origValue = _unsafeWindow.__INITIAL_STATE__;
					if(origValue == null ? void 0 : origValue.abtest) {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comments-header-renderer", "video-page-hide-top-vote-card", `#vote {display: none !important;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comments-header-renderer", "video-page-hide-reply-notice", `#notice {display: none !important;}`);
				},
				disableFunc: () => {
...
.comment-container .reply-list {margin-top: -20px !important;}`,
				enableFunc: () => {
					shadow.register("bili-comments-header-renderer", "video-page-hide-main-reply-box", `#commentbox bili-comment-box {display: none !important;}
...
.fixed-reply-box .reply-box-textarea::placeholder {color: transparent !important; user-select: none;}`,
				enableFunc: () => {
					shadow.register("bili-comment-textarea", "video-page-hide-reply-box-textarea-placeholder", `textarea:not([placeholder^="回复"])::placeholder {color: transparent !important; user-select: none;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comments-header-renderer", "video-page-hide-fixed-reply-box", `.bili-comments-bottom-fixed-wrapper {display: none !important;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-user-profile", "video-page-hide-comment-user-card", `#wrap {display: none !important;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comment-renderer", "video-page-hide-reply-decorate", `#ornament {display: none !important;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comment-user-medal", "video-page-hide-contractor-box", `#contractor {display: none !important;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comment-user-info", "video-page-hide-user-level", `#user-level {display: none !important;}
...
.comment-container .root-reply-avatar .bili-avatar {width: 48px !important; height:48px !important;}`,
				enableFunc: () => {
					shadow.register("bili-avatar", "video-page-hide-bili-avatar-pendent-dom", `.layer.center[style*="66px"] {display: none !important;}`);
				},
				disableFunc: () => {
...
.comment-container .bili-avatar-icon {display: none !important;}`,
				enableFunc: () => {
					shadow.register("bili-avatar", "video-page-hide-bili-avatar-nft-icon", `.layer:not(.center) {display: none !important;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comment-renderer", "video-page-hide-vote-info", `bili-comment-vote-option {display: none !important;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comment-renderer", "video-page-hide-reply-tag-list", `#tags {display: none !important;}`);
				},
				disableFunc: () => {
...
.comment-container .reply-content .icon.search-word {display: none !important;}`,
				enableFunc: () => {
					shadow.register("bili-rich-text", "video-page-hide-jump-link-search-word", `#contents a[href*="search.bilibili.com"] {color: inherit !important;}
...
.comment-container .sub-reply-container .reply-content .jump-link.user:hover {color: #40C5F1 !important;}`,
				enableFunc: () => {
					shadow.register("bili-rich-text", "video-page-hide-reply-content-user-highlight", `#contents a[href*="space.bilibili.com"] {color: inherit !important;}
...
animation-fill-mode: forwards;
				...
				enableFunc: () => {
					shadow.register("bili-comment-renderer", "video-page-hide-root-reply-dislike-reply-btn", `#body {
--bili-comment-hover-more-display: 0 !important;
}
#body:hover {
--bili-comment-hover-more-display: 1 !important;
}`);
					shadow.register("bili-comment-action-buttons-renderer", "video-page-hide-root-reply-dislike-reply-btn", `#dislike button, #reply button, #more button {
...
animation-fill-mode: forwards;
				...
				enableFunc: () => {
					shadow.register("bili-comment-reply-renderer", "video-page-hide-sub-reply-dislike-reply-btn", `
#body {
--bili-comment-hover-more-display: 0 !important;
}
#body:hover {
--bili-comment-hover-more-display: 1 !important;
					...
					shadow.register("bili-comment-action-buttons-renderer", "video-page-hide-sub-reply-dislike-reply-btn", `#dislike button, #reply button, #more button {
display: block !important;
opacity: var(--bili-comment-action-buttons-more-display);
transition: opacity 0.2s 0.3s;
}`);
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-rich-text", "video-page-hide-emoji-large", `#contents img:is(.emoji-large, [style^="width:50px"]) {display: none !important;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-rich-text", "video-page-hide-emoji-large-zoom", `#contents img:is(.emoji-large, [style^="width:50px"]) {zoom: 0.5 !important;}`);
				},
				disableFunc: () => {
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comment-user-info", "video-page-reply-user-name-color-pink", `#user-name {color: #FB7299 !important;}
#user-name a {color: #FB7299 !important;}`);
			...
			new CheckboxItem({
				...
				enableFunc: () => {
					shadow.register("bili-comment-user-info", "video-page-reply-user-name-color-default", `#user-name {color: #61666d !important;}
...
.reply-view-image .preview-list {display: none !important;}`,
				enableFunc: () => {
					shadow.register("bili-photoswipe", "video-page-reply-view-image-optimize", `#wrap:has(#thumb:empty) :is(#prev, #next) {display: none !important;}
#prev, #next {zoom: 1.3;}
...
<button class="wordlist-close-button">关闭</button>
	...
	if(isPageHomepage()) {
		...
		videoPubdateFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$8.black.pubdate.valueKey}`, 0));
		...
		const checkVideoList = async (fullSite) => {
			...
			try {
				...
				let rcmdVideos;
				if(!fullSite) {
					feedVideos = Array.from(vlc.querySelectorAll(`:scope > .feed-card:not([${settings.filterSign}]):has(.bili-video-card__wrap)`));
					rcmdVideos = Array.from(vlc.querySelectorAll(`:scope > .bili-video-card:not([${settings.filterSign}]):has(.bili-video-card__wrap)`));
				} else {
					feedVideos = Array.from(vlc.querySelectorAll(`:scope > .feed-card:has(.bili-video-card__wrap)`));
					rcmdVideos = Array.from(vlc.querySelectorAll(`:scope > .bili-video-card:has(.bili-video-card__wrap)`));
				}
				const blackPairs = [];
		...
		const uploaderItems = [
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$8.black.uploader.valueKey, "UP主 黑名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$8.black.uploaderKeyword.valueKey, "UP主昵称关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
		...
		const titleItems = [
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$8.black.title.valueKey, "标题关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
		...
		homepagePageVideoFilterGroupList.push(new Group("homepage-title-keyword-filter-group", "首页 标题关键词过滤", titleItems));
		const bvidItems = [
			// 启用 首页 BV号过滤
			new CheckboxItem({
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$8.black.bvid.valueKey, "BV号 黑名单", `每行一个BV号，保存时自动去重`,
						(values) => {
		...
		const pubdateItems = [
			// 启用 发布日期过滤
			new CheckboxItem({
				itemID: GM_KEYS$8.black.pubdate.statusKey,
			...
			// 设定发布日期阈值
			new NumberItem({
				itemID: GM_KEYS$8.black.pubdate.valueKey,
		...
		const whitelistItems = [
			// 标有 [已关注] 的视频免过滤
			new CheckboxItem({
				itemID: GM_KEYS$8.white.isFollow.statusKey,
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$8.white.uploader.valueKey, "UP主 白名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$8.white.title.valueKey, "标题关键词 白名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
	...
	if(isPagePopular()) {
		...
		const videoUploaderFilter = new VideoUploaderFilter();
		videoUploaderFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$7.black.uploader.valueKey}`, []));
		const videoUploaderKeywordFilter = new VideoUploaderKeywordFilter();
		videoUploaderKeywordFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$7.black.uploaderKeyword.valueKey}`, []));
		const videoQualityFilter = new VideoQualityFilter();
		videoQualityFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$7.black.quality.valueKey}`, 0));
		const videoDimensionFilter = new VideoDimensionFilter();
		const videoUploaderWhiteFilter = new VideoUploaderWhiteFilter();
		videoUploaderWhiteFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$7.white.uploader.valueKey}`, []));
		const videoTitleWhiteFilter = new VideoTitleWhiteFilter();
					...
					if(isContextMenuUploaderEnable && (target.classList.contains("up-name__text") || target.classList.contains("up-name"))) {
						...
						if(uploader) {
							...
							menu.registerMenu(`◎ 屏蔽UP主：${uploader}`, () => {
								...
								try {
									const arr = _GM_getValue(`BILICLEANER_${GM_KEYS$7.black.uploader.valueKey}`, []);
									if(!arr.includes(uploader)) {
										arr.unshift(uploader);
										_GM_setValue(`BILICLEANER_${GM_KEYS$7.black.uploader.valueKey}`, arr);
									}
								} catch (err) {
									error("contextMenuFunc addParam error", err);
								}
							...
							menu.registerMenu(`◎ 将UP主加入白名单`, () => {
								...
								check(true).then().catch();
								try {
									const arr = _GM_getValue(`BILICLEANER_${GM_KEYS$7.white.uploader.valueKey}`, []);
									if(!arr.includes(uploader)) {
										arr.unshift(uploader);
										_GM_setValue(`BILICLEANER_${GM_KEYS$7.white.uploader.valueKey}`, arr);
									}
								} catch (err) {
									error("contextMenuFunc addParam error", err);
								}
		...
		const qualityItems = [
			new CheckboxItem({
				itemID: GM_KEYS$7.black.dimension.statusKey,
			...
			new CheckboxItem({
				itemID: GM_KEYS$7.black.quality.statusKey,
			...
			new NumberItem({
				itemID: GM_KEYS$7.black.quality.valueKey,
		...
		const uploaderItems = [
			// 启用 热门页UP主过滤, 默认开启
			new CheckboxItem({
				itemID: GM_KEYS$7.black.uploader.statusKey,
				description: "启用 UP主过滤 (右键单击UP主)",
				defaultStatus: true,
				enableFunc: () => {
					isContextMenuUploaderEnable = true;
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$7.black.uploader.valueKey, "UP主 黑名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
							videoUploaderFilter.setParam(values);
							check(true).then().catch();
						}).show();
			...
			// 启用 UP主昵称关键词过滤
			new CheckboxItem({
				itemID: GM_KEYS$7.black.uploaderKeyword.statusKey,
				description: "启用 UP主昵称关键词过滤",
				enableFunc: () => {
					videoUploaderKeywordFilter.enable();
					check(true).then().catch();
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$7.black.uploaderKeyword.valueKey, "UP主昵称关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoUploaderKeywordFilter.setParam(values);
							check(true).then().catch();
		...
		const titleItems = [
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$7.black.title.valueKey, "标题关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleFilter.setParam(values);
							check(true).then().catch();
		...
		popularPageVideoFilterGroupList.push(new Group("popular-title-keyword-filter-group", "热门页 标题关键词过滤", titleItems));
		const bvidItems = [
			// 启用 热门页 BV号过滤
			new CheckboxItem({
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$7.black.bvid.valueKey, "BV号 黑名单", `每行一个BV号，保存时自动去重`,
						(values) => {
							videoBvidFilter.setParam(values);
							check(true).then().catch();
						}).show();
		...
		const whitelistItems = [
			// 启用 UP主白名单
			new CheckboxItem({
				itemID: GM_KEYS$7.white.uploader.statusKey,
				description: "启用 UP主白名单",
				enableFunc: () => {
					videoUploaderWhiteFilter.enable();
					check(true).then().catch();
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$7.white.uploader.valueKey, "UP主 白名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
							videoUploaderWhiteFilter.setParam(values);
							check(true).then().catch();
						}).show();
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$7.white.title.valueKey, "标题关键词 白名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleWhiteFilter.setParam(values);
							check(true).then().catch();
	...
	if(isPageSpace()) {
		const videoBvidFilter = new VideoBvidFilter();
		videoBvidFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$6.black.bvid.valueKey}`, []));
		const videoDurationFilter = new VideoDurationFilter();
		videoDurationFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$6.black.duration.valueKey}`, 0));
		const videoTitleFilter = new VideoTitleFilter();
		videoTitleFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$6.black.title.valueKey}`, []));
		const videoTitleWhiteFilter = new VideoTitleWhiteFilter();
		videoTitleWhiteFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$6.white.title.valueKey}`, []));
		const selectorFns = {
			duration: (video) => {
				var _a, _b;
		...
		const checkVideoList = async (_fullSite) => {
			...
			try {
				...
				if(/^\/\d+\/channel\/(collectiondetail|seriesdetail)/.test(location.pathname)) {
					videos = Array.from(vlc.querySelectorAll(`:is(#page-collection-detail,#page-series-detail) li.small-item`));
				}
				if(videos.length) {
					const blackPairs = [];
					videoBvidFilter.isEnable && blackPairs.push([videoBvidFilter, selectorFns.bvid]);
						...
						if(href2) {
							...
							if(bvid) {
								...
								menu.registerMenu(`◎ 屏蔽视频 ${bvid}`, () => {
									...
									check();
									try {
										const arr = _GM_getValue(`BILICLEANER_${GM_KEYS$6.black.bvid.valueKey}`, []);
										if(!arr.includes(bvid)) {
											arr.unshift(bvid);
											_GM_setValue(`BILICLEANER_${GM_KEYS$6.black.bvid.valueKey}`, arr);
										}
									} catch (err) {
										error("contextMenuFunc addParam error", err);
									}
		...
		const titleItems = [
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$6.black.title.valueKey, "标题关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleFilter.setParam(values);
							check();
		...
		spacePageVideoFilterGroupList.push(new Group("space-title-keyword-filter-group", "分区页 标题关键词过滤", titleItems));
		const bvidItems = [
			// 启用 分区页 BV号过滤
			new CheckboxItem({
				itemID: GM_KEYS$6.black.bvid.statusKey,
				description: "启用 BV号过滤 (右键单击标题)",
				enableFunc: () => {
					isContextMenuBvidEnable = true;
					contextMenuFunc();
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$6.black.bvid.valueKey, "BV号 黑名单", `每行一个BV号，保存时自动去重`,
						(values) => {
							videoBvidFilter.setParam(values);
							check();
						}).show();
		...
		const whitelistItems = [
			// 启用 标题关键词白名单
			new CheckboxItem({
				itemID: GM_KEYS$6.white.title.statusKey,
				description: "启用 标题关键词白名单",
				enableFunc: () => {
					videoTitleWhiteFilter.enable();
					check();
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$6.white.title.valueKey, "标题关键词 白名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleWhiteFilter.setParam(values);
							check();
		...
		spacePageVideoFilterGroupList.push(new Group("space-whitelist-filter-group", "分区页 白名单设定 (免过滤)", whitelistItems));
	}
...
.reply-view-image .preview-list {display: none !important;}`
	...
	if(isPageDynamic() || isPageSpace()) {
		...
		dynUploaderFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$5.black.uploader.valueKey}`, []));
		const dynDurationFilter = new DynDurationFilter();
		dynDurationFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$5.black.duration.valueKey}`, 0));
		const dynVideoTitleFilter = new DynVideoTitleFilter();
		dynVideoTitleFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$5.black.title.valueKey}`, []));
						...
						if(document.querySelector(".bili-dyn-list-tabs")) {
							...
							if(uploader) {
								...
								menu.registerMenu(`隐藏用户动态：${uploader}`, () => {
									...
									check(true);
									try {
										const arr = _GM_getValue(`BILICLEANER_${GM_KEYS$5.black.uploader.valueKey}`,
											[]);
										if(!arr.includes(uploader)) {
											arr.unshift(uploader);
											_GM_setValue(`BILICLEANER_${GM_KEYS$5.black.uploader.valueKey}`, arr);
										}
									} catch (err) {
										error("contextMenuFunc addParam error", err);
									}
		...
		const checkDynList = async (fullSite) => {
			...
			try {
				...
				if(fullSite) {
					...
					dyns = Array.from(dynListContainer.querySelectorAll(`.bili-dyn-list__item:not([${settings.filterSign}])`));
				}
				if(dyns.length) {
					const blackPairs = [];
		...
		const uploaderItems = [
			// 启用 动态页 用户名过滤
			new CheckboxItem({
				itemID: GM_KEYS$5.black.uploader.statusKey,
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$5.black.uploader.valueKey, "隐藏动态 用户名列表", "每行一个用户名，保存时自动去重",
						(values) => {
		...
		const durationItems = [
			// 启用 动态页时长过滤
			new CheckboxItem({
				itemID: GM_KEYS$5.black.duration.statusKey,
				description: "启用 时长过滤",
				enableFunc: () => {
			...
			// 设定最低时长
			new NumberItem({
				itemID: GM_KEYS$5.black.duration.valueKey,
				description: "设定最低时长 (0~300s)",
				defaultValue: 60,
				minValue: 0,
				maxValue: 300,
		...
		const titleItems = [
			// 启用 视频标题 关键词过滤
			new CheckboxItem({
				itemID: GM_KEYS$5.black.title.statusKey,
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$5.black.title.valueKey, "标题关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
	...
	const isCommentV2 = () => {
		var _a, _b;
		if(!isV2) {
			isV2 = ((_b = (_a = _unsafeWindow.__INITIAL_STATE__) == null ? void 0 : _a.abtest) == null ? void 0 : _b.comment_next_version) === "ELEMENTS";
		}
		return isV2;
	};
	const GM_KEYS$4 = {
	...
	if(isPageVideo() || isPageBangumi() || isPagePlaylist()) {
		const bots = [
			...
			// 473018527 @AI视频总结
			// 3546639035795567 @AI总结视频
			"机器工具人", "有趣的程序员", "AI视频小助理", "AI视频小助理总结一下", "AI笔记侠", "AI视频助手", "哔哩哔理点赞姬", "课代表猫", "AI课代表呀", "木几萌Moe", "星崽丨StarZai", "AI沈阳美食家",
			// 'AI识片酱', // 听歌识曲，免除过滤
			"AI头脑风暴", "GPT_5", "Juice_AI", "AI全文总结", "AI视频总结", "AI总结视频"
		];
			...
			try {
				...
				if(isCommentV2()) {
					...
					if(fullSite) {
						...
						rootComments = Array.from(shadowRoot.querySelectorAll(`bili-comment-thread-renderer:not([${settings.filterSign}])`));
						rootComments.forEach((c) => {
							var _a2, _b, _c;
							const replies = (_c = (_b = (_a2 = c.shadowRoot) == null ? void 0 : _a2.querySelector("bili-comment-replies-renderer")) == null ? void 0 : _b.shadowRoot) == null ? void 0 : _c.querySelectorAll(`bili-comment-reply-renderer:not([${settings.filterSign}])`);
							if(replies == null ? void 0 : replies.length) {
								subComments = subComments.concat(Array.from(replies));
							}
						});
					...
					if(fullSite) {
						...
						rootComments = Array.from(document.querySelectorAll(`.reply-item:not([${settings.filterSign}])`));
						subComments = Array.from(document.querySelectorAll(`.sub-reply-item:not(.jump-link.user):not([${settings.filterSign}])`));
					}
				}
						...
						if(target && isContextMenuUsernameEnable$1 && (((_a = target.parentElement) == null ? void 0 : _a.id) === "user-name" || target.classList.contains("user-name") || target.classList.contains("sub-user-name"))) {
							...
							if(username) {
								...
								menu.registerMenu(`屏蔽用户：${username}`, () => {
									...
									check(true);
									try {
										const arr = _GM_getValue(`BILICLEANER_${GM_KEYS$4.black.username.valueKey}`,
											[]);
		...
		const usernameItems = [
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$4.black.username.valueKey, "用户名 黑名单", "每行一个用户名，保存时自动去重",
						(values) => {
		...
		const contentItems = [
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$4.black.content.valueKey, "评论关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
		...
		videoPageCommentFilterGroupList.push(new Group("comment-level-filter-whitelist-group", "评论区 等级过滤", levelItems));
		const whitelistItems = [
			// 一级评论 免过滤
			new CheckboxItem({
			...
			// 含超链接的评论 免过滤, 默认开启
			new CheckboxItem({
				itemID: GM_KEYS$4.white.isTLink.statusKey,
	...
	if(isPageDynamic() || isPageSpace()) {
		const bots = [
			...
			// 473018527 @AI视频总结
			// 3546639035795567 @AI总结视频
			"机器工具人", "有趣的程序员", "AI视频小助理", "AI视频小助理总结一下", "AI笔记侠", "AI视频助手", "哔哩哔理点赞姬", "课代表猫", "AI课代表呀", "木几萌Moe", "星崽丨StarZai", "AI沈阳美食家", "AI识片酱", "AI头脑风暴", "GPT_5", "Juice_AI", "AI全文总结", "AI视频总结", "AI总结视频"
		];
		const commentUsernameFilter = new CommentUsernameFilter();
		commentUsernameFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$3.black.username.valueKey}`, []));
		const commentContentFilter = new CommentContentFilter();
		commentContentFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$3.black.content.valueKey}`, []));
		const commentLevelFilter = new CommentLevelFilter();
		commentLevelFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$3.black.level.valueKey}`, 0));
		const commentBotFilter = new CommentBotFilter();
		commentBotFilter.setParam(bots);
		const commentCallBotFilter = new CommentCallBotFilter();
		commentCallBotFilter.setParam(bots);
						...
						if(target && isContextMenuUsernameEnable && (((_a = target.parentElement) == null ? void 0 : _a.id) === "user-name" || target.classList.contains("user-name") || target.classList.contains("sub-user-name"))) {
							...
							if(username) {
								...
								menu.registerMenu(`屏蔽用户：${username}`, () => {
									...
									check(true);
									try {
										const arr = _GM_getValue(`BILICLEANER_${GM_KEYS$3.black.username.valueKey}`,
											[]);
										if(!arr.includes(username)) {
											arr.unshift(username);
											_GM_setValue(`BILICLEANER_${GM_KEYS$3.black.username.valueKey}`, arr);
										}
									} catch (err) {
										error("contextMenuFunc addParam error", err);
									}
		...
		const usernameItems = [
			// 启用 评论区 用户名过滤
			new CheckboxItem({
				itemID: GM_KEYS$3.black.username.statusKey,
				description: "启用 评论区 用户名过滤\n(右键单击用户名)",
				enableFunc: () => {
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$3.black.username.valueKey, "用户名 黑名单", "每行一个用户名，保存时自动去重",
						(values) => {
							commentUsernameFilter.setParam(values);
							check(true);
						}).show();
		...
		const contentItems = [
			// 启用 动态页关键词过滤
			new CheckboxItem({
				itemID: GM_KEYS$3.black.content.statusKey,
				description: "启用 评论区 关键词过滤",
				enableFunc: () => {
					commentContentFilter.enable();
					check(true);
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$3.black.content.valueKey, "评论关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							commentContentFilter.setParam(values);
							check(true);
		...
		const typeItems = [
			// 过滤 召唤AI的评论
			new CheckboxItem({
				itemID: GM_KEYS$3.black.callBot.statusKey,
				description: "过滤 召唤AI的评论",
				defaultStatus: true,
				enableFunc: () => {
					commentCallBotFilter.enable();
			...
			// 过滤 AI发布的评论
			new CheckboxItem({
				itemID: GM_KEYS$3.black.bot.statusKey,
				description: "过滤 AI发布的评论",
				enableFunc: () => {
					commentBotFilter.enable();
					check(true);
			...
			// 过滤 @其他用户的评论
			new CheckboxItem({
				itemID: GM_KEYS$3.black.callUser.statusKey,
				description: "过滤 @其他用户的评论",
				enableFunc: () => {
					commentCallUserFilter.enable();
					check(true);
		...
		const levelItems = [
			// 启用 动态页等级过滤
			new CheckboxItem({
				itemID: GM_KEYS$3.black.level.statusKey,
				description: "启用 用户等级过滤",
				enableFunc: () => {
					commentLevelFilter.enable();
					check(true);
			...
			// 设定最低等级
			new NumberItem({
				itemID: GM_KEYS$3.black.level.valueKey,
				description: "设定最低等级 (0~6)",
				defaultValue: 3,
				minValue: 0,
				maxValue: 6,
		...
		dynamicPageCommentFilterGroupList.push(new Group("comment-level-filter-whitelist-group", "评论区 等级过滤", levelItems));
		const whitelistItems = [
			// 一级评论 免过滤
			new CheckboxItem({
				itemID: GM_KEYS$3.white.root.statusKey,
				description: "一级评论(主评论) 免过滤",
				enableFunc: () => {
					isRootWhite = true;
					check(true);
			...
			// 二级评论 免过滤
			new CheckboxItem({
				itemID: GM_KEYS$3.white.sub.statusKey,
				description: "二级评论(回复) 免过滤",
				enableFunc: () => {
					isSubWhite = true;
					check(true);
			...
			// UP主的评论 免过滤, 默认开启
			new CheckboxItem({
				itemID: GM_KEYS$3.white.isUp.statusKey,
				description: "UP主的评论 免过滤",
				defaultStatus: true,
				enableFunc: () => {
					commentIsUpFilter.enable();
			...
			// 置顶评论 免过滤, 默认开启
			new CheckboxItem({
				itemID: GM_KEYS$3.white.isPin.statusKey,
				description: "置顶评论 免过滤",
				defaultStatus: true,
				enableFunc: () => {
					commentIsPinFilter.enable();
			...
			// 笔记评论 免过滤, 默认开启
			new CheckboxItem({
				itemID: GM_KEYS$3.white.isNote.statusKey,
				description: "笔记/图片评论 免过滤",
				defaultStatus: true,
				enableFunc: () => {
					commentIsNoteFilter.enable();
			...
			// 含超链接的评论 免过滤, 默认开启
			new CheckboxItem({
				itemID: GM_KEYS$3.white.isTLink.statusKey,
				description: "含超链接的评论 免过滤\n（站内视频/URL）",
				defaultStatus: true,
				enableFunc: () => {
					commentIsLinkFilter.enable();
	...
	if(isPageVideo() || isPageBangumi() || isPagePlaylist()) {
		...
		const checkVideoList = async (_fullSite) => {
			...
			try {
				const nextVideos = Array.from(videoListContainer.querySelectorAll(`.next-play :is(.video-page-card-small, .video-page-operator-card-small)`));
				const rcmdVideos = Array.from(videoListContainer.querySelectorAll(`.rec-list :is(.video-page-card-small, .video-page-operator-card-small), .recommend-video-card`));
				const blackPairs = [];
				videoBvidFilter.isEnable && blackPairs.push([videoBvidFilter, selectorFns.bvid]);
				videoDurationFilter.isEnable && blackPairs.push([videoDurationFilter, selectorFns.duration]);
				videoTitleFilter.isEnable && blackPairs.push([videoTitleFilter, selectorFns.title]);
				...
				debugVideoFilter(`check ${nextVideos.length} next, ${rcmdVideos.length} rcmd videos`);
			} catch (err) {
				error("checkVideoList error", err);
			}
		};
...
`);
				...
				rightList.forEach((video2) => {
					var _a, _b;
					if(isEleHide(video2)) {
						const title = (_b = (_a = video2.querySelector(".info > a p")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim();
			...
			video.ended ? check2() : video.addEventListener("ended", check2);
		};
		let isContextMenuFuncRunning2 = false;
		let isContextMenuUploaderEnable = false;
		let isContextMenuBvidEnable = false;
		...
		const uploaderItems = [
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$2.black.uploader.valueKey, "UP主 黑名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
							videoUploaderFilter.setParam(values);
							check();
						}).show();
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$2.black.uploaderKeyword.valueKey, "UP主昵称关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoUploaderKeywordFilter.setParam(values);
							check();
		...
		const titleItems = [
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$2.black.title.valueKey, "标题关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleFilter.setParam(values);
							check();
		...
		videoPageVideoFilterGroupList.push(new Group("video-title-keyword-filter-group", "播放页 标题关键词过滤", titleItems));
		const bvidItems = [
			// 启用 播放页 BV号过滤
			new CheckboxItem({
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$2.black.bvid.valueKey, "BV号 黑名单", `每行一个BV号，保存时自动去重`,
						(values) => {
							videoBvidFilter.setParam(values);
							check();
						}).show();
		...
		const whitelistItems = [
			// 接下来播放 免过滤
			new CheckboxItem({
				itemID: GM_KEYS$2.white.isNext.statusKey,
			...
			// 视频播放结束推荐 免过滤
			new CheckboxItem({
				itemID: GM_KEYS$2.white.isEnding.statusKey,
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$2.white.uploader.valueKey, "UP主 白名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
							videoUploaderWhiteFilter.setParam(values);
							check();
						}).show();
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$2.white.title.valueKey, "标题关键词 白名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleWhiteFilter.setParam(values);
							check();
	...
	if(isPageChannel()) {
		...
		const videoPubdateFilter = new VideoPubdateFilter();
		videoPubdateFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS$1.black.pubdate.valueKey}`, 0));
		const videoUploaderFilter = new VideoUploaderFilter();
		...
		const uploaderItems = [
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$1.black.uploader.valueKey, "UP主 黑名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
							videoUploaderFilter.setParam(values);
							check(true);
						}).show();
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS$1.black.uploaderKeyword.valueKey, "UP主昵称关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoUploaderKeywordFilter.setParam(values);
							check(true);
		...
		const titleItems = [
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$1.black.title.valueKey, "标题关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleFilter.setParam(values);
							check(true);
		...
		channelPageVideoFilterGroupList.push(new Group("channel-title-keyword-filter-group", "分区页 标题关键词过滤", titleItems));
		const bvidItems = [
			// 启用 分区页 BV号过滤
			new CheckboxItem({
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$1.black.bvid.valueKey, "BV号 黑名单", `每行一个BV号，保存时自动去重`,
						(values) => {
							videoBvidFilter.setParam(values);
							check(true);
						}).show();
		...
		const pubdateItems = [
			// 启用 发布日期过滤
			new CheckboxItem({
				itemID: GM_KEYS$1.black.pubdate.statusKey,
				description: "启用 发布日期过滤",
				enableFunc: () => {
					videoPubdateFilter.enable();
					check(true);
			...
			// 设定发布日期阈值
			new NumberItem({
				itemID: GM_KEYS$1.black.pubdate.valueKey,
				description: "视频发布日 距今不超过",
				defaultValue: 60,
				minValue: 1,
				maxValue: 365,
		...
		const whitelistItems = [
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$1.white.uploader.valueKey, "UP主 白名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
							videoUploaderWhiteFilter.setParam(values);
							check(true);
						}).show();
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS$1.white.title.valueKey, "标题关键词 白名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleWhiteFilter.setParam(values);
							check(true);
		...
		channelPageVideoFilterGroupList.push(new Group("channel-whitelist-filter-group", "分区页 白名单设定 (免过滤)", whitelistItems));
	}
	...
	if(isPageSearch()) {
		const videoBvidFilter = new VideoBvidFilter();
		videoBvidFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS.black.bvid.valueKey}`, []));
		const videoDurationFilter = new VideoDurationFilter();
		videoDurationFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS.black.duration.valueKey}`, 0));
		const videoTitleFilter = new VideoTitleFilter();
		videoTitleFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS.black.title.valueKey}`, []));
		const videoUploaderFilter = new VideoUploaderFilter();
		videoUploaderFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS.black.uploader.valueKey}`, []));
		const videoUploaderKeywordFilter = new VideoUploaderKeywordFilter();
		videoUploaderKeywordFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS.black.uploaderKeyword.valueKey}`, []));
		const videoUploaderWhiteFilter = new VideoUploaderWhiteFilter();
		videoUploaderWhiteFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS.white.uploader.valueKey}`, []));
		const videoTitleWhiteFilter = new VideoTitleWhiteFilter();
		videoTitleWhiteFilter.setParam(_GM_getValue(`BILICLEANER_${GM_KEYS.white.title.valueKey}`, []));
		const selectorFns = {
			duration: (video) => {
				var _a, _b;
				const duration = (_b = (_a = video.querySelector(".bili-video-card__stats__duration")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim();
		...
		const checkVideoList = async (_fullSite) => {
			...
			try {
				const topVideos = Array.from(vlc.querySelectorAll(`.user-video-info .video-list > .video-list-item`));
				const contentVideos = Array.from(vlc.querySelectorAll(`.video.search-all-list .video-list > div, .search-page-video .video-list > div`));
				const blackPairs = [];
				videoBvidFilter.isEnable && blackPairs.push([videoBvidFilter, selectorFns.bvid]);
				videoDurationFilter.isEnable && blackPairs.push([videoDurationFilter, selectorFns.duration]);
				videoTitleFilter.isEnable && blackPairs.push([videoTitleFilter, selectorFns.title]);
					...
					if(isContextMenuUploaderEnable && e.target.closest(".bili-video-card__info--owner")) {
						...
						if(uploader) {
							...
							menu.registerMenu(`◎ 屏蔽UP主：${uploader}`, () => {
								...
								check();
								try {
									const arr = _GM_getValue(`BILICLEANER_${GM_KEYS.black.uploader.valueKey}`, []);
									if(!arr.includes(uploader)) {
										arr.unshift(uploader);
										_GM_setValue(`BILICLEANER_${GM_KEYS.black.uploader.valueKey}`, arr);
									}
								} catch (err) {
									error("contextMenuFunc addParam error", err);
								}
							...
							menu.registerMenu(`◎ 将UP主加入白名单`, () => {
								...
								check();
								try {
									const arr = _GM_getValue(`BILICLEANER_${GM_KEYS.white.uploader.valueKey}`, []);
									if(!arr.includes(uploader)) {
										arr.unshift(uploader);
										_GM_setValue(`BILICLEANER_${GM_KEYS.white.uploader.valueKey}`, arr);
									}
								} catch (err) {
									error("contextMenuFunc addParam error", err);
								}
						...
						if(href2) {
							...
							if(bvid) {
								...
								menu.registerMenu(`◎ 屏蔽视频 ${bvid}`, () => {
									...
									check();
									try {
										const arr = _GM_getValue(`BILICLEANER_${GM_KEYS.black.bvid.valueKey}`, []);
										if(!arr.includes(bvid)) {
											arr.unshift(bvid);
											_GM_setValue(`BILICLEANER_${GM_KEYS.black.bvid.valueKey}`, arr);
										}
									} catch (err) {
										error("contextMenuFunc addParam error", err);
									}
		...
		const uploaderItems = [
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS.black.uploader.valueKey, "UP主 黑名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
							videoUploaderFilter.setParam(values);
							check();
						}).show();
			...
			new ButtonItem({
				...
				name: "编辑",
				itemFunc: () => {
					new WordList(GM_KEYS.black.uploaderKeyword.valueKey, "UP主昵称关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoUploaderKeywordFilter.setParam(values);
							check();
		...
		const titleItems = [
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS.black.title.valueKey, "标题关键词 黑名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleFilter.setParam(values);
							check();
		...
		searchPageVideoFilterGroupList.push(new Group("search-title-keyword-filter-group", "搜索页 标题关键词过滤", titleItems));
		const bvidItems = [
			// 启用 搜索页 BV号过滤
			new CheckboxItem({
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS.black.bvid.valueKey, "BV号 黑名单", `每行一个BV号，保存时自动去重`,
						(values) => {
							videoBvidFilter.setParam(values);
							check();
						}).show();
		...
		const whitelistItems = [
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS.white.uploader.valueKey, "UP主 白名单", `每行一个UP主昵称，保存时自动去重`,
						(values) => {
							videoUploaderWhiteFilter.setParam(values);
							check();
						}).show();
			...
			new ButtonItem({
				...
				// 按钮功能：打开编辑器
				itemFunc: () => {
					new WordList(GM_KEYS.white.title.valueKey, "标题关键词 白名单", `每行一个关键词或正则，不区分大小写
正则默认iu模式，无需flag，语法：/abc|\\d+/`,
						(values) => {
							videoTitleWhiteFilter.setParam(values);
							check();
	...
	const main = async () => {
		...
		const register = () => {
			...
			if(isPageDynamic()) {
				regIDs.push(_GM_registerMenuCommand("✅动态过滤设置", () => createPanelWithMode("dynFilter", DYN_FILTER_GROUPS)));
			}
