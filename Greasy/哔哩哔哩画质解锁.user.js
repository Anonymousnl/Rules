...
`);
	...
	function updateQualityButtons(panel) {
		panel.querySelectorAll('button').forEach(button => {
			...
			if(button.textContent === userQualitySetting || (button.textContent === 'Hi-Res 音质' && hiResAudioEnabled) || (button.textContent === '杜比全景声' && dolbyAtmosEnabled) || (button.textContent === '移除清晰度按钮（Beta）' && takeOverQualityControl)) {
