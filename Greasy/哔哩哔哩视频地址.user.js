...
// @match       *://www.bilibili.com/blackboard/live/live-activity-player.html*
...
// @downloadURL https://github.com/Anonymousnl/Rules/raw/refs/heads/master/Greasy/%E5%93%94%E5%93%A9%E5%93%94%E5%93%A9%E8%A7%86%E9%A2%91%E5%9C%B0%E5%9D%80.user.js
// @updateURL   https://github.com/Anonymousnl/Rules/raw/refs/heads/master/Greasy/%E5%93%94%E5%93%A9%E5%93%94%E5%93%A9%E8%A7%86%E9%A2%91%E5%9C%B0%E5%9D%80.user.js
// ==/UserScript==
(() => {
	// webpackBootstrap
	var __webpack_modules__ = ({
		507: (function(__unused_webpack_module, exports, __webpack_require__) {
			...
			const {
				debug,
				useLogger: subLogger
			} = (0, logger_1.useLogger)("bilibili-ban-pcdn");
			const {
				getConfig
			} = (0, menu_1.useBooleanMenu)({
				blockPlayError: {
					title: "屏蔽“播放遇到问题？”提示",
					defaultValue: false,
				},
		...
		682: ((__unused_webpack_module, exports) => {
			Object.defineProperty(exports, "__esModule", ({
				value: true
			}));
				...
				const cleanDash = (dash) => {
					const cleanMedia = (media) => {
						const {
							baseUrl,
							backupUrls
						} = removeSomeUrls([media.baseUrl, ...media.backupUrl]);
				...
				const cleanDurl = (durls) => {
					durls.forEach((durl) => {
						const {
							baseUrl,
							backupUrls
						} = removeSomeUrls([durl.url, ...durl.backup_url]);
						durl.url = baseUrl;
		...
		686: ((__unused_webpack_module, exports) => {
			Object.defineProperty(exports, "__esModule", ({
				value: true
			}));
