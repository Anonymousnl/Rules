...
// @icon        https://raw.githubusercontent.com/Anonymousnl/Rules/master/Greasy/Icons/bilibili.png
// @require     https://registry.npmmirror.com/vue/3.5.33/files/dist/vue.global.prod.js
...
// @downloadURL https://github.com/Anonymousnl/Rules/raw/master/Greasy/%E5%93%94%E5%93%A9%E5%93%94%E5%93%A9%E9%A1%B5%E9%9D%A2%E5%87%80%E5%8C%96.user.js
// @updateURL   https://github.com/Anonymousnl/Rules/raw/master/Greasy/%E5%93%94%E5%93%A9%E5%93%94%E5%93%A9%E9%A1%B5%E9%9D%A2%E5%87%80%E5%8C%96.user.js
// ==/UserScript==
(async function(e$2) {
    ...
    const e$2__namespace = _interopNamespaceDefault(e$2);
    ...
    function createPinia() {
        const scope = e$2.effectScope(true);
        const state = scope.run(() => e$2.ref({}));
        let _p = [];
        let toBeInstalled = [];
        const pinia = e$2.markRaw({
            install(app) {
    ...
    function addSubscription(subscriptions, callback, detached, onCleanup = noop$1) {
        ...
        if (!detached && e$2.getCurrentScope()) {
            e$2.onScopeDispose(removeSubscription);
        }
    ...
    function mergeReactiveObjects(target, patchToApply) {
        ...
        for (const key in patchToApply) {
            ...
            if (isPlainObject(targetValue) && isPlainObject(subPatch) && target.hasOwnProperty(key) && !e$2.isRef(subPatch) && !e$2.isReactive(subPatch)) {
    ...
    function createOptionsStore(id, options, pinia, hot) {
        ...
        function setup() {
            ...
            const localState = e$2.toRefs(pinia.state.value[id]);
            return assign(localState, actions, Object.keys(getters || {}).reduce((computedGetters, name) => {
                computedGetters[name] = e$2.markRaw(e$2.computed(() => {
                    setActivePinia(pinia);
    ...
    function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
        ...
        const partialStore = {
            ...
            $subscribe(callback, options2 = {}) {
                ...
                const stopWatcher = scope.run(() => e$2.watch(() => pinia.state.value[$id], (state) => {
        ...
        const store = e$2.reactive(partialStore);
        pinia._s.set($id, store);
        const runWithContext = pinia._a && pinia._a.runWithContext || fallbackRunWithContext;
        const setupStore = runWithContext(() => pinia._e.run(() => (scope = e$2.effectScope()).run(() => setup({
            action
        }))));
        for (const key in setupStore) {
            const prop = setupStore[key];
            if (e$2.isRef(prop) && !isComputed(prop) || e$2.isReactive(prop)) {
                if (!isOptionsStore) {
            ...
            assign(e$2.toRaw(store), setupStore);
        }
    ...
    function defineStore(idOrOptions, setup, setupOptions) {
        ...
        function useStore(pinia, hot) {
            const hasContext = e$2.hasInjectionContext();
            pinia =
                pinia || (hasContext ? e$2.inject(piniaSymbol, null) : null);
            if (pinia)
                setActivePinia(pinia);
            pinia = activePinia;
            if (!pinia._s.has(id)) {
    ...
    function d$2(u2, e2, r2) {
        let i2 = e$2.ref(r2 == null ? void 0 : r2.value),
            f2 = e$2.computed(() => u2.value !== void 0);
        return [e$2.computed(() => f2.value ? u2.value : i2.value), function(t2) {
            return f2.value || (i2.value = t2), e2 == null ? void 0 : e2(t2);
        }];
    }
    var r$3;
    let n$3 = Symbol("headlessui.useid"),
        o$4 = 0;
    const i$4 = (r$3 = e$2__namespace.useId) != null ? r$3 : function() {
        return e$2__namespace.inject(n$3, () => `${++o$4}`)();
    };
    ...
    var d$1 = (t2, e2, r2) => e2 in t2 ? i$3(t2, e2, {
        enumerable: true,
        configurable: true,
        writable: true,
        value: r2
    ...
    var N$2 = ((n2) => (n2[n2.First = 1] = "First", n2[n2.Previous = 2] = "Previous", n2[n2.Next = 4] = "Next", n2[n2.Last = 8] = "Last", n2[n2.WrapAround = 16] = "WrapAround", n2[n2.NoScroll = 32] = "NoScroll", n2))(N$2 || {}),
    ...
    function w$3(e2, r2 = 0) {
        var t2;
        return e2 === ((t2 = i$2(e2)) == null ? void 0 : t2.body) ? false : u$5(r2, {
            [0]() {
    ...
    function u$4(e2, t2, n2) {
        c$2.isServer || e$2.watchEffect((o2) => {
    ...
    function w$1(f2, m, l2 = e$2.computed(() => true)) {
        function a2(e2, r2) {
    ...
    function s2(t2, e2) {
        let n2 = e$2.ref(r$2(t2.value.type, t2.value.as));
        return e$2.onMounted(() => {
    ...
    var N$1 = ((o2) => (o2[o2.None = 0] = "None", o2[o2.RenderStrategy = 1] = "RenderStrategy", o2[o2.Static = 2] = "Static", o2))(N$1 || {}),
    ...
    function y({
        ...
        let {
            as: n2,
            ...l2
        } = T$1(r2, ["unmount", "static"]), a2 = (m = e2.default) == null ? void 0 : m.call(e2, o2), d2 = {};
        if (o2) {
            let u2 = false,
                c2 = [];
...
`)].join(`
`));
                let p2 = j((h2 = u2.props) != null ? h2 : {}, l2, d2),
                    f2 = e$2.cloneVNode(u2, p2, true);
                for (let s3 in p2) s3.startsWith("on") && (f2.props || (f2.props = {}), f2.props[s3] = p2[s3]);
                return f2;
            }
            return Array.isArray(a2) && a2.length === 1 ? a2[0] : a2;
        }
        return e$2.h(n2, Object.assign({}, l2, d2), {
            default: () => a2
        });
    }

    function b(r2) {
        return r2.flatMap((t2) => t2.type === e$2.Fragment ? b(t2.children) : [t2]);
    }
    ...
    function j(...r2) {
        ...
        let t2 = {},
            e2 = {};
        for (let i2 of r2)
            for (let n2 in i2) n2.startsWith("on") && typeof i2[n2] == "function" ? (e2[n2] != null || (e2[n2] = []), e2[n2].push(i2[n2])) : t2[n2] = i2[n2];
    ...
    function f$1(l2, n2) {
        ...
        let r2 = n2.resolveActiveIndex(),
            s3 = r2 != null ? r2 : -1;
        switch (l2.focus) {
            case 0: {
                for (let e2 = 0; e2 < t2.length; ++e2)
                    if (!n2.resolveDisabled(t2[e2], e2, t2)) return e2;
                return r2;
            }
            case 1: {
                s3 === -1 && (s3 = t2.length);
            ...
            case 4: {
                for (let e2 = 0; e2 < t2.length; ++e2)
                    if (n2.resolveId(t2[e2], e2, t2) === l2.id) return e2;
                return r2;
            }
            case 5:
                return null;
    ...
    function o$1(i2, s3, t2) {
        if (Array.isArray(t2))
            for (let [r2, n2] of t2.entries()) o$1(i2, f(s3, r2.toString()), n2);
    ...
    function k$1({
        ...
        return e$2.provide(u, {
            register: r2,
            slot: t2,
            name: o2,
            props: s3
        }), e$2.computed(() => e2.value.length > 0 ? e2.value.join(" ") : void 0);
    }
    e$2.defineComponent({
        name: "Description",
        props: {
        ...
        setup(t2, {
            ...
            var n2;
            let e2 = (n2 = t2.id) != null ? n2 : `headlessui-description-${i$4()}`,
                r2 = w();
            return e$2.onMounted(() => e$2.onUnmounted(r2.register(e2))), () => {
                let {
                    name: i2 = "Description",
                    slot: l2 = e$2.ref({}),
                    props: d2 = {}
                    ...
                    ...Object.entries(d2).reduce((a2, [g2, m]) => Object.assign(a2, {
                        [g2]: e$2.unref(m)
                    }), {}),
                    id: e2
                };
    ...
    function U() {
        return e$2.inject(k, null);
    }
    let N = e$2.defineComponent({
            name: "Disclosure",
            props: {
                as: {
                    type: [Object, String],
            ...
            setup(t$12, {
                ...
                let s3 = e$2.ref(t$12.defaultOpen ? 0 : 1),
                    e2 = e$2.ref(null),
                    i$12 = e$2.ref(null),
                    n2 = {
                        buttonId: e$2.ref(`headlessui-disclosure-button-${i$4()}`),
                        panelId: e$2.ref(`headlessui-disclosure-panel-${i$4()}`),
                        disclosureState: s3,
                        panel: e2,
                        button: i$12,
                        toggleDisclosure() {
                            s3.value = u$5(s3.value, {
                                [0]: 1,
                                [1]: 0
                            });
                        },
                ...
                return e$2.provide(T, n2), t(e$2.computed(() => u$5(s3.value, {
                    [0]: i.Open,
                    [1]: i.Closed
                }))), () => {
                    let {
        ...
        Q = e$2.defineComponent({
            ...
            setup(t2, {
                ...
                let e2 = O("DisclosureButton"),
                    i2 = U(),
                    n2 = e$2.computed(() => i2 === null ? false : i2.value === e2.panelId.value);
                e$2.onMounted(() => {
                ...
                s$12({
                    el: l2,
                    $el: l2
                }), n2.value || e$2.watchEffect(() => {
                    e2.button.value = l2.value;
                });
                let a2 = s2(e$2.computed(() => ({
                    as: t2.as,
                    type: r2.type
                })), l2);
                ...
                return () => {
                    var C2;
                    let u2 = {
                            open: e2.disclosureState.value === 0
                        },
                        {
                            id: S2,
                            ...K2
                        ...
                        M = n2.value ? {
                            ...
                            id: (C2 = e2.buttonId.value) != null ? C2 : S2,
                            ref: l2,
                            type: a2.value,
                            "aria-expanded": e2.disclosureState.value === 0,
                            "aria-controls": e2.disclosureState.value === 0 || o$3(e2.panel) ? e2.panelId.value : void 0,
        ...
        V = e$2.defineComponent({
            ...
            setup(t2, {
                ...
                e$2.onMounted(() => {
                    ...
                    el: e2.panel,
                    $el: e2.panel
                }), e$2.provide(k, e2.panelId);
                let i$12 = l(),
                    n2 = e$2.computed(() => i$12 !== null ? (i$12.value & i.Open) === i.Open : e2.disclosureState.value === 0);
                return () => {
                    var v2;
                    let l2 = {
                            open: e2.disclosureState.value === 0,
                        ...
                        D = {
                            id: (v2 = e2.panelId.value) != null ? v2 : a2,
                            ref: e2.panel
                        };
                    return A$1({
                        ourProps: D,
    ...
    function o(e2) {
        var r2, i2;
        let n2 = (r2 = e2.innerText) != null ? r2 : "",
            t2 = e2.cloneNode(true);
    ...
    var ce = ((r2) => (r2[r2.Open = 0] = "Open", r2[r2.Closed = 1] = "Closed", r2))(ce || {}),
        ve = ((r2) => (r2[r2.Single = 0] = "Single", r2[r2.Multi = 1] = "Multi", r2))(ve || {}),
        be = ((r2) => (r2[r2.Pointer = 0] = "Pointer", r2[r2.Other = 1] = "Other", r2))(be || {});
    ...
    let Ie = e$2.defineComponent({
        name: "Listbox",
        emits: {
            "update:modelValue": (o2) => true
        },
        props: {
            as: {
                type: [Object, String],
        ...
        setup(o2, {
            ...
            function u2(t2 = (i2) => i2) {
                let i2 = p2.value !== null ? s3.value[p2.value] : null,
                    l2 = O$1(t2(s3.value.slice()), (O2) => o$3(O2.dataRef.domRef)),
                    d2 = i2 ? l2.indexOf(i2) : null;
                return d2 === -1 && (d2 = null), {
                    options: l2,
                    activeOptionIndex: d2
                };
            }
            let D = e$2.computed(() => o2.multiple ? 1 : 0),
                [y2, L] = d$2(e$2.computed(() => o2.modelValue), (t2) => w2("update:modelValue", t2), e$2.computed(() => o2.defaultValue)),
                M = e$2.computed(() => y2.value === void 0 ? u$5(D.value, {
                    [1]: [],
                    [0]: void 0
                }) : y2.value),
                k2 = {
                    ...
                    orientation: e$2.computed(() => o2.horizontal ? "horizontal" : "vertical"),
                    labelRef: e2,
                    buttonRef: f2,
                    optionsRef: v2,
                    disabled: e$2.computed(() => o2.disabled),
                    options: s3,
                    searchQuery: m,
                    activeOptionIndex: p2,
                    activationTrigger: a2,
                    closeListbox() {
                    ...
                    goToOption(t2, i2, l2) {
                        ...
                        let d2 = u2(),
                            O2 = f$1(t2 === c.Specific ? {
                                focus: c.Specific,
                                id: i2
                            } : {
                                focus: t2
                            }, {
                                resolveItems: () => d2.options,
                                resolveActiveIndex: () => d2.activeOptionIndex,
                                resolveId: (h2) => h2.id,
                                resolveDisabled: (h2) => h2.dataRef.disabled
                            });
                    ...
                    search(t2) {
                        ...
                        let O2 = (p2.value !== null ? s3.value.slice(p2.value + l2).concat(s3.value.slice(0, p2.value + l2)) : s3.value).find((I) => I.dataRef.textValue.startsWith(m.value) && !I.dataRef.disabled),
                            h2 = O2 ? s3.value.indexOf(O2) : -1;
                    ...
                    select(t2) {
                        o2.disabled || L(u$5(D.value, {
                            [0]: () => t2,
                            [1]: () => {
                                let i2 = e$2.toRaw(k2.value.value).slice(),
                                    l2 = e$2.toRaw(t2),
                                    d2 = i2.findIndex((O2) => k2.compare(l2, e$2.toRaw(O2)));
            ...
            }, e$2.computed(() => n2.value === 0)), e$2.provide($, k2), t(e$2.computed(() => u$5(n2.value, {
                [0]: i.Open,
                [1]: i.Closed
            })));
            let C2 = e$2.computed(() => {
            ...
            return e$2.onMounted(() => {
                ...
                return e$2.h(e$2.Fragment, [...t2 != null && M.value != null ? e$1({
                    [t2]: M.value
                }).map(([I, Q2]) => e$2.h(f$2, E$1({
                    features: u$2.Hidden,
                    key: I,
                    as: "input",
                    type: "hidden",
                    ...
                    theirProps: {
                        ...r2,
                        ...T$1(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"])
                    },
                    slot: h2,
                    slots: b2,
                    attrs: r2,
    ...
    e$2.defineComponent({
        ...
        setup(o2, {
            ...
            var f2;
            let w2 = (f2 = o2.id) != null ? f2 : `headlessui-listbox-label-${i$4()}`,
                n2 = A("ListboxLabel");

            function e2() {
                var v2;
                (v2 = o$3(n2.buttonRef)) == null || v2.focus({
                    preventScroll: true
                });
            }
            return () => {
                let v2 = {
                        open: n2.listboxState.value === 0,
                        disabled: n2.disabled.value
                    },
                    {
                        ...s3
                    } = o2,
    ...
    let je = e$2.defineComponent({
            ...
            setup(o2, {
                ...
                var p2;
                let n2 = (p2 = o2.id) != null ? p2 : `headlessui-listbox-button-${i$4()}`,
                    e2 = A("ListboxButton");
                w2({
                    el: e2.buttonRef,
                    $el: e2.buttonRef
                ...
                function f2(a2) {
                    switch (a2.key) {
                        ...
                        case o$2.Enter:
                        case o$2.ArrowDown:
                            a2.preventDefault(), e2.openListbox(), e$2.nextTick(() => {
                                var u2;
                                (u2 = o$3(e2.optionsRef)) == null || u2.focus({
                                    preventScroll: true
                                }), e2.value.value || e2.goToOption(c.First);
                            });
                            break;
                        case o$2.ArrowUp:
                            a2.preventDefault(), e2.openListbox(), e$2.nextTick(() => {
                ...
                function s$12(a2) {
                    e2.disabled.value || (e2.listboxState.value === 0 ? (e2.closeListbox(), e$2.nextTick(() => {
                        var u2;
                        return (u2 = o$3(e2.buttonRef)) == null ? void 0 : u2.focus({
                            preventScroll: true
                        });
                    })) : (a2.preventDefault(), e2.openListbox(), me(() => {
                        var u2;
                        return (u2 = o$3(e2.optionsRef)) == null ? void 0 : u2.focus({
                            preventScroll: true
                        });
                    })));
                }
                let m = s2(e$2.computed(() => ({
                    as: o2.as,
                    type: b2.type
                })), e2.buttonRef);
                return () => {
                    var y2, L;
                    let a2 = {
                            open: e2.listboxState.value === 0,
                            disabled: e2.disabled.value,
                            value: e2.value.value
                        },
                        {
                            ...u2
                        } = o2,
                        D = {
                            ...
                            "aria-controls": (y2 = o$3(e2.optionsRef)) == null ? void 0 : y2.id,
                            "aria-expanded": e2.listboxState.value === 0,
                            "aria-labelledby": e2.labelRef.value ? [(L = o$3(e2.labelRef)) == null ? void 0 : L.id, n2].join(" ") : void 0,
                            disabled: e2.disabled.value === true ? true : void 0,
                            onKeydown: f2,
                            onKeyup: v2,
                            onClick: s$12
                        };
        ...
        Ae = e$2.defineComponent({
            ...
            setup(o2, {
                ...
                var p2;
                let n2 = (p2 = o2.id) != null ? p2 : `headlessui-listbox-options-${i$4()}`,
                    e2 = A("ListboxOptions"),
                    f2 = e$2.ref(null);
                w2({
                    el: e2.optionsRef,
                ...
                function v2(a2) {
                    switch (f2.value && clearTimeout(f2.value), a2.key) {
                        ...
                        case o$2.Enter:
                            ...
                            e2.mode.value === 0 && (e2.closeListbox(), e$2.nextTick(() => {
                                var u2;
                                return (u2 = o$3(e2.buttonRef)) == null ? void 0 : u2.focus({
                                    preventScroll: true
                                });
                        ...
                        case o$2.Escape:
                            a2.preventDefault(), a2.stopPropagation(), e2.closeListbox(), e$2.nextTick(() => {
                                var u2;
                                return (u2 = o$3(e2.buttonRef)) == null ? void 0 : u2.focus({
                                    preventScroll: true
                                });
                ...
                let s3 = l(),
                    m = e$2.computed(() => s3 !== null ? (s3.value & i.Open) === i.Open : e2.listboxState.value === 0);
                return () => {
                    var y2, L;
                    let a2 = {
                            open: e2.listboxState.value === 0
                        ...
                        D = {
                            "aria-activedescendant": e2.activeOptionIndex.value === null || (y2 = e2.options.value[e2.activeOptionIndex.value]) == null ? void 0 : y2.id,
                            "aria-multiselectable": e2.mode.value === 1 ? true : void 0,
                            "aria-labelledby": (L = o$3(e2.buttonRef)) == null ? void 0 : L.id,
                            "aria-orientation": e2.orientation.value,
                            id: n2,
                            onKeydown: v2,
                            role: "listbox",
                            tabIndex: 0,
        ...
        Fe = e$2.defineComponent({
            ...
            setup(o2, {
                ...
                var C2;
                let n2 = (C2 = o2.id) != null ? C2 : `headlessui-listbox-option-${i$4()}`,
                    e2 = A("ListboxOption"),
                    f2 = e$2.ref(null);
                w2({
                    el: f2,
                ...
                let v2 = e$2.computed(() => e2.activeOptionIndex.value !== null ? e2.options.value[e2.activeOptionIndex.value].id === n2 : false),
                    s3 = e$2.computed(() => u$5(e2.mode.value, {
                        [0]: () => e2.compare(e$2.toRaw(e2.value.value), e$2.toRaw(o2.value)),
                        [1]: () => e$2.toRaw(e2.value.value).some((t2) => e2.compare(e$2.toRaw(t2), e$2.toRaw(o2.value)))
                    })),
                    m = e$2.computed(() => u$5(e2.mode.value, {
                        [1]: () => {
                            var i2;
                            let t2 = e$2.toRaw(e2.value.value);
                            return ((i2 = e2.options.value.find((l2) => t2.some((d2) => e2.compare(e$2.toRaw(d2), e$2.toRaw(l2.dataRef.value))))) == null ? void 0 : i2.id) === n2;
                        },
                        [0]: () => s3.value
                    })),
                    p$12 = p(f2),
                ...
                e$2.onMounted(() => e2.registerOption(n2, a2)), e$2.onUnmounted(() => e2.unregisterOption(n2)), e$2.onMounted(() => {
                    e$2.watch([e2.listboxState, s3], () => {
                        e2.listboxState.value === 0 && s3.value && u$5(e2.mode.value, {
                            [1]: () => {
                    ...
                    e2.listboxState.value === 0 && v2.value && e2.activationTrigger.value !== 0 && e$2.nextTick(() => {
                        var t2, i2;
                        return (i2 = (t2 = o$3(f2)) == null ? void 0 : t2.scrollIntoView) == null ? void 0 : i2.call(t2, {
                            block: "nearest"
                        });
                    });
                });
                ...
                function u2(t2) {
                    ...
                    e2.select(o2.value), e2.mode.value === 0 && (e2.closeListbox(), e$2.nextTick(() => {
                        var i2;
                        return (i2 = o$3(e2.buttonRef)) == null ? void 0 : i2.focus({
                            preventScroll: true
                        });
                    }));
                }
                ...
                return () => {
                    let {
                        ...
                        ref: f2,
                        role: "option",
                        tabIndex: t2 === true ? void 0 : -1,
                        "aria-disabled": t2 === true ? true : void 0,
                        "aria-selected": s3.value,
                        disabled: void 0,
                        onClick: u2,
                        onFocus: D,
                        onPointerenter: L,
    ...
    let K = e$2.defineComponent({
        ...
        setup(t2, {
            ...
            var r2;
            let e2 = (r2 = t2.id) != null ? r2 : `headlessui-label-${i$4()}`,
                o2 = d();
            return e$2.onMounted(() => e$2.onUnmounted(o2.register(e2))), () => {
                let {
                    name: l2 = "Label",
                    slot: p2 = {},
                    props: c2 = {}
                    ...
                    ...Object.entries(c2).reduce((b2, [g2, m]) => Object.assign(b2, {
                        [g2]: e$2.unref(m)
                    }), {}),
                    id: e2
                };
                return f2 && (delete u2.onClick, delete u2.htmlFor, delete s3.onClick), A$1({
                    ourProps: u2,
                    theirProps: s3,
                    slot: p2,
                    attrs: i2,
    ...
    let C = Symbol("GroupContext"),
            ...
            setup(l2, {
                ...
                let r2 = e$2.ref(null),
                    f2 = E({
                        name: "SwitchLabel",
                        props: {
                            htmlFor: e$2.computed(() => {
                                var t2;
                                return (t2 = r2.value) == null ? void 0 : t2.id;
                            }),
                            onClick(t2) {
                                r2.value && (t2.currentTarget.tagName === "LABEL" && t2.preventDefault(), r2.value.click(), r2.value.focus({
                                    preventScroll: true
                                }));
                            }
                        }
        ...
        ue = e$2.defineComponent({
            name: "Switch",
            emits: {
                "update:modelValue": (l2) => true
            },
            props: {
                as: {
                    type: [Object, String],
            ...
            setup(l2, {
                ...
                var h2;
                let p2 = (h2 = l2.id) != null ? h2 : `headlessui-switch-${i$4()}`,
                    n2 = e$2.inject(C, null),
                    [t2, s$12] = d$2(e$2.computed(() => l2.modelValue), (e2) => c2("update:modelValue", e2), e$2.computed(() => l2.defaultChecked));

                function m() {
                    s$12(!t2.value);
                }
                let E2 = e$2.ref(null),
                    o2 = n2 === null ? E2 : n2.switchRef,
                    L = s2(e$2.computed(() => ({
                        as: l2.as,
                        type: i2.type
                    })), o2);
                ...
                return e$2.onMounted(() => {
                    ...
                    let {
                        ...
                        type: L.value,
                        tabIndex: y2 === -1 ? 0 : y2,
                        "aria-checked": t2.value,
                        "aria-labelledby": n2 == null ? void 0 : n2.labelledby.value,
                        "aria-describedby": n2 == null ? void 0 : n2.describedby.value,
                        onClick: D,
                        onKeyup: R,
                        onKeypress: x
                    };
                    return e$2.h(e$2.Fragment, [e2 != null && t2.value != null ? e$2.h(f$2, E$1({
                        features: u$2.Hidden,
                        as: "input",
                        type: "checkbox",
                        hidden: true,
                        ...
                        theirProps: {
                            ...i2,
                            ...T$1(b2, ["modelValue", "defaultChecked"])
                        },
                        slot: T2,
                        attrs: i2,
                        slots: r2,
    ...
    function render$2(_ctx, _cache) {
        return e$2.openBlock(), e$2.createElementBlock("svg", {
    ...
    const _hoisted_1$b = {
        class: "mx-auto w-full bg-white p-1.5"
    };
    const _sfc_main$f = e$2.defineComponent({
        ...
        setup(__props) {
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock("div", _hoisted_1$b, [
                    e$2.createVNode(e$2.unref(N), {
                        "default-open": !__props.isFold
                    }, {
                        default: e$2.withCtx(({
                            open
                        }) => [
                            e$2.createVNode(e$2.unref(Q), {
                                class: e$2.normalizeClass(["flex w-full justify-between rounded-lg px-4 py-1.5 text-left font-bold outline-none", {
                                ...
                                default: e$2.withCtx(() => [
                                    e$2.createElementVNode("span", null, e$2.toDisplayString(__props.title || "Disclosure Title"), 1),
                                    e$2.createVNode(e$2.unref(render), {
                                        class: e$2.normalizeClass([{
                                            "rotate-180": open,
                                            "rotate-90": !open,
                            ...
                            e$2.createVNode(e$2.unref(V), {
                                unmount: false,
                                class: "pl-3 pr-2 pt-2 text-gray-500"
                            }, {
                                default: e$2.withCtx(() => [
                                    e$2.renderSlot(_ctx.$slots, "default")
                                ]),
                                _: 3
                            })
                        ]),
    ...
    const matchBvid = (s3) => {
        return bvidPattern.exec(s3)?.[1] ?? null;
    };
    const avidbvidPattern = /(av\d+|BV[1-9A-HJ-NP-Za-km-z]+)/;
    const matchAvidBvid = (s3) => {
        return avidbvidPattern.exec(s3)?.[1] ?? null;
    };
    ...
    const toHalfWidth = (s3) => {
        return s3.replace(/\u3000/g, " ").replace(/[\uFF01-\uFF5E]/g, (ch) => String.fromCharCode(ch.charCodeAt(0) - 65248));
    };
    const playerGoTo = (mode) => {
        const map = {
            normal: 0,
            wide: 1,
            web: 2,
        ...
        if (typeof _unsafeWindow.player?.requestStatue === "function") {
            _unsafeWindow.player.requestStatue(map[mode]).catch((err) => {
    ...
    function tryOnScopeDispose$1(fn) {
        if (e$2.getCurrentScope()) {
            e$2.onScopeDispose(fn);
            return true;
        }
        return false;
    }
    ...
    const injectLocal = (...args) => {
        var _a;
        const key = args[0];
        const instance = (_a = e$2.getCurrentInstance()) == null ? void 0 : _a.proxy;
        if (instance == null && !e$2.hasInjectionContext())
            throw new Error("injectLocal must be called in setup");
        if (instance && localProvidedStateMap.has(instance) && key in localProvidedStateMap.get(instance))
            return localProvidedStateMap.get(instance)[key];
        return e$2.inject(...args);
    };
    ...
    function debounceFilter(ms, options = {}) {
        ...
        let lastInvoker;
        const filter = (invoke) => {
            const duration = e$2.toValue(ms);
            const maxDuration = e$2.toValue(options.maxWait);
            if (timer)
                _clearTimeout(timer);
    ...
    function throttleFilter(...args) {
        ...
        let leading;
        let rejectOnCancel;
        if (!e$2.isRef(args[0]) && typeof args[0] === "object")
            ({
                delay: ms,
                trailing = true,
                leading = true,
    ...
    function pausableFilter(extendFilter = bypassFilter, options = {}) {
        ...
        return {
            isActive: e$2.readonly(isActive),
            pause,
            resume,
            eventFilter
        };
    ...
    function toRef(...args) {
        if (args.length !== 1)
            return e$2.toRef(...args);
        const r2 = args[0];
        return typeof r2 === "function" ? e$2.readonly(e$2.customRef(() => ({
            get: r2,
            set: noop
        }))) : e$2.ref(r2);
    }
    ...
    function toRefs(objectRef, options = {}) {
        if (!e$2.isRef(objectRef))
            return e$2.toRefs(objectRef);
        const result = Array.isArray(objectRef.value) ? Array.from({
            length: objectRef.value.length
        }) : {};
        for (const key in objectRef.value) {
            result[key] = e$2.customRef(() => ({
                get() {
                    return objectRef.value[key];
                },
                set(v2) {
                    var _a;
                    const replaceRef = (_a = e$2.toValue(options.replaceRef)) != null ? _a : true;
                    if (replaceRef) {
    ...
    function useEventListener(...args) {
        ...
        const firstParamTargets = e$2.computed(() => {
            const test = toArray(e$2.toValue(args[0])).filter((e2) => e2 != null);
        ...
        const stopWatch = watchImmediate(
            () => {
                ...
                return [
                    ...
                    toArray(e$2.toValue(firstParamTargets.value ? args[1] : args[0])),
                    toArray(e$2.unref(firstParamTargets.value ? args[2] : args[1])),
                    e$2.toValue(firstParamTargets.value ? args[3] : args[2])
                ];
            },
    ...
    function useMounted() {
        const isMounted = e$2.shallowRef(false);
        const instance = e$2.getCurrentInstance();
        if (instance) {
            e$2.onMounted(() => {
    ...
    function useMutationObserver(target, callback, options = {}) {
        ...
        const targets = e$2.computed(() => {
            const value = e$2.toValue(target);
            const items = toArray(value).map(unrefElement).filter(notNullish);
            return new Set(items);
        });
        const stopWatch = e$2.watch(
            () => targets.value,
            (targets2) => {
                cleanup();
    ...
    function useSSRWidth() {
        const ssrWidth = e$2.hasInjectionContext() ? injectLocal(ssrWidthSymbol, null) : null;
    ...
    function useMediaQuery(query, options = {}) {
        ...
        const ssrSupport = e$2.shallowRef(typeof ssrWidth === "number");
        const mediaQuery = e$2.shallowRef();
        const matches = e$2.shallowRef(false);
        const handler = (event) => {
        ...
        e$2.watchEffect(() => {
            if (ssrSupport.value) {
                ...
                const queryStrings = e$2.toValue(query).split(",");
            ...
            if (!isSupported.value)
                return;
            mediaQuery.value = window2.matchMedia(e$2.toValue(query));
            matches.value = mediaQuery.value.matches;
        });
        useEventListener(mediaQuery, "change", handler, {
            passive: true
        });
        return e$2.computed(() => matches.value);
    }
    ...
    function useStorage(key, defaults2, storage, options = {}) {
        ...
        const data = (shallow ? e$2.shallowRef : e$2.ref)(typeof defaults2 === "function" ? defaults2() : defaults2);
        const keyComputed = e$2.computed(() => e$2.toValue(key));
        if (!storage) {
            try {
        ...
        if (!storage)
            return data;
        const rawInit = e$2.toValue(defaults2);
    ...
    function useDraggable(target, options = {}) {
        ...
        const position = e$2.ref(
            (_a = e$2.toValue(initialValue)) != null ? _a : {
                x: 0,
                y: 0
            }
        );
        const pressedDelta = e$2.ref();
        ...
        const handleEvent = (e2) => {
            if (e$2.toValue(preventDefault2))
                e2.preventDefault();
            if (e$2.toValue(stopPropagation))
                e2.stopPropagation();
        };
        const start = (e2) => {
            var _a2;
            if (!e$2.toValue(buttons).includes(e2.button))
                return;
            if (e$2.toValue(options.disabled) || !filterEvent(e2))
                return;
            if (e$2.toValue(exact) && e2.target !== e$2.toValue(target))
                return;
            const container = e$2.toValue(containerElement);
            const containerRect = (_a2 = container == null ? void 0 : container.getBoundingClientRect) == null ? void 0 : _a2.call(container);
            const targetRect = e$2.toValue(target).getBoundingClientRect();
            const pos = {
        ...
        if (isClient) {
            const config2 = () => {
                ...
                return {
                    ...
                    passive: !e$2.toValue(preventDefault2)
                };
            };
        ...
        return {
            ...toRefs(position),
            position,
            isDragging: e$2.computed(() => !!pressedDelta.value),
            style: e$2.computed(
    ...
    function useResizeObserver(target, callback, options = {}) {
        ...
        const targets = e$2.computed(() => {
            const _targets = e$2.toValue(target);
    ...
    function useElementBounding(target, options = {}) {
        ...
        const height = e$2.shallowRef(0);
        const bottom = e$2.shallowRef(0);
        const left = e$2.shallowRef(0);
        const right = e$2.shallowRef(0);
        const top2 = e$2.shallowRef(0);
        const width = e$2.shallowRef(0);
        const x = e$2.shallowRef(0);
        const y2 = e$2.shallowRef(0);
        ...
        e$2.watch(() => unrefElement(target), (ele) => !ele && update());
    ...
    function useMagicKeys(options = {}) {
        ...
        const current = e$2.reactive(new Set());
        const obj = {
            toJSON() {
                return {};
            },
        ...
        const refs = useReactive ? e$2.reactive(obj) : obj;
                ...
                get(target2, prop, rec) {
                    ...
                    if (!(prop in refs)) {
                        if (/[+_-]/.test(prop)) {
                            ...
                            refs[prop] = e$2.computed(() => keys2.map((key) => e$2.toValue(proxy[key])).every(Boolean));
                        } else {
                            refs[prop] = e$2.shallowRef(false);
                        }
                    }
                    const r2 = Reflect.get(target2, prop, rec);
                    return useReactive ? e$2.toValue(r2) : r2;
                }
            }
        );
        return proxy;
    ...
    function useWindowSize(options = {}) {
        ...
        const width = e$2.shallowRef(initialWidth);
        const height = e$2.shallowRef(initialHeight);
        const update = () => {
            if (window2) {
                if (type === "outer") {
    ...
    const _hoisted_2$7 = {
        class: "no-scrollbar flex min-h-[calc(100%-2.5rem)] flex-1 flex-col p-2"
    };
    const _sfc_main$e = e$2.defineComponent({
        __name: "PanelComp",
        props: {
            title: {},
            widthPercent: {},
        ...
        setup(__props, {
            ...
            const emit = __emit;
            const props = __props;
            const panel = e$2.ref(null);
            const bar = e$2.ref(null);
            ...
            const {
                width,
                height
            } = useElementBounding(bar, {
                windowScroll: false
            });
            const maxPos = e$2.computed(() => {
                return {
            ...
            const {
                ...
                initialValue: {
                    x: Math.max(
                        windowSize.width.value / 2 - Math.max(windowSize.width.value * props.widthPercent / 100, props.minWidth) / 2,
                        0
                    ),
                    y: Math.max(
                        windowSize.height.value / 2 - Math.max(windowSize.height.value * props.heightPercent / 100, props.minHeight) / 2,
                        0
                    )
                },
                handle: e$2.computed(() => bar.value),
                preventDefault: true,
                onMove: (pos) => {
            ...
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock("div", {
                    ref_key: "panel",
                    ref: panel,
                    style: e$2.normalizeStyle([panelStyle.value, e$2.unref(style)]),
                    ...
                    e$2.createElementVNode("div", _hoisted_2$7, [
                        e$2.renderSlot(_ctx.$slots, "default")
                    ])
                ], 4);
            };
    ...
    const _hoisted_2$6 = {
        class: "text-sm leading-6 text-orange-900"
    };
    const _sfc_main$d = e$2.defineComponent({
        ...
        setup(__props) {
            return (_ctx, _cache) => {
                return __props.description?.length ? (e$2.openBlock(), e$2.createElementBlock("div", _hoisted_1$9, [
                    e$2.createElementVNode("div", _hoisted_2$6, [
                        (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(__props.description, (line, index) => {
                            return e$2.openBlock(), e$2.createElementBlock("div", {
                                key: index
                            }, [
                                e$2.createElementVNode("p", null, [
                                    _cache[0] || (_cache[0] = e$2.createElementVNode("span", {
                                        class: "mr-1"
                                    }, "•", -1)),
                                    e$2.createTextVNode(e$2.toDisplayString(line), 1)
                                ])
                            ]);
                        }), 128))
                    ])
                ])) : e$2.createCommentVNode("", true);
            };
        }
    });
    const _hoisted_1$8 = {
        class: "mx-2 mb-2 flex flex-1 flex-col p-1 text-black"
    };
    const _sfc_main$c = e$2.defineComponent({
        __name: "EditorDialog",
        setup(__props, {
            expose: __expose
        }) {
            const isEditorShow = e$2.ref(false);
            const editorData = e$2.ref("");
            const currentItem = e$2.ref(null);
            let stopWatch = null;
            ...
            return (_ctx, _cache) => {
                return isEditorShow.value ? (e$2.openBlock(), e$2.createBlock(_sfc_main$e, e$2.mergeProps({
                    key: 0
                }, {
                    ...
                    default: e$2.withCtx(() => [
                        e$2.createElementVNode("div", _hoisted_1$8, [
                            currentItem.value?.editorDescription?.length ? (e$2.openBlock(), e$2.createBlock(_sfc_main$d, {
                                key: 0,
                                class: "mb-3",
                                description: currentItem.value.editorDescription
                            }, null, 8, ["description"])) : e$2.createCommentVNode("", true),
                            e$2.withDirectives(e$2.createElementVNode("textarea", {
                                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => editorData.value = $event),
                                onKeydown: _cache[1] || (_cache[1] = e$2.withModifiers(() => {}, ["stop"])),
                                ...
                                [e$2.vModelText, editorData.value]
                            ])
                        ])
                    ]),
                    _: 1
                }, 16)) : e$2.createCommentVNode("", true);
            };
        }
    });
    const _hoisted_1$7 = {
        class: "flex w-full py-1 hover:bg-blue-50 hover:bg-opacity-50"
    };
    const _hoisted_2$5 = {
        class: "ml-2 self-center text-black"
    };
    const _sfc_main$b = e$2.defineComponent({
        __name: "EditorComp",
        props: {
            type: {},
            id: {},
        ...
        setup(__props, {
            ...
            const emit = __emit;
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, [
                    e$2.createElementVNode("label", _hoisted_1$7, [
                        e$2.createElementVNode("button", {
                            type: "button",
                        ...
                        e$2.createElementVNode("span", _hoisted_2$5, e$2.toDisplayString(__props.name), 1)
                    ]),
                    __props.description?.length ? (e$2.openBlock(), e$2.createBlock(_sfc_main$d, {
                        key: 0,
                        class: "pl-9",
    ...
    const _sfc_main$a = e$2.defineComponent({
        __name: "ListComp",
        props: {
            type: {},
            id: {},
        ...
        setup(__props) {
            ...
            const currOption = options.find((v2) => v2.value === currValue);
            const selectedOption = e$2.ref(currOption ?? options[0]);
            e$2.watch(selectedOption, (newSelected) => {
            ...
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, [
                    e$2.createElementVNode("div", _hoisted_1$6, [
                        e$2.createElementVNode("div", _hoisted_2$4, e$2.toDisplayString(__props.name), 1),
                        e$2.createVNode(e$2.unref(Ie), {
                            modelValue: selectedOption.value,
                            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => selectedOption.value = $event)
                        }, {
                            default: e$2.withCtx(() => [
                                e$2.createElementVNode("div", _hoisted_3$2, [
                                    e$2.createVNode(e$2.unref(je), {
                                        ...
                                        default: e$2.withCtx(() => [
                                            e$2.createElementVNode("span", _hoisted_4, e$2.toDisplayString(selectedOption.value.name), 1),
                                            e$2.createElementVNode("span", _hoisted_5, [
                                                e$2.createVNode(e$2.unref(render$1), {
                                    ...
                                    e$2.createVNode(e$2.Transition, {
                                        "leave-active-class": "transition duration-100 ease-in",
                                        "leave-from-class": "opacity-100",
                                        "leave-to-class": "opacity-0"
                                    }, {
                                        default: e$2.withCtx(() => [
                                            e$2.createVNode(e$2.unref(Ae), {
                                                ...
                                                default: e$2.withCtx(() => [
                                                    (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(e$2.unref(options), (option, index) => {
                                                        return e$2.openBlock(), e$2.createBlock(e$2.unref(Fe), {
                                                            key: index,
                                                            value: option,
                                                            as: "template"
                                                        }, {
                                                            default: e$2.withCtx(({
                                                                ...
                                                                e$2.createElementVNode("li", {
                                                                    class: e$2.normalizeClass([
                                                                        active ? "bg-purple-100 text-black" : "text-gray-900",
                                                                        "relative cursor-default py-2 pl-10 pr-4 transition-colors duration-200"
                                                                    ])
                                                                }, [
                                                                    e$2.createElementVNode("span", {
                                                                        class: e$2.normalizeClass([selected ? "font-medium" : "font-normal", "block truncate"])
                                                                    }, e$2.toDisplayString(option.name), 3),
                                                                    selected ? (e$2.openBlock(), e$2.createElementBlock("span", _hoisted_6, [
                                                                        e$2.createVNode(e$2.unref(render$2), {
                                                                            class: "h-5 w-5",
                                                                            "aria-hidden": "true"
                                                                        })
                                                                    ])) : e$2.createCommentVNode("", true)
    ...
    const _hoisted_1$5 = {
        class: "my-1 flex items-center py-1 text-black"
    };
    const _hoisted_2$3 = ["step"];
    const _hoisted_3$1 = {
        key: 0,
        class: "ml-2"
    };
    const _sfc_main$9 = e$2.defineComponent({
        __name: "NumberComp",
        props: {
            type: {},
            id: {},
        ...
        setup(__props) {
            const item = __props;
            const currValue = e$2.ref(_GM_getValue(item.id, item.defaultValue));
            watchThrottled(
                currValue,
                (newValue, oldValue) => {
                    try {
            ...
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, [
                    e$2.createElementVNode("div", _hoisted_1$5, [
                        e$2.createElementVNode("div", null, e$2.toDisplayString(__props.name), 1),
                        e$2.withDirectives(e$2.createElementVNode("input", {
                            type: "number",
                            step: __props.step,
                            ...
                            [e$2.vModelText, currValue.value]
                        ]),
                        __props.addonText ? (e$2.openBlock(), e$2.createElementBlock("div", _hoisted_3$1, e$2.toDisplayString(__props.addonText), 1)) : e$2.createCommentVNode("", true)
                    ]),
                    __props.description?.length ? (e$2.openBlock(), e$2.createBlock(_sfc_main$d, {
                        key: 0,
                        class: "pl-1",
    ...
    const _hoisted_1$4 = {
        class: "mb-0.5 mt-1 flex items-center py-1 text-black"
    };
    const _sfc_main$8 = e$2.defineComponent({
        __name: "StringComp",
        props: {
            type: {},
            id: {},
        ...
        setup(__props) {
            ...
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, [
                    e$2.createElementVNode("div", _hoisted_1$4, [
                        e$2.createElementVNode("div", null, e$2.toDisplayString(__props.name), 1),
                        e$2.withDirectives(e$2.createElementVNode("input", {
                            type: "text",
                            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => currValue.value = $event),
    ...
    const _sfc_main$7 = e$2.defineComponent({
        __name: "SwitchComp",
        props: {
            type: {},
            id: {},
        ...
        setup(__props) {
            const item = __props;
            const enabled = e$2.ref(_GM_getValue(item.id, item.defaultEnable));
            e$2.watch(enabled, () => {
                try {
                    if (enabled.value) {
                        if (!item.noStyle) {
            ...
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, [
                    e$2.createVNode(e$2.unref(oe), {
                        class: "m-0.5 h-fit w-full rounded-lg py-1 hover:bg-blue-50 hover:bg-opacity-50"
                    }, {
                        default: e$2.withCtx(() => [
                            e$2.createElementVNode("div", _hoisted_1$3, [
                                e$2.createVNode(e$2.unref(de), {
                                    class: "flex flex-1 flex-row text-black"
                                }, {
                                    default: e$2.withCtx(() => [
                                        e$2.createVNode(e$2.unref(ue), {
                                            modelValue: enabled.value,
                                            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => enabled.value = $event),
                                            class: e$2.normalizeClass([enabled.value ? "bg-[#00AEEC]" : "bg-gray-200", "relative inline-flex h-6 w-11 items-center rounded-full outline-none transition-colors"])
                                        }, {
                                            default: e$2.withCtx(() => [
                                                e$2.createElementVNode("span", {
                                                    class: e$2.normalizeClass([enabled.value ? "translate-x-6" : "translate-x-1", "inline-block h-4 w-4 transform rounded-full bg-white transition-transform"])
                                                }, null, 2)
                                            ]),
                                            _: 1
                                        }, 8, ["modelValue", "class"]),
                                        e$2.createElementVNode("p", _hoisted_2$2, e$2.toDisplayString(__props.name), 1)
                                    ]),
                                    _: 1
                                })
                            ])
    ...
    const isPageMessage = () => ans === "message";
    ...
    const rawCheck = async (elements, enableFilterVisitSign = true, hideMode, blackPairs, whitePairs, forceBlackPairs) => {
        ...
        await Promise.all(tasks).catch(() => {}).finally(() => {
            requestAnimationFrame(() => {
                for (let i2 = 0; i2 < elements.length; i2++) {
                    toHideIdx.has(i2) ? hideEle(elements[i2], hideMode) : showEle(elements[i2], hideMode);
                    enableFilterVisitSign && elements[i2].setAttribute(config.filterVisitSign, "");
                }
            });
        });
    ...
    const coreCheck = async (elements, enableFilterVisitSign = true, hideMode, blackPairs, whitePairs, forceBlackPairs, noThrottle) => {
        if (noThrottle) {
    ...
    class Shadow {
        ...
        hook() {
            ...
            Element.prototype.attachShadow = function(init) {
                ...
                if (self2.shadowStore.has(tag)) {
                    ...
                    self2.shadowStore.set(tag, new Set([shadowRoot]));
                }
                if (self2.observerStore.has(tag)) {
                    for (const [observer, config2] of self2.observerStore.get(tag)) {
                        observer.observe(shadowRoot, config2);
                    }
                }
                return shadowRoot;
            };
        ...
        addShadowObserver(tag, observer, config2) {
            tag = tag.toUpperCase();
            const curr = this.observerStore.get(tag);
            if (curr) {
                curr.add([observer, config2]);
            } else {
                this.observerStore.set(tag, new Set([
                    [observer, config2]
                ]));
            }
            if (this.shadowStore.size) {
    ...
    class CommentUsernameKeywordFilter extends KeywordFilter {}
    class CommentContentFilter extends KeywordFilter {}
    class CommentAdFilter extends KeywordFilter {}
    class CommentLevelFilter extends NumberMinFilter {}
    class CommentNoFaceFilter extends BooleanFilter {}
    ...
    class CommentEmojiOnlyFilter extends BooleanFilter {}
    ...
    const selectorFns$9 = {
        root: {
            ...
            isLink: (comment) => {
                ...
                if (jump_url) {
                    for (const k2 of Object.keys(jump_url)) {
                        if (!jump_url[k2]?.pc_url?.includes("search.bilibili.com")) {
                            return true;
                        }
                    }
                }
            ...
            isMe: (comment) => {
                const me2 = comment.__user?.uname;
                if (!me2) {
                    return false;
                }
                if (comment.__data?.member?.uname === me2 || comment.__data?.content?.message?.includes(`@${me2}`)) {
                    return true;
                }
                return false;
            }
        ...
        sub: {
            ...
            isLink: (comment) => {
                ...
                if (urls) {
                    for (const k2 of Object.keys(urls)) {
                        if (!urls[k2]?.pc_url?.includes("search.bilibili.com")) {
                            return true;
                        }
                    }
                }
            ...
            isMe: (comment) => {
                ...
                if (comment.__data?.member?.uname === me2 || comment.__data?.content?.message?.trim()?.replace(/^回复\s?@[^@\s]+\s?:/, "").includes(`@${me2}`)) {
                    return true;
                }
                return false;
            }
    ...
    class CommentFilterCommon {
        ...
        async checkRoot(mode) {
            ...
            if (ShadowInstance.shadowStore.has("BILI-COMMENT-THREAD-RENDERER")) {
                ...
                if (mode === "incr") {
                    rootComments = rootComments.filter((v2) => !v2.hasAttribute(config.filterVisitSign));
                }
            }
                ...
                rootComments.forEach((v2) => {
                    logger.debug(
                        [
                            ...
                            `username: ${selectorFns$9.root.username(v2)}`,
                            `content: ${selectorFns$9.root.content(v2)}`,
                            `callUser: ${selectorFns$9.root.callUser(v2)}`,
                            `callUserNoReply: ${selectorFns$9.root.callUserNoReply(v2)}`,
                            `callUserOnly: ${selectorFns$9.root.callUserOnly(v2)}`,
                            `callUserOnlyNoReply: ${selectorFns$9.root.callUserOnlyNoReply(v2)}`,
                            `level: ${selectorFns$9.root.level(v2)}`,
                            `noface: ${selectorFns$9.root.noface(v2)}`,
                            `isUp: ${selectorFns$9.root.isUp(v2)}`,
                            `isPin: ${selectorFns$9.root.isPin(v2)}`,
                            `isNote: ${selectorFns$9.root.isNote(v2)}`,
                            `isLink: ${selectorFns$9.root.isLink(v2)}`,
                            `isMe: ${selectorFns$9.root.isMe(v2)}`,
                            `emojiOnly: ${selectorFns$9.root.emojiOnly(v2)}`
                        ].join("\n")
                    );
                });
            }
        ...
        async checkSub(mode) {
            ...
            if (ShadowInstance.shadowStore.has("BILI-COMMENT-REPLY-RENDERER")) {
                ...
                if (mode === "incr") {
                    subComments = subComments.filter((v2) => !v2.hasAttribute(config.filterVisitSign));
                }
            }
                ...
                subComments.forEach((v2) => {
                    logger.debug(
                        [
                            ...
                            `username: ${selectorFns$9.sub.username(v2)}`,
                            `content: ${selectorFns$9.sub.content(v2)}`,
                            `callUser: ${selectorFns$9.sub.callUser(v2)}`,
                            `callUserNoReply: ${selectorFns$9.sub.callUserNoReply(v2)}`,
                            `callUserOnly: ${selectorFns$9.sub.callUserOnly(v2)}`,
                            `callUserOnlyNoReply: ${selectorFns$9.sub.callUserOnlyNoReply(v2)}`,
                            `level: ${selectorFns$9.sub.level(v2)}`,
                            `noface: ${selectorFns$9.sub.noface(v2)}`,
                            `isUp: ${selectorFns$9.sub.isUp(v2)}`,
                            `isLink: ${selectorFns$9.sub.isLink(v2)}`,
                            `isMe: ${selectorFns$9.sub.isMe(v2)}`,
                            `emojiOnly: ${selectorFns$9.sub.emojiOnly(v2)}`
                        ].join("\n")
                    );
                });
            }
    ...
    const mainFilter$9 = new CommentFilterCommon();
    ...
    const commentFilterCommonGroups = [{
            ...
            items: [{
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$9.commentUsernameKeywordFilter.setParam(
                            _GM_getValue(GM_KEYS$9.black.usernameKeyword.valueKey, [])
                        );
                        mainFilter$9.check("full");
                    }
                }
    ...
    const commentFilterCommonHandler = (target) => {
        ...
        if (target.parentElement?.id === "user-name" || target.classList.contains("user-name") || target.classList.contains("sub-user-name")) {
            ...
            if (username && mainFilter$9.commentUsernameFilter.isEnable) {
                menus.push({
                    name: `屏蔽用户：${username}`,
                    fn: async () => {
                        try {
    ...
    class DynDynVideoFilter extends BooleanFilter {}
    class DynPlaybackFilter extends BooleanFilter {}
    class DynVideoTitleWhiteFilter extends KeywordFilter {}
    class DynContentWhiteFilter extends KeywordFilter {}
    const GM_KEYS$8 = {
        black: {
            uploader: {
...
.dyn-card-opus__summary span
            ...
            ).map((v2) => v2?.textContent?.trim()).filter((v2) => v2?.trim()).join("\n");
        },
        dynVideo: (dyn) => {
    ...
    class DynamicFilterDynamic {
        ...
        async check(mode) {
            ...
            let revertAll = false;
            if (!(this.dynUploaderFilter.isEnable || this.dynDurationFilter.isEnable || this.dynVideoTitleFilter.isEnable || this.dynContentFilter.isEnable || this.dynDynVideoFilter.isEnable || this.dynPlaybackFilter.isEnable)) {
                revertAll = true;
            }
            const timer = performance.now();
            ...
            if (revertAll) {
                dyns.forEach((v2) => showEle(v2, "sign"));
                return;
            }
            if (config.isDebugMode) {
                dyns.forEach((v2) => {
                    logger.debug(
                        [
                            ...
                            `uploader: ${selectorFns$8.uploader(v2)}`,
                            `title: ${selectorFns$8.title(v2)}`,
                            `duration: ${selectorFns$8.duration(v2)}`,
                            `content: ${selectorFns$8.content(v2)}`,
                            `shortVideo: ${selectorFns$8.dynVideo(v2)}`,
                            `playback: ${selectorFns$8.playback(v2)}`
                        ].join("\n")
                    );
                });
            }
    ...
    const mainFilter$8 = new DynamicFilterDynamic();
    ...
    const dynamicFilterDynamicHandler = (target) => {
        ...
        if (target.classList.contains("bili-dyn-title__text")) {
            ...
            if (uploader && mainFilter$8.dynUploaderFilter.isEnable) {
                menus.push({
    ...
    const mainFilter$7 = new DynamicFilterHeader();
    const dynamicFilterHeaderEntry = async () => {
        mainFilter$7.init();
        mainFilter$7.observe();
        if (_GM_getValue(GM_KEYS$7.black.uploader.statusKey)) {
            mainFilter$7.dynUploaderFilter.enable();
        }
        if (_GM_getValue(GM_KEYS$7.black.title.statusKey)) {
            mainFilter$7.dynVideoTitleFilter.enable();
        }
        if (_GM_getValue(GM_KEYS$7.black.content.statusKey)) {
            mainFilter$7.dynContentFilter.enable();
        }
        if (_GM_getValue(GM_KEYS$7.white.title.statusKey)) {
            mainFilter$7.dynVideoTitleWhiteFilter.enable();
        }
        if (_GM_getValue(GM_KEYS$7.white.content.statusKey)) {
...
.dyn-card-opus__summary span
    ...
    class DynamicFilterSpace {
        ...
        async check(mode) {
            ...
            let revertAll = false;
            if (!(this.dynDurationFilter.isEnable || this.dynVideoTitleFilter.isEnable || this.dynContentFilter.isEnable || this.dynDynVideoFilter.isEnable || this.dynPlaybackFilter.isEnable)) {
                revertAll = true;
            }
            const timer = performance.now();
            let selector = `.bili-dyn-list__item`;
                ...
                dyns.forEach((v2) => {
                    logger.debug(
                        [
                            ...
                            `shortVideo: ${selectorFns$6.dynVideo(v2)}`,
                            `playback: ${selectorFns$6.playback(v2)}`
                        ].join("\n")
                    );
                });
            }
    ...
    const selectorFns$5 = {
        ...
        bvid: (video) => {
            const href2 = video.querySelector(".bili-video-card__title a")?.getAttribute("href") || video.querySelector(".bili-cover-card")?.getAttribute("href");
    ...
    class VideoFilterChannel {
        ...
        async check(mode) {
            ...
            if (revertAll) {
                videos.forEach((v2) => showEle(v2, "sign"));
                return;
            }
            if (config.isDebugMode) {
                videos.forEach((v2) => {
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$5.videoUploaderKeywordFilter.setParam(
                            _GM_getValue(GM_KEYS$5.black.uploaderKeyword.valueKey, [])
                        );
                        mainFilter$5.checkFull();
                    }
                }
    ...
    const videoFilterChannelHandler = (target) => {
        ...
        if (target.closest(".bili-video-card__author")) {
            ...
            const url = target.closest(".bili-video-card__author")?.href.trim();
    ...
    const selectorFns$4 = {
        ...
        bvid: (video) => {
            const href2 = video.querySelector(".bili-video-card__info--tit a")?.getAttribute("href") || video.querySelector(".bili-video-card__image--link")?.getAttribute("href");
            return (href2 && matchBvid(href2)) ?? void 0;
        },
        uploader: (video) => {
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$4.videoUploaderKeywordFilter.setParam(
                            _GM_getValue(GM_KEYS$4.black.uploaderKeyword.valueKey, [])
                        );
                        mainFilter$4.checkFull();
                    }
                }
    ...
    const videoFilterHomepageHandler = (target) => {
        ...
        if (target.closest(".bili-video-card__info--owner")) {
            ...
            const url = target.closest(".bili-video-card__info--owner")?.href.trim();
            const spaceUrl = url?.match(/space\.bilibili\.com\/\d+/)?.[0];
            if (uploader) {
    ...
    const getVideoData = (video) => {
        ...
        if (!video.classList.contains("rank-item")) {
            return video.__vue__?.videoData;
        }
        const rank = video.getAttribute("data-rank");
        if (rank && parseInt(rank) > 0) {
            videoData = video.closest(".rank-list-wrap")?.__vue__?.list?.[parseInt(rank) - 1];
        }
        return videoData;
    };
    const selectorFns$3 = {
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$3.videoUploaderKeywordFilter.setParam(
                            _GM_getValue(GM_KEYS$3.black.uploaderKeyword.valueKey, [])
                        );
                        mainFilter$3.checkFull();
                    }
                }
    ...
    const selectorFns$2 = {
        ...
        bvid: (video) => {
            const href2 = video.querySelector(".bili-video-card__wrap > a")?.getAttribute("href") || video.querySelector(".bili-video-card__info--right > a")?.getAttribute("href");
            return (href2 && matchBvid(href2)) ?? void 0;
        },
        uploader: (video) => {
            return video.querySelector(".bili-video-card__info--author")?.textContent?.trim();
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$2.videoUploaderKeywordFilter.setParam(
                            _GM_getValue(GM_KEYS$2.black.uploaderKeyword.valueKey, [])
                        );
                        mainFilter$2.checkFull();
                    }
                }
    ...
    const selectorFns$1 = {
        ...
        bvid: (video) => {
            const href2 = video.querySelector("a.title")?.getAttribute("href")?.trim() || video.querySelector(".bili-video-card__title a")?.getAttribute("href")?.trim();
            return (href2 && matchBvid(href2)) ?? void 0;
        }
    };
    ...
    const selectorFns = {
        ...
        bvid: (video) => {
            const href2 = video.querySelector(".info > a")?.getAttribute("href") || video.querySelector(".pic-box .framepreview-box > a")?.getAttribute("href");
            return (href2 && matchBvid(href2)) ?? void 0;
        },
        uploader: (video) => {
...
.rec-list :is(.video-page-card-small, .video-page-operator-card-small), .recommend-video-card`;
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter.videoUploaderKeywordFilter.setParam(
                            _GM_getValue(GM_KEYS.black.uploaderKeyword.valueKey, [])
                        );
                        mainFilter.checkFull();
                    }
                }
    ...
    const useRulePanelStore = defineStore("RulePanel", () => {
        const isShow = e$2.ref(false);
        const show = () => {
            isShow.value = true;
        };
        const hide = () => {
    ...
    const useVideoFilterPanelStore = defineStore("VideoFilterPanel", () => {
        const isShow = e$2.ref(false);
        const show = () => {
            isShow.value = true;
        };
    ...
    const useCommentFilterPanelStore = defineStore("CommentFilterPanel", () => {
        const isShow = e$2.ref(false);
        const show = () => {
            isShow.value = true;
        };
    ...
    const useDynamicFilterPanelStore = defineStore("DynamicFilterPanel", () => {
        const isShow = e$2.ref(false);
        const show = () => {
            isShow.value = true;
        };
    ...
    const useSideBtnStore = defineStore("SideBtn", () => {
    ...
    const _sfc_main$6 = e$2.defineComponent({
        __name: "CommentFilterPanelView",
        setup(__props) {
            const store = useCommentFilterPanelStore();
            const editorDialogRef = e$2.ref(null);
            ...
            return (_ctx, _cache) => {
                return e$2.withDirectives((e$2.openBlock(), e$2.createBlock(_sfc_main$e, e$2.mergeProps({
                    title: "评论过滤（全站通用）",
                    widthPercent: 28,
                    heightPercent: 85,
                    minWidth: 360,
                    ...
                    onClose: e$2.unref(store).hide
                }), {
                    default: e$2.withCtx(() => [
                        (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(e$2.unref(currPageGroups), (group, index) => {
                            return e$2.openBlock(), e$2.createElementBlock("div", {
                                key: index
                            }, [
                                e$2.createVNode(_sfc_main$f, e$2.mergeProps({
                                    ref_for: true
                                }, {
                                    title: group.name,
                                    isFold: group.fold
                                    ...
                                    default: e$2.withCtx(() => [
                                        (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(group.items, (item, innerIndex) => {
                                            return e$2.openBlock(), e$2.createElementBlock("div", {
                                                key: innerIndex
                                            }, [
                                                item.type === "switch" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$7, e$2.mergeProps({
                                                    key: 0,
                                                    ref_for: true
                                                }, item), null, 16)) : item.type === "number" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$9, e$2.mergeProps({
                                                    key: 1,
                                                    ref_for: true
                                                }, item), null, 16)) : item.type === "string" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$8, e$2.mergeProps({
                                                    key: 2,
                                                    ref_for: true
                                                }, item), null, 16)) : item.type === "editor" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$b, e$2.mergeProps({
                                                    key: 3,
                                                    ref_for: true
                                                }, item, {
                                                    onEdit: handleEdit
                                                }), null, 16)) : item.type === "list" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$a, e$2.mergeProps({
                                                    key: 4,
                                                    ref_for: true
                                                }, item), null, 16)) : e$2.createCommentVNode("", true)
                                            ]);
                                        }), 128))
                                    ]),
                                    _: 2
                    ...
                    [e$2.vShow, e$2.unref(store).isShow]
                ]);
            };
        }
    });
    ...
    const _sfc_main$5 = e$2.defineComponent({
        __name: "ContextMenuView",
        setup(__props) {
            const show = e$2.ref(false);
            const pos = e$2.reactive({
                left: -9999,
                top: -9999
            });
            const menuList = e$2.ref([]);
            ...
            return (_ctx, _cache) => {
                return show.value ? (e$2.openBlock(), e$2.createElementBlock("div", {
                    key: 0,
                    ...
                    style: e$2.normalizeStyle({
                        left: pos.left + "px",
                        top: pos.top + "px"
                    })
                }, [
                    (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(menuList.value, (menu2, index) => {
                        return e$2.openBlock(), e$2.createElementBlock("div", {
                            key: index
                        }, [
                            e$2.createElementVNode("div", {
                                onClick: ($event) => menu2.fn()?.catch(() => {}),
                                class: "px-2.5 py-1 hover:bg-[#00aeec] hover:text-white"
                            }, [
                                _cache[0] || (_cache[0] = e$2.createElementVNode("span", {
                                    class: "mr-0.5"
                                }, "◎", -1)),
                                e$2.createTextVNode(" " + e$2.toDisplayString(menu2.name), 1)
                            ], 8, _hoisted_1$2),
                            index < menuList.value.length - 1 ? (e$2.openBlock(), e$2.createElementBlock("hr", _hoisted_2$1)) : e$2.createCommentVNode("", true)
                        ]);
                    }), 128))
                ], 4)) : e$2.createCommentVNode("", true);
            };
        }
    });
    const _sfc_main$4 = e$2.defineComponent({
...
https://www.bilibili.com${location.pathname}`;
    ...
    let preventVolumeTune$1 = false;
    let cleanUp$1 = () => {};
    const isWebScreen$1 = () => {
        if (_unsafeWindow.player?.getManifest()?.screenKind === 2) {
            return true;
        }
        return !!document.querySelector("#bilibili-player-wrap[class^=video_playerFullScreen]");
    };
    const isMiniScreen$1 = () => {
    ...
    for (const eventName of ["mousewheel", "DOMMouseScroll", "wheel"]) {
        useEventListener(
            ...
            eventName,
            (e2) => {
                if (preventVolumeTune$1 && isWebScreen$1() && !isMiniScreen$1()) {
    ...
    const handleFullScreenClick$1 = (e2) => {
    ...
    const handleFullScreenDblClick$1 = (e2) => {
        const target = e2.target;
            ...
            enableFn: async () => {
                ...
                if (coinBtn) {
                    ...
                    document.addEventListener("DOMContentLoaded", () => {
                        ...
                        coinBtn2?.addEventListener("click", disableAutoLike);
                    });
                }
            }
        },
...
#user-name a {color: #61666d !important;}`
    ...
    const useGMValue = (key, initialValue, options = {}) => {
        const {
            deep = true, syncFromStorage = true, debounce = 1e3
        } = options;
        const state = e$2.ref(_GM_getValue(key, initialValue));
        watchDebounced(
            state,
            (value) => {
    ...
    function useCookies(dependencies, {
        ...
        const touches = e$2.shallowRef(0);
        const onChange = () => {
    ...
    const isDarkMode = e$2.ref(false);
            ...
            _unsafeWindow.fetch = async (input, init) => {
                ...
                try {
                    for (const fn of this.postFnArr) {
                        const ans2 = await fn(input, init, resp);
                        if (ans2) {
                            resp = ans2;
                        }
                    }
...
https://${domain}/${avbv}` : `https://${domain}/${avbv}`;
    ...
    const handleFullScreenClick = (e2) => {
        const target = e2.target;
        if (target.closest("#bilibili-player .bpx-player-ctrl-full") || target.classList.contains("bpx-player-ctrl-full") && target.classList.contains("#bilibili-player")) {
            e2.stopImmediatePropagation();
            toggleFullScreen();
    ...
    const handleFullScreenDblClick = (e2) => {
        const target = e2.target;
        if (target.closest("#bilibili-player .bpx-player-video-perch") || target.classList.contains("bpx-player-video-perch") && target.closest("#bilibili-player")) {
            e2.stopImmediatePropagation();
            document.querySelector("#bilibili-player video")?.pause();
    ...
    const videoPlayerLayoutItems = [{
        ...
        },
        {
            ...
            enableFn: () => {
                const id = setInterval(() => {
                    if (typeof _unsafeWindow.player?.requestStatue === "function") {
                        _unsafeWindow.player.requestStatue(2).then(() => {
                            clearInterval(id);
                            const id2 = setInterval(() => {
                                ...
                                if (container && video && container.getAttribute("data-screen") === "web") {
                                    const a2 = container.offsetHeight / innerHeight;
                                    const b2 = container.offsetWidth / innerWidth;
                                    const c2 = video.offsetHeight / innerHeight;
                                    if (a2 > 0.9 && a2 < 1.1 && b2 > 0.9 && b2 < 1.1 && c2 > 0.9 && c2 < 1.1) {
                                        clearInterval(id2);
                                        setTimeout(() => {
        ...
        },
        {
            ...
            enableFn: () => {
                Element.prototype.getBoundingClientRect = function() {
                    if (!document.fullscreenElement && isWebScreen() && (this.id === "arc_toolbar_report" || this.id === "playlistToolbar")) {
    ...
    const _sfc_main$3 = e$2.defineComponent({
        ...
        setup(__props) {
            ...
            return (_ctx, _cache) => {
                return e$2.withDirectives((e$2.openBlock(), e$2.createBlock(_sfc_main$e, e$2.mergeProps({
                    ...
                    default: e$2.withCtx(() => [
                        (e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(currRules, (rule, i2) => {
                            return e$2.createElementVNode("div", {
                                key: i2
                            }, [
                                (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(rule.groups, (group, j2) => {
                                    return e$2.openBlock(), e$2.createElementBlock("div", {
                                        key: j2
                                    }, [
                                        e$2.createVNode(_sfc_main$f, e$2.mergeProps({
    ...
    const _hoisted_2 = {
        class: "select-none text-center text-[13px] leading-4"
    };
    const _hoisted_3 = {
        class: "select-none text-center text-[13px] leading-4"
    };
    const _sfc_main$2 = e$2.defineComponent({
        __name: "SideBtnView",
        setup(__props) {
            ...
            const isDragging = e$2.ref(false);
            const windowSize = useWindowSize({
                includeScrollbar: false
            });
            const maxPos = e$2.computed(() => {
            ...
            const buttons = [{
                    text: e$2.computed(() => isDarkMode.value ? "日间模式" : "夜间模式"),
                    defaultHidden: true,
                    isValid: true,
            ...
            useDraggable(target, {
                ...
                preventDefault: true,
                handle: e$2.computed(() => target.value),
                onMove: (pos) => {
            ...
            return (_ctx, _cache) => {
                return e$2.unref(sideBtnStore).isShow ? (e$2.openBlock(), e$2.createElementBlock("div", {
                    key: 0,
                    class: e$2.normalizeClass(["group fixed flex flex-col justify-end text-opacity-50 will-change-[right,bottom] hover:text-opacity-100", [e$2.unref(isDarkMode) ? "text-white" : "text-black", e$2.unref(isPageBangumi)() || e$2.unref(isPageVideo)() ? "z-[100]" : "z-[2000]"]]),
                    ref_key: "target",
                    ref: target,
                    style: e$2.normalizeStyle({
                        right: e$2.unref(btnPos).right + "px",
                        bottom: e$2.unref(btnPos).bottom + "px"
                    })
                }, [
                    (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(buttons.filter((btn) => btn.isValid), (btn, index) => {
                        return e$2.openBlock(), e$2.createElementBlock("div", {
                            class: e$2.normalizeClass(["mt-1 h-10 w-10 cursor-pointer items-center justify-center rounded-lg border transition-colors hover:border-none hover:bg-[#00AEEC] hover:text-white", [
                                e$2.unref(isDarkMode) ? "border-[#2f3134] bg-[#242628]" : "border-gray-200 bg-white",
                                btn.defaultHidden && !isDragging.value ? "hidden group-hover:flex" : "flex"
                            ]]),
                            key: index,
                            onClick: ($event) => btn.click()
                        }, [
                            e$2.createElementVNode("div", null, [
                                e$2.createElementVNode("p", _hoisted_2, e$2.toDisplayString(btn.text.value.substring(0, 2)), 1),
                                e$2.createElementVNode("p", _hoisted_3, e$2.toDisplayString(btn.text.value.substring(2, 4)), 1)
                            ])
                        ], 10, _hoisted_1$1);
                    }), 128))
                ], 6)) : e$2.createCommentVNode("", true);
            };
        }
    });
    const _sfc_main$1 = e$2.defineComponent({
    ...
    const _sfc_main = e$2.defineComponent({
        __name: "App",
        setup(__props) {
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock("div", _hoisted_1, [
                    e$2.createVNode(_sfc_main$3),
                    e$2.createVNode(_sfc_main$1),
                    e$2.createVNode(_sfc_main$6),
                    e$2.createVNode(_sfc_main$4),
                    e$2.createVNode(_sfc_main$5),
                    e$2.createVNode(_sfc_main$2)
                ]);
            };
        }
    });
    ...
    const loadSwitchItem = (item) => {
        const enable = _GM_getValue(item.id, item.defaultEnable);
        if (enable) {
            if (!item.noStyle) {
                document.documentElement.setAttribute(item.attrName ?? item.id, "");
            }
    ...
    const migrate = async () => {
        ...
        for (const [key, valueMap] of Object.entries(renameMap)) {
            ...
            if (value in valueMap) {
                _GM_setValue(key, valueMap[value]);
            }
        }
    ...
    const main = () => {
        ...
        const app = e$2.createApp(_sfc_main);
