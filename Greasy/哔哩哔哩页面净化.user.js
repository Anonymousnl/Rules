...
https://www.bilibili.com${location.pathname}`;
	...
	const bangumiPlayerLayoutItems = [{
		...
		enableFn: async () => {
			...
			const id = setInterval(() => {
				var _a;
				const webBtn = document.body.querySelector("#bilibili-player .bpx-player-ctrl-web");
				const fullBtn = document.body.querySelector("#bilibili-player .bpx-player-ctrl-full");
				if(webBtn && fullBtn) {
					clearInterval(id);
					const isFullScreen = () => {
					...
					newFullBtn.addEventListener("click", fn2);
					...
					const id2 = setInterval(() => {
						...
						if(perchEl) {
							clearInterval(id2);
							perchEl.addEventListener("dblclick",
								(event) => {
									var _a2;
									(_a2 = document.querySelector("#bilibili-player video")) == null ? void 0 : _a2.pause();
