...
// @grant       GM_setValue
// @grant       unsafeWindow
// @require     https://registry.npmmirror.com/vue/3.5.14/files/dist/vue.global.prod.js
...
.rec-list :is(.video-page-card-small, .video-page-operator-card-small), .recommend-video-card`;
	...
	const videoFilterVideoHandler = (target) => {
		...
		const menus = [];
		if(target.closest(".right-container") && (target.classList.contains("name") || target.classList.contains("up-name") || ((_a = target.parentElement) == null ? void 0 : _a.classList.contains("up-name")) || target.closest(".staff-info"))) {
