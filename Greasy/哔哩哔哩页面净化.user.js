		...
		async checkRoot(mode) {
			...
			if(settings.enableDebugFilter) {
				rootComments.forEach((v2) => {
					debugFilter(
						[`CommentFilterCommon rootComments`, `username: ${selectorFns$8.root.username(v2)}`, `content: ${selectorFns$8.root.content(v2)}`, `callUser: ${selectorFns$8.root.callUser(v2)}`, `callUserNoReply: ${selectorFns$8.root.callUserNoReply(v2)}`, `callUserOnly: ${selectorFns$8.root.callUserOnly(v2)}`, `callUserOnlyNoReply: ${selectorFns$8.root.callUserOnlyNoReply(v2)}`, `level: ${selectorFns$8.root.level(v2)}`, `isUp: ${selectorFns$8.root.isUp(v2)}`, `isPin: ${selectorFns$8.root.isPin(v2)}`, `isNote: ${selectorFns$8.root.isNote(v2)}`, `isLink: ${selectorFns$8.root.isLink(v2)}`, `isMe: ${selectorFns$8.root.isMe(v2)}`].join("\n"));
				});
			}
		...
		async checkSub(mode) {
			...
			if(settings.enableDebugFilter) {
				subComments.forEach((v2) => {
					debugFilter(
						[`CommentFilterCommon subComments`, `username: ${selectorFns$8.sub.username(v2)}`, `content: ${selectorFns$8.sub.content(v2)}`, `callUser: ${selectorFns$8.sub.callUser(v2)}`, `callUserNoReply: ${selectorFns$8.sub.callUserNoReply(v2)}`, `callUserOnly: ${selectorFns$8.sub.callUserOnly(v2)}`, `callUserOnlyNoReply: ${selectorFns$8.sub.callUserOnlyNoReply(v2)}`, `level: ${selectorFns$8.sub.level(v2)}`, `isUp: ${selectorFns$8.sub.isUp(v2)}`, `isLink: ${selectorFns$8.sub.isLink(v2)}`, `isMe: ${selectorFns$8.sub.isMe(v2)}`].join("\n"));
				});
			}
	...
	class DynamicFilterDynamic {
		...
		async check(mode) {
			...
			if(settings.enableDebugFilter) {
				dyns.forEach((v2) => {
					debugFilter(
						[`DynamicFilterDynamic`, `uploader: ${selectorFns$7.uploader(v2)}`, `title: ${selectorFns$7.title(v2)}`, `duration: ${selectorFns$7.duration(v2)}`, `content: ${selectorFns$7.content(v2)}`, `shortVideo: ${selectorFns$7.dynVideo(v2)}`, `playback: ${selectorFns$7.playback(v2)}`].join("\n"));
				});
			}
			const blackPairs = [];
