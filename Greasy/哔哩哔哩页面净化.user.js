...
.dyn-card-opus__summary span
    ...
    class DynamicFilterDynamic {
        constructor() {
            ...
            // 白名单
            __publicField(this, "dynVideoTitleWhiteFilter", new DynVideoTitleWhiteFilter());
            __publicField(this, "dynContentWhiteFilter", new DynContentWhiteFilter());
        }
        init() {
            ...
            this.dynVideoTitleWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$8.white.title.valueKey, []));
            this.dynContentWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$8.white.content.valueKey, []));
        }
        async check(mode) {
            if (!this.target) {
                return;
        ...
        },
        {
            ...
            items: [{
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$8.dynVideoTitleWhiteFilter.setParam(
                            BiliCleanerStorage.get(GM_KEYS$8.white.title.valueKey, [])
                        );
                        mainFilter$8.checkFull();
                    }
                },
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$8.dynContentWhiteFilter.setParam(
                            BiliCleanerStorage.get(GM_KEYS$8.white.content.valueKey, [])
                        );
                        mainFilter$8.checkFull();
                    }
                }
    ...
    class DynamicFilterHeader {
        ...
        init() {
            ...
            this.dynVideoTitleWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$7.white.title.valueKey, []));
            this.dynContentWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$7.white.content.valueKey, []));
        }
        async check(mode) {
            if (!this.target) {
                return;
    ...
    const dynamicFilterHeaderEntry = async () => {
        ...
        if (BiliCleanerStorage.get(GM_KEYS$7.white.title.statusKey)) {
            mainFilter$7.dynVideoTitleWhiteFilter.enable();
        }
        if (BiliCleanerStorage.get(GM_KEYS$7.white.content.statusKey)) {
...
.dyn-card-opus__summary span
    ...
    class DynamicFilterSpace {
        ...
        init() {
            ...
            this.dynVideoTitleWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$6.white.title.valueKey, []));
            this.dynContentWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$6.white.content.valueKey, []));
        }
        async check(mode) {
            if (!this.target) {
                return;
        ...
        },
        {
            ...
            items: [{
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$6.dynVideoTitleWhiteFilter.setParam(
                            BiliCleanerStorage.get(GM_KEYS$6.white.title.valueKey, [])
                        );
                        mainFilter$6.checkFull();
                    }
                },
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$6.dynContentWhiteFilter.setParam(
                            BiliCleanerStorage.get(GM_KEYS$6.white.content.valueKey, [])
                        );
                        mainFilter$6.checkFull();
                    }
                }
