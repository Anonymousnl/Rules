...
(function(e$1) {
    ...
    function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
        ...
        const setupStore = runWithContext(() => pinia._e.run(() => (scope = e$1.effectScope()).run(() => setup({
            action
        }))));
    ...
    function d$2(u2, e2, r2) {
        let i2 = e$1.ref(r2 == null ? void 0 : r2.value),
            f2 = e$1.computed(() => u2.value !== void 0);
...
`));
    ...
    function k$1({
        ...
        return e$1.provide(u, {
            register: r2,
            slot: t2,
            name: o2,
            props: s3
        }), e$1.computed(() => e2.value.length > 0 ? e2.value.join(" ") : void 0);
    }
    e$1.defineComponent({
        name: "Description",
        props: {
    ...
    let N = e$1.defineComponent({
            ...
            setup(t$12, {
                ...
                let s3 = e$1.ref(t$12.defaultOpen ? 0 : 1),
                    e2 = e$1.ref(null),
                    i$12 = e$1.ref(null),
                    n2 = {
                        buttonId: e$1.ref(`headlessui-disclosure-button-${i$4()}`),
                        panelId: e$1.ref(`headlessui-disclosure-panel-${i$4()}`),
                        disclosureState: s3,
                        panel: e2,
                        button: i$12,
                        toggleDisclosure() {
                ...
                return e$1.provide(T, n2), t(e$1.computed(() => u$5(s3.value, {
                    [0]: i.Open,
                    [1]: i.Closed
                }))), () => {
                    let {
        ...
        Q = e$1.defineComponent({
            ...
            setup(t2, {
                ...
                let e2 = O("DisclosureButton"),
                    i2 = U(),
                    n2 = e$1.computed(() => i2 === null ? false : i2.value === e2.panelId.value);
                e$1.onMounted(() => {
                ...
                s$12({
                    el: l2,
                    $el: l2
                }), n2.value || e$1.watchEffect(() => {
                    e2.button.value = l2.value;
                });
                let a2 = s2(e$1.computed(() => ({
                    as: t2.as,
                    type: r2.type
                })), l2);
        ...
        V = e$1.defineComponent({
            ...
            setup(t2, {
                ...
                e$1.onMounted(() => {
                    ...
                    el: e2.panel,
                    $el: e2.panel
                }), e$1.provide(k, e2.panelId);
                let i$12 = l(),
                    n2 = e$1.computed(() => i$12 !== null ? (i$12.value & i.Open) === i.Open : e2.disclosureState.value === 0);
                return () => {
                    var v2;
                    let l2 = {
                            open: e2.disclosureState.value === 0,
    ...
    let Ie = e$1.defineComponent({
        ...
        setup(o2, {
            ...
            let D = e$1.computed(() => o2.multiple ? 1 : 0),
                [y2, L] = d$2(e$1.computed(() => o2.modelValue), (t2) => w2("update:modelValue", t2), e$1.computed(() => o2.defaultValue)),
                M = e$1.computed(() => y2.value === void 0 ? u$5(D.value, {
                    [1]: [],
                    [0]: void 0
                }) : y2.value),
                k2 = {
                    ...
                    orientation: e$1.computed(() => o2.horizontal ? "horizontal" : "vertical"),
                    labelRef: e$12,
                    buttonRef: f2,
                    optionsRef: v2,
                    disabled: e$1.computed(() => o2.disabled),
                    options: s3,
                    searchQuery: m,
                    ...
                    select(t2) {
                        o2.disabled || L(u$5(D.value, {
                            [0]: () => t2,
                            [1]: () => {
                                let i2 = e$1.toRaw(k2.value.value).slice(),
                                    l2 = e$1.toRaw(t2),
                                    d2 = i2.findIndex((O2) => k2.compare(l2, e$1.toRaw(O2)));
            ...
            }, e$1.computed(() => n2.value === 0)), e$1.provide($, k2), t(e$1.computed(() => u$5(n2.value, {
                [0]: i.Open,
                [1]: i.Closed
            })));
            let C2 = e$1.computed(() => {
            ...
            return e$1.onMounted(() => {
                ...
                return e$1.h(e$1.Fragment, [...t2 != null && M.value != null ? e({
                    [t2]: M.value
                }).map(([I, Q2]) => e$1.h(f$2, E$1({
                    features: u$2.Hidden,
                    key: I,
                    as: "input",
                    type: "hidden",
    ...
    let je = e$1.defineComponent({
        ...
        Ae = e$1.defineComponent({
            ...
            setup(o2, {
                ...
                let s3 = l(),
                    m = e$1.computed(() => s3 !== null ? (s3.value & i.Open) === i.Open : e2.listboxState.value === 0);
                return () => {
                    var y2, L;
                    let a2 = {
                            open: e2.listboxState.value === 0
        ...
        Fe = e$1.defineComponent({
            ...
            setup(o2, {
                ...
                let v2 = e$1.computed(() => e2.activeOptionIndex.value !== null ? e2.options.value[e2.activeOptionIndex.value].id === n2 : false),
                    s3 = e$1.computed(() => u$5(e2.mode.value, {
                        [0]: () => e2.compare(e$1.toRaw(e2.value.value), e$1.toRaw(o2.value)),
                        [1]: () => e$1.toRaw(e2.value.value).some((t2) => e2.compare(e$1.toRaw(t2), e$1.toRaw(o2.value)))
                    })),
                    m = e$1.computed(() => u$5(e2.mode.value, {
                        [1]: () => {
                            var i2;
        ...
        ue = e$1.defineComponent({
            ...
            setup(l2, {
                ...
                let p2 = (h2 = l2.id) != null ? h2 : `headlessui-switch-${i$4()}`,
                    n2 = e$1.inject(C, null),
                    [t2, s$12] = d$2(e$1.computed(() => l2.modelValue), (e2) => c2("update:modelValue", e2), e$1.computed(() => l2.defaultChecked));
                ...
                return e$1.onMounted(() => {
                    ...
                    return e$1.h(e$1.Fragment, [e2 != null && t2.value != null ? e$1.h(f$2, E$1({
                        features: u$2.Hidden,
                        as: "input",
                        type: "checkbox",
                        hidden: true,
    ...
    const _sfc_main$e = /* @__PURE__ */ e$1.defineComponent({
        ...
        setup(__props) {
            return (_ctx, _cache) => {
                return e$1.openBlock(), e$1.createElementBlock("div", _hoisted_1$a, [
    ...
    const injectLocal = (...args) => {
        ...
        if (instance == null && !e$1.hasInjectionContext()) throw new Error("injectLocal must be called in setup");
    ...
    function pausableFilter(extendFilter = bypassFilter, options = {}) {
        ...
        return {
            isActive: e$1.readonly(isActive),
            pause,
            resume,
            eventFilter
        };
    ...
    function toRef(...args) {
        if (args.length !== 1) return e$1.toRef(...args);
        const r2 = args[0];
        return typeof r2 === "function" ? e$1.readonly(e$1.customRef(() => ({
            get: r2,
            set: noop
        }))) : e$1.ref(r2);
    }
    ...
    function watchWithFilter(source, cb, options = {}) {
        const {
            eventFilter = bypassFilter, ...watchOptions
        } = options;
        return e$1.watch(source, createFilterWrapper(eventFilter, cb), watchOptions);
    }
    ...
    function toRefs(objectRef, options = {}) {
        if (!e$1.isRef(objectRef)) return e$1.toRefs(objectRef);
    ...
    function tryOnMounted(fn2, sync = true, target) {
        ...
        if (instance) e$1.onMounted(fn2, target);
        else if (sync) fn2();
        else e$1.nextTick(fn2);
    }

    function watchImmediate(source, cb, options) {
        return e$1.watch(source, cb, {
            ...options,
            immediate: true
        });
    }
    ...
    function useEventListener(...args) {
        ...
        const stopWatch = watchImmediate(
            ...
            ([raw_targets, raw_events, raw_listeners, raw_options]) => {
                ...
                cleanups.push(...raw_targets.flatMap(
    ...
    function useMediaQuery(query, options = {}) {
        ...
        const ssrSupport = e$1.shallowRef(typeof ssrWidth === "number");
    ...
    function useBroadcastChannel(options) {
        ...
        const isClosed = e$1.shallowRef(false);
        const channel = e$1.ref();
        const data2 = e$1.ref();
        const error2 = e$1.shallowRef(null);
        const post2 = (data22) => {
            if (channel.value) channel.value.postMessage(data22);
        };
        const close = () => {
    ...
    function useStorage(key, defaults2, storage, options = {}) {
        ...
        const data2 = (shallow ? e$1.shallowRef : e$1.ref)(typeof defaults2 === "function" ? defaults2() : defaults2);
        ...
        function update(event) {
            ...
            pauseWatch();
            try {
                if ((event == null ? void 0 : event.newValue) !== serializer.write(data2.value)) data2.value = read(event);
            } catch (e2) {
                onError(e2);
            } finally {
                if (event) e$1.nextTick(resumeWatch);
                else resumeWatch();
            }
        }
    ...
    function useDraggable(target, options = {}) {
        ...
        const position = e$1.ref(
            (_a = e$1.toValue(initialValue)) != null ? _a : {
                x: 0,
                y: 0
            });
        const pressedDelta = e$1.ref();
        const filterEvent = (e2) => {
            if (pointerTypes) return pointerTypes.includes(e2.pointerType);
            return true;
        };
        const handleEvent = (e2) => {
            if (e$1.toValue(preventDefault2)) e2.preventDefault();
            if (e$1.toValue(stopPropagation)) e2.stopPropagation();
        };
        const start = (e2) => {
            var _a2;
            if (!e$1.toValue(buttons).includes(e2.button)) return;
            if (e$1.toValue(options.disabled) || !filterEvent(e2)) return;
            if (e$1.toValue(exact) && e2.target !== e$1.toValue(target)) return;
            ...
            if ((onStart == null ? void 0 : onStart(pos, e2)) === false) return;
        ...
        const move = (e2) => {
            ...
            if (axis === "y" || axis === "both") {
                ...
                if (container) y2 = Math.min(Math.max(0, y2), container.scrollHeight - targetRect.height);
            }
            position.value = {
                x,
                y: y2
    ...
    function useResizeObserver(target, callback, options = {}) {
        ...
        const stopWatch = e$1.watch(targets,
            (els) => {
                cleanup();
    ...
    function useWindowSize(options = {}) {
        ...
        const width = e$1.shallowRef(initialWidth);
        const height = e$1.shallowRef(initialHeight);
        const update = () => {
            if (window2) {
                if (type === "outer") {
            ...
            return (_ctx, _cache) => {
                return e$1.openBlock(), e$1.createElementBlock("div", {
                    ...
                    e$1.createElementVNode("div", {
                        ...
                        e$1.createElementVNode("div", _hoisted_1$9, e$1.toDisplayString(_ctx.title), 1),
                    ...
                    e$1.createElementVNode("div", _hoisted_2$7, [
                        e$1.renderSlot(_ctx.$slots, "default")
                    ])
                ], 4);
            };
    ...
    const _sfc_main$c = /* @__PURE__ */ e$1.defineComponent({
        ...
        setup(__props) {
            return (_ctx, _cache) => {
                var _a;
                return ((_a = _ctx.description) == null ? void 0 : _a.length) ? (e$1.openBlock(), e$1.createElementBlock("div", _hoisted_1$8, [
                        ...
                        (e$1.openBlock(true), e$1.createElementBlock(e$1.Fragment, null, e$1.renderList(_ctx.description, (line, index) => {
                            return e$1.openBlock(), e$1.createElementBlock("div", {
                                ...
                                e$1.createElementVNode("p", null, [
                                    _cache[0] || (_cache[0] = e$1.createElementVNode("span", {
                                        class: "mr-1"
                                    }, "•", -1)),
        ...
        setup(__props) {
            ...
            return (_ctx, _cache) => {
                ...
                return e$1.openBlock(), e$1.createElementBlock(e$1.Fragment, null, [
                    e$1.createElementVNode("label", _hoisted_1$7, [
                        ...
                        e$1.createElementVNode("span", _hoisted_2$5, e$1.toDisplayString(_ctx.name), 1)
                    ]),
                            ...
                            return [
                                e$1.createElementVNode("div", _hoisted_3$3, [
                                    ...
                                    e$1.withDirectives(e$1.createElementVNode("textarea", {
                                        ...
                                        onKeydown: _cache[2] || (_cache[2] = e$1.withModifiers(() => {}, ["stop"])),
                                                        ...
                                                        return e$1.openBlock(), e$1.createBlock(e$1.unref(Fe), {
                                                            ...
                                                            default: e$1.withCtx(({
                                                                ...
                                                                e$1.createElementVNode("li", {
                                                                    class: e$1.normalizeClass([
                                                                        active ? "bg-purple-100 text-black" : "text-gray-900", "relative cursor-default py-2 pl-10 pr-4 transition-colors duration-200"
                                                                    ])
                                                                }, [
                ...
                return e$1.openBlock(), e$1.createElementBlock(e$1.Fragment, null, [
                    e$1.createElementVNode("div", _hoisted_1$5, [
                        ...
                        e$1.withDirectives(e$1.createElementVNode("input", {
                            ...
                            onKeydown: _cache[1] || (_cache[1] = e$1.withModifiers(() => {}, ["stop"])),
                        ...
                        _ctx.addonText ? (e$1.openBlock(), e$1.createElementBlock("div", _hoisted_3$1, e$1.toDisplayString(_ctx.addonText), 1)) : e$1.createCommentVNode("", true)
                    ]),
                    ((_a = _ctx.description) == null ? void 0 : _a.length) ? (e$1.openBlock(), e$1.createBlock(_sfc_main$c, {
                        key: 0,
                        class: "pl-1",
                            ...
                            e$1.createElementVNode("div", _hoisted_1$3, [
                                e$1.createVNode(e$1.unref(de), {
                                    ...
                                    default: e$1.withCtx(() => [
                                        ...
                                        e$1.createElementVNode("p", _hoisted_2$2, e$1.toDisplayString(_ctx.name), 1)
                                    ]),
                                    _: 1
                                })
                            ])
        ...
        async checkRoot(mode) {
            ...
            if (settings.enableDebugFilter) {
                rootComments.forEach((v2) => {
                    debugFilter(
                        [`CommentFilterCommon rootComments`, `username: ${selectorFns$9.root.username(v2)}`, `content: ${selectorFns$9.root.content(v2)}`, `callUser: ${selectorFns$9.root.callUser(v2)}`, `callUserNoReply: ${selectorFns$9.root.callUserNoReply(v2)}`, `callUserOnly: ${selectorFns$9.root.callUserOnly(v2)}`, `callUserOnlyNoReply: ${selectorFns$9.root.callUserOnlyNoReply(v2)}`, `level: ${selectorFns$9.root.level(v2)}`, `isUp: ${selectorFns$9.root.isUp(v2)}`, `isPin: ${selectorFns$9.root.isPin(v2)}`, `isNote: ${selectorFns$9.root.isNote(v2)}`, `isLink: ${selectorFns$9.root.isLink(v2)}`, `isMe: ${selectorFns$9.root.isMe(v2)}`].join("\n"));
                });
            }
            ...
            debugFilter(`CommentFilterCommon hide ${rootBlackCnt} in ${rootComments.length} root comments, mode=${mode}, time=${time}`);
        }
        /**
         * 检测二级评论
         * @param mode full全量，incr增量
        ...
        async checkSub(mode) {
            ...
            if (settings.enableDebugFilter) {
                subComments.forEach((v2) => {
                    debugFilter(
                        [`CommentFilterCommon subComments`, `username: ${selectorFns$9.sub.username(v2)}`, `content: ${selectorFns$9.sub.content(v2)}`, `callUser: ${selectorFns$9.sub.callUser(v2)}`, `callUserNoReply: ${selectorFns$9.sub.callUserNoReply(v2)}`, `callUserOnly: ${selectorFns$9.sub.callUserOnly(v2)}`, `callUserOnlyNoReply: ${selectorFns$9.sub.callUserOnlyNoReply(v2)}`, `level: ${selectorFns$9.sub.level(v2)}`, `isUp: ${selectorFns$9.sub.isUp(v2)}`, `isLink: ${selectorFns$9.sub.isLink(v2)}`, `isMe: ${selectorFns$9.sub.isMe(v2)}`].join("\n"));
                });
            }
            ...
            const time = (performance.now() - timer).toFixed(1);
            debugFilter(`CommentFilterCommon hide ${subBlackCnt} in ${subComments.length} sub comments, mode=${mode}, time=${time}`);
        }
        check(mode) {
    ...
    const commentFilterCommonGroups = [{
        ...
        items: [{
            ...
            saveFn: async () => {
                mainFilter$9.commentUsernameFilter.setParam(BiliCleanerStorage.get(GM_KEYS$9.black.username.valueKey, []));
                mainFilter$9.check("full");
            }
        }]
    }, {
        ...
        items: [{
            ...
            editorDescription: ["每行一个关键词或正则，不区分大小写、全半角", "请勿使用过于激进的关键词或正则", "正则默认 ius 模式，无需 flag，语法：/abc|\\d+/"],
            saveFn: async () => {
        ...
        items: [{
            ...
            noStyle: true,
            enableFn: () => {
                fetchHook.addPostFn(async (input, init, resp) => {
                    var _a, _b, _c, _d, _e;
                    if (!resp) {
                        return;
                    }
    ...
    const selectorFns$8 = {
        ...
        content: (dyn) => {
            return Array.from(dyn.querySelectorAll(".bili-dyn-content :is(.dyn-card-opus__title, .bili-rich-text__content > span:not(.bili-rich-text-module.at))")).map((v2) => {
                var _a;
    ...
    class DynamicFilterDynamic {
        ...
        async check(mode) {
            ...
            if (settings.enableDebugFilter) {
                dyns.forEach((v2) => {
                    debugFilter(
                        [`DynamicFilterDynamic`, `uploader: ${selectorFns$8.uploader(v2)}`, `title: ${selectorFns$8.title(v2)}`, `duration: ${selectorFns$8.duration(v2)}`, `content: ${selectorFns$8.content(v2)}`, `shortVideo: ${selectorFns$8.dynVideo(v2)}`, `playback: ${selectorFns$8.playback(v2)}`].join("\n"));
                });
            }
            const blackPairs = [];
        ...
        observe() {
            waitForEle(document, ".bili-dyn-home--member",
                (node) => node.className === "bili-dyn-home--member").then((ele) => {
                if (!ele) {
                    return;
                }
    ...
    class DynamicFilterHeader {
        ...
        async check(mode) {
            ...
            if (settings.enableDebugFilter) {
                dyns.forEach((v2) => {
                    debugFilter(
                        [`DynamicFilterHeader`, `uploader: ${selectorFns$7.uploader(v2)}`, `title: ${selectorFns$7.title(v2)}`, `content: ${selectorFns$7.content(v2)}`].join("\n"));
                });
            }
            const blackPairs = [];
    ...
    class DynamicFilterSpace {
        ...
        async check(mode) {
            ...
            if (settings.enableDebugFilter) {
                dyns.forEach((v2) => {
                    debugFilter(
                        [`DynamicFilterSpace`, `title: ${selectorFns$6.title(v2)}`, `duration: ${selectorFns$6.duration(v2)}`, `content: ${selectorFns$6.content(v2)}`, `shortVideo: ${selectorFns$6.dynVideo(v2)}`, `playback: ${selectorFns$6.playback(v2)}`].join("\n"));
                });
            }
            const blackPairs = [];
    ...
    class VideoFilterChannel {
        ...
        async check(mode) {
            ...
            if (settings.enableDebugFilter) {
                videos.forEach((v2) => {
                    debugFilter(
                        [`VideoFilterChannel`, `bvid: ${selectorFns$5.bvid(v2)}`, `duration: ${selectorFns$5.duration(v2)}`, `title: ${selectorFns$5.title(v2)}`, `uploader: ${selectorFns$5.uploader(v2)}`, `pubdate: ${selectorFns$5.pubdate(v2)}`].join("\n"));
                });
            }
            const blackPairs = [];
    ...
    const videoFilterChannelGroups = [{
        ...
        items: [{
            ...
            editorDescription: ["每行一个关键词或正则，不区分大小写、全半角", "请勿使用过于激进的关键词或正则", "正则默认 ius 模式，无需 flag，语法：/abc|\\d+/"],
            saveFn: async () => {
                mainFilter$5.videoUploaderKeywordFilter.setParam(BiliCleanerStorage.get(GM_KEYS$5.black.uploaderKeyword.valueKey, []));
                mainFilter$5.checkFull();
            }
        }]
    }, {
        ...
        items: [{
            ...
            editorDescription: ["每行一个UP主昵称，保存时自动去重"],
            saveFn: async () => {
                mainFilter$5.videoUploaderWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$5.white.uploader.valueKey, []));
                mainFilter$5.checkFull();
            }
        }, {
            type: "switch",
    ...
    class VideoFilterHomepage {
        ...
        async check(mode) {
            ...
            if (settings.enableDebugFilter) {
                videos.forEach((v2) => {
                    debugFilter(
                        [`VideoFilterHomepage`, `bvid: ${selectorFns$4.bvid(v2)}`, `duration: ${selectorFns$4.duration(v2)}`, `views: ${selectorFns$4.views(v2)}`, `title: ${selectorFns$4.title(v2)}`, `uploader: ${selectorFns$4.uploader(v2)}`, `pubdate: ${selectorFns$4.pubdate(v2)}`, `isFollow: ${selectorFns$4.isFollow(v2)}`].join("\n"));
                });
            }
            const blackPairs = [];
    ...
    const videoFilterHomepageGroups = [{
        ...
        items: [{
            ...
            editorDescription: ["每行一个关键词或正则，不区分大小写、全半角", "请勿使用过于激进的关键词或正则", "正则默认 ius 模式，无需 flag，语法：/abc|\\d+/"],
            saveFn: async () => {
                mainFilter$4.videoUploaderKeywordFilter.setParam(BiliCleanerStorage.get(GM_KEYS$4.black.uploaderKeyword.valueKey, []));
                mainFilter$4.checkFull();
            }
        }]
    }, {
        ...
        items: [{
            ...
            editorDescription: ["每行一个UP主昵称，保存时自动去重"],
            saveFn: async () => {
                mainFilter$4.videoUploaderWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$4.white.uploader.valueKey, []));
                mainFilter$4.checkFull();
            }
        }, {
            type: "switch",
    ...
    class VideoFilterPopular {
        ...
        async check(mode) {
            ...
            if (settings.enableDebugFilter) {
                videos.forEach((v2) => {
                    debugFilter(
                        [`VideoFilterPopular`, `bvid: ${selectorFns$3.bvid(v2)}`, `duration: ${selectorFns$3.duration(v2)}`, `title: ${selectorFns$3.title(v2)}`, `uploader: ${selectorFns$3.uploader(v2)}`, `quality: ${selectorFns$3.quality(v2)}`].join("\n"));
                });
            }
            const blackPairs = [];
    ...
    const videoFilterPopularGroups = [{
        ...
        items: [{
            ...
            editorDescription: ["每行一个关键词或正则，不区分大小写、全半角", "请勿使用过于激进的关键词或正则", "正则默认 ius 模式，无需 flag，语法：/abc|\\d+/"],
            saveFn: async () => {
                mainFilter$3.videoUploaderKeywordFilter.setParam(BiliCleanerStorage.get(GM_KEYS$3.black.uploaderKeyword.valueKey, []));
                mainFilter$3.checkFull();
            }
        }]
    }, {
        ...
        items: [{
            ...
            editorDescription: ["每行一个UP主昵称，保存时自动去重"],
            saveFn: async () => {
                mainFilter$3.videoUploaderWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$3.white.uploader.valueKey, []));
                mainFilter$3.checkFull();
            }
        }, {
            type: "switch",
    ...
    class VideoFilterSearch {
        ...
        async check(mode) {
            ...
            if (settings.enableDebugFilter) {
                videos.forEach((v2) => {
                    debugFilter(
                        [`VideoFilterSearch`, `bvid: ${selectorFns$2.bvid(v2)}`, `duration: ${selectorFns$2.duration(v2)}`, `title: ${selectorFns$2.title(v2)}`, `uploader: ${selectorFns$2.uploader(v2)}`].join("\n"));
                });
            }
            const blackPairs = [];
    ...
    const videoFilterSearchGroups = [{
        ...
        items: [{
            ...
            editorDescription: ["每行一个关键词或正则，不区分大小写、全半角", "请勿使用过于激进的关键词或正则", "正则默认 ius 模式，无需 flag，语法：/abc|\\d+/"],
            saveFn: async () => {
                mainFilter$2.videoUploaderKeywordFilter.setParam(BiliCleanerStorage.get(GM_KEYS$2.black.uploaderKeyword.valueKey, []));
                mainFilter$2.checkFull();
            }
        }]
    }, {
        ...
        items: [{
            ...
            editorDescription: ["每行一个UP主昵称，保存时自动去重"],
            saveFn: async () => {
                mainFilter$2.videoUploaderWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS$2.white.uploader.valueKey, []));
                mainFilter$2.checkFull();
            }
        }, {
            type: "switch",
    ...
    class VideoFilterSpace {
        ...
        async check(mode) {
            ...
            if (settings.enableDebugFilter) {
                videos.forEach((v2) => {
                    debugFilter(
                        [`VideoFilterSpace`, `bvid: ${selectorFns$1.bvid(v2)}`, `duration: ${selectorFns$1.duration(v2)}`, `title: ${selectorFns$1.title(v2)}`].join("\n"));
                });
            }
            const blackPairs = [];
...
.rec-list :is(.video-page-card-small, .video-page-operator-card-small), .recommend-video-card`;
            ...
            if (settings.enableDebugFilter) {
                videos.forEach((v2) => {
                    debugFilter(
                        [`VideoFilterVideo`, `bvid: ${selectorFns.bvid(v2)}`, `duration: ${selectorFns.duration(v2)}`, `title: ${selectorFns.title(v2)}`, `uploader: ${selectorFns.uploader(v2)}`].join("\n"));
                });
            }
            const blackPairs = [];
        ...
        // }
        observe() {
            waitForEle(document, "#reco_list, .recommend-list-v1, .recommend-list-container",
                (node) => {
    ...
    const videoFilterVideoGroups = [{
        ...
        items: [{
            ...
            editorDescription: ["每行一个关键词或正则，不区分大小写、全半角", "请勿使用过于激进的关键词或正则", "正则默认 ius 模式，无需 flag，语法：/abc|\\d+/"],
            saveFn: async () => {
                mainFilter.videoUploaderKeywordFilter.setParam(BiliCleanerStorage.get(GM_KEYS.black.uploaderKeyword.valueKey, []));
                mainFilter.checkFull();
            }
        }]
    }, {
        ...
        items: [{
            ...
            description: ['过滤当前视频的"相关视频"缓存数据', "自动替换接下来播放、播放结束相关视频", "启用后，变动其他过滤功能需刷新页面"],
            noStyle: true,
            enableFn: () => {
        ...
        items: [{
            ...
            editorDescription: ["每行一个UP主昵称，保存时自动去重"],
            saveFn: async () => {
                mainFilter.videoUploaderWhiteFilter.setParam(BiliCleanerStorage.get(GM_KEYS.white.uploader.valueKey, []));
                mainFilter.checkFull();
            }
        }, {
            type: "switch",
                    ...
                    default: e$1.withCtx(() => [
                        (e$1.openBlock(true), e$1.createElementBlock(e$1.Fragment, null, e$1.renderList(e$1.unref(currPageGroups), (group, index) => {
                            return e$1.openBlock(), e$1.createElementBlock("div", {
                                ...
                                e$1.createVNode(_sfc_main$e, e$1.mergeProps({
                                    ref_for: true
                                }, {
                                    title: group.name,
                                    isFold: group.fold
                ...
                return show.value ? (e$1.openBlock(), e$1.createElementBlock("div", {
                    ...
                    (e$1.openBlock(true), e$1.createElementBlock(e$1.Fragment, null, e$1.renderList(menuList.value, (menu2, index) => {
                        return e$1.openBlock(), e$1.createElementBlock("div", {
                            ...
                            index < menuList.value.length - 1 ? (e$1.openBlock(), e$1.createElementBlock("hr", _hoisted_2$1)) : e$1.createCommentVNode("", true)
                        ]);
                    }), 128))
...
`);
        ...
        noStyle: true,
        enableFn: () => {
            ShadowInstance.addShadowStyle("bili-comment-renderer",
                // 一级评论
                "video-page-hide-root-reply-dislike-reply-btn", `#body {
--bili-comment-hover-more-display: 0 !important;
}
#body:hover {
--bili-comment-hover-more-display: 1 !important;
}`);
            ShadowInstance.addShadowStyle("bili-comment-reply-renderer",
                // 二级评论
...
#user-name a {color: #61666d !important;}`);
    ...
    function useCookies(dependencies, {
        ...
        const touches = e$1.shallowRef(0);
        const onChange = () => {
    ...
    const isDarkMode = e$1.ref(false);
    const {
        data,
        post
    } = useBroadcastChannel({
    ...
    const commonThemeItems = [{
        ...
        name: "夜间模式",
        description: ["实验功能，仅对常用页面生效", "插件会接管夜间模式，官方默认时不接管", "官方模式在顶栏头像菜单中设定"],
...
https://${domain}/${avbv}` : `https://${domain}/${avbv}`;
    ...
    const videoRightItems = [{
        ...
        enableFn: () => {
            ...
            fn2();
            waitForEle(document, ".recommend-list-v1, .recommend-list-container",
                (node) => ["recommend-list-v1", "recommend-list-container"].includes(node.className)).then((ele) => {
                if (ele) {
                ...
                return e$1.withDirectives((e$1.openBlock(), e$1.createBlock(_sfc_main$d, e$1.mergeProps({
                    ...
                    default: e$1.withCtx(() => [
                        (e$1.openBlock(), e$1.createElementBlock(e$1.Fragment, null, e$1.renderList(currRules, (rule, i2) => {
                            return e$1.createElementVNode("div", {
                                key: i2
                            }, [
    ...
    const _sfc_main$2 = /* @__PURE__ */ e$1.defineComponent({
        ...
        setup(__props) {
            ...
            const buttons = [{
                text: e$1.computed(() => isDarkMode.value ? "日间模式" : "夜间模式"),
                defaultHidden: true,
                isValid: true,
            ...
            return (_ctx, _cache) => {
                return e$1.unref(sideBtnStore).isShow ? (e$1.openBlock(), e$1.createElementBlock("div", {
                    key: 0,
                    class: e$1.normalizeClass(["group fixed flex flex-col justify-end text-opacity-50 will-change-[right,bottom] hover:text-opacity-100", [e$1.unref(isDarkMode) ? "text-white" : "text-black", e$1.unref(isPageBangumi)() || e$1.unref(isPageVideo)() ? "z-[100]" : "z-[2000]"]]),
                    ref_key: "target",
                    ref: target,
                    style: e$1.normalizeStyle({
                        right: e$1.unref(btnPos).right + "px",
                        bottom: e$1.unref(btnPos).bottom + "px"
                    })
                }, [
                    (e$1.openBlock(true), e$1.createElementBlock(e$1.Fragment, null, e$1.renderList(buttons.filter((btn) => btn.isValid), (btn, index) => {
                        return e$1.openBlock(), e$1.createElementBlock("div", {
                            class: e$1.normalizeClass(["mt-1 h-10 w-10 cursor-pointer items-center justify-center rounded-lg border transition-colors hover:border-none hover:bg-[#00AEEC] hover:text-white", [
                                // 主题
                                e$1.unref(isDarkMode) ? "border-[#2f3134] bg-[#242628]" : "border-gray-200 bg-white",
                                // 显示
                            ...
                            e$1.createElementVNode("div", null, [
                                e$1.createElementVNode("p", _hoisted_2, e$1.toDisplayString(btn.text.value.substring(0, 2)), 1),
                                e$1.createElementVNode("p", _hoisted_3, e$1.toDisplayString(btn.text.value.substring(2, 4)), 1)
                            ])
                        ], 10, _hoisted_1$1);
                    }), 128))
