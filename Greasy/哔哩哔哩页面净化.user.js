...
(function(e$2) {
    ...
    const e$2__namespace = /*#__PURE__*/ _interopNamespaceDefault(e$2);
...
`));
    ...
    const _sfc_main$e = /* @__PURE__ */ e$2.defineComponent({
        ...
        setup(__props) {
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock("div", _hoisted_1$a, [
    ...
    function useBroadcastChannel(options) {
        ...
        const isClosed = e$2.shallowRef(false);
        const channel = e$2.ref();
        const data2 = e$2.ref();
        const error2 = e$2.shallowRef(null);
        const post2 = (data22) => {
            if (channel.value)
                channel.value.postMessage(data22);
        };
        const close = () => {
            if (channel.value)
                channel.value.close();
        ...
        if (isSupported.value) {
            tryOnMounted(() => {
                ...
                useEventListener(channel, "message", (e2) => {
                    data2.value = e2.data;
                }, listenerOptions);
                useEventListener(channel, "messageerror", (e2) => {
                    error2.value = e2;
                }, listenerOptions);
    ...
    function useStorage(key, defaults2, storage, options = {}) {
        ...
        const data2 = (shallow ? e$2.shallowRef : e$2.ref)(typeof defaults2 === "function" ? defaults2() : defaults2);
    ...
    function useMagicKeys(options = {}) {
        ...
        const current = e$2.reactive( /* @__PURE__ */ new Set());
        const obj = {
            toJSON() {
                return {};
            },
    ...
    const _sfc_main$d = /* @__PURE__ */ e$2.defineComponent({
        __name: "PanelComp",
        props: {
            title: {},
            widthPercent: {},
            ...
            return (_ctx, _cache) => {
                return e$2.openBlock(), e$2.createElementBlock("div", {
                    ...
                    e$2.createElementVNode("div", {
                        ...
                        e$2.createElementVNode("div", _hoisted_1$9, e$2.toDisplayString(__props.title), 1),
    ...
    const _sfc_main$c = /* @__PURE__ */ e$2.defineComponent({
        ...
        setup(__props) {
            return (_ctx, _cache) => {
                var _a;
                return ((_a = __props.description) == null ? void 0 : _a.length) ? (e$2.openBlock(), e$2.createElementBlock("div", _hoisted_1$8, [
    ...
    const _sfc_main$b = /* @__PURE__ */ e$2.defineComponent({
        __name: "EditorComp",
        props: {
            type: {},
            id: {},
        ...
        setup(__props) {
            ...
            const saveSuccess = e$2.ref(false);
            ...
            const saveData = () => {
                try {
                    const data2 = editorData.value.split("\n").filter((v2) => v2.trim() !== "");
                    BiliCleanerStorage.set(item.id, orderedUniq(data2));
            ...
            return (_ctx, _cache) => {
                ...
                return e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, [
                    ...
                    ((_a = __props.description) == null ? void 0 : _a.length) ? (e$2.openBlock(), e$2.createBlock(_sfc_main$c, {
                        key: 0,
                        class: "pl-9",
                        description: __props.description
                    }, null, 8, ["description"])) : e$2.createCommentVNode("", true),
                    isEditorShow.value ? (e$2.openBlock(), e$2.createBlock(_sfc_main$d, e$2.mergeProps({
                        key: 1,
                        ref_key: "panel",
                        ref: panel
                    }, {
                        title: __props.editorTitle,
                        widthPercent: 28,
                        heightPercent: 85,
                        minWidth: 360,
                        minHeight: 600
                        ...
                        default: e$2.withCtx(() => {
                            var _a2;
                            return [
                                e$2.createElementVNode("div", _hoisted_3$3, [
                                    ((_a2 = __props.editorDescription) == null ? void 0 : _a2.length) ? (e$2.openBlock(), e$2.createBlock(_sfc_main$c, {
                                        key: 0,
                                        class: "mb-3",
                                        description: __props.editorDescription
                                    }, null, 8, ["description"])) : e$2.createCommentVNode("", true),
                                    e$2.withDirectives(e$2.createElementVNode("textarea", {
                                        "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => editorData.value = $event),
                                        onKeydown: _cache[2] || (_cache[2] = e$2.withModifiers(() => {}, ["stop"])),
                                    ...
                                    e$2.createElementVNode("div", _hoisted_4$1, [
                                        e$2.createElementVNode("button", {
                                            class: e$2.normalizeClass(["w-24 self-center rounded-md border-2 border-gray-300 bg-white py-0.5 text-center text-lg hover:border-blue-400 hover:bg-blue-50", saveSuccess.value ? "border-green-400 bg-green-50 hover:border-green-400 hover:bg-green-50" : ""]),
                                            onClick: saveData
                                        }, " 保存 ", 2),
                                        e$2.createElementVNode("button", {
    ...
    const _sfc_main$a = /* @__PURE__ */ e$2.defineComponent({
        __name: "ListComp",
        props: {
            type: {},
            id: {},
                ...
                if (value !== item.disableValue) {
                    ...
                    for (const option of item.options) {
                        if (option.value === value && option.fn) {
                            (_a = option.fn()) == null ? void 0 : _a.catch(() => {});
                        }
                    }
                } else {
                    document.documentElement.removeAttribute(item.id);
                }
                BiliCleanerStorage.set(item.id, value);
            });
            return (_ctx, _cache) => {
                var _a;
                return e$2.openBlock(), e$2.createElementBlock(e$2.Fragment, null, [
    ...
    const _sfc_main$9 = /* @__PURE__ */ e$2.defineComponent({
        __name: "NumberComp",
        props: {
            type: {},
            id: {},
        ...
        setup(__props) {
            const item = __props;
            const currValue = e$2.ref(BiliCleanerStorage.get(item.id, item.defaultValue));
            watchThrottled(
                currValue,
                (newValue, oldValue) => {
                    var _a;
                    try {
                        ...
                        if (newValue === item.disableValue) {
                            ...
                            (_a = item.fn(currValue.value)) == null ? void 0 : _a.catch((err) => {
                                throw err;
                            });
                        }
    ...
    const _sfc_main$8 = /* @__PURE__ */ e$2.defineComponent({
        __name: "StringComp",
        props: {
            type: {},
            id: {},
    ...
    const _sfc_main$7 = /* @__PURE__ */ e$2.defineComponent({
        __name: "SwitchComp",
        props: {
            type: {},
            id: {},
        ...
        setup(__props) {
            const item = __props;
            const enabled = e$2.ref(BiliCleanerStorage.get(item.id, item.defaultEnable));
            e$2.watch(enabled, () => {
                var _a, _b;
                try {
                    if (enabled.value) {
                        ...
                        if (item.enableFn) {
                            (_a = item.enableFn()) == null ? void 0 : _a.catch(() => {});
                        }
                        ...
                        if (item.disableFn) {
                            (_b = item.disableFn()) == null ? void 0 : _b.catch((err) => {
                                throw err;
                            });
                        }
        ...
        await Promise.all(tasks).catch(() => {}).finally(() => {
            requestAnimationFrame(() => {
                for (let i2 = 0; i2 < elements.length; i2++) {
                    ...
                    enableFilterVisitSign && elements[i2].setAttribute(settings.filterVisitSign, "");
                }
            });
        });
    ...
    const _Shadow = class _Shadow {
        ...
        addShadowStyle(tag, className, css2) {
            ...
            if (curr) {
                ...
                this.cssStore.set(tag, /* @__PURE__ */ new Set([{
                    className,
                    css: css2
                }]));
            }
        ...
        addShadowObserver(tag, observer, config) {
            ...
            if (curr) {
                ...
                this.observerStore.set(tag, /* @__PURE__ */ new Set([
                    [observer, config]
                ]));
            }
            if (this.shadowStore.size) {
    ...
    const selectorFns$9 = {
        root: {
            ...
            content: (comment) => {
                var _a, _b, _c, _d;
                return (_d = (_c = (_b = (_a = comment.__data) == null ? void 0 : _a.content) == null ? void 0 : _b.message) == null ? void 0 : _c.replace(/@[^@\s]+/g, " ")) == null ? void 0 : _d.replace(/(\[[^[\]]+\])+/g, " ").trim();
            },
            noface: (comment) => {
                var _a, _b, _c, _d, _e, _f;
                return ((_c = (_b = (_a = comment.__data) == null ? void 0 : _a.member) == null ? void 0 : _b.avatar) == null ? void 0 : _c.endsWith("noface.jpg")) && ((_f = (_e = (_d = comment.__data) == null ? void 0 : _d.member) == null ? void 0 : _e.vip) == null ? void 0 : _f.vipStatus) === 0;
            },
            callBot: (comment) => {
                var _a, _b;
            ...
            emojiOnly: (comment) => {
                var _a, _b, _c, _d, _e;
                return ((_e = (_d = (_c = (_b = (_a = comment.__data) == null ? void 0 : _a.content) == null ? void 0 : _b.message) == null ? void 0 : _c.replace(/@[^@\s]+/g, " ")) == null ? void 0 : _d.replace(/(\[[^[\]]+\])+/g, " ")) == null ? void 0 : _e.replace(emojiPattern, " ").trim()) === "";
            },
            isUp: (comment) => {
                var _a;
        ...
        sub: {
            ...
            content: (comment) => {
                var _a, _b, _c, _d, _e, _f;
                return (_f = (_e = (_d = (_c = (_b = (_a = comment.__data) == null ? void 0 : _a.content) == null ? void 0 : _b.message) == null ? void 0 : _c.trim()) == null ? void 0 : _d.replace(/^回复\s?@[^@\s]+\s?:/, "")) == null ? void 0 : _e.replace(/@[^@\s]+/g, " ")) == null ? void 0 : _f.replace(/(\[[^[\]]+\])+/g, " ").trim();
            },
            noface: (comment) => {
                var _a, _b, _c, _d, _e, _f;
                return ((_c = (_b = (_a = comment.__data) == null ? void 0 : _a.member) == null ? void 0 : _b.avatar) == null ? void 0 : _c.endsWith("noface.jpg")) && ((_f = (_e = (_d = comment.__data) == null ? void 0 : _d.member) == null ? void 0 : _e.vip) == null ? void 0 : _f.vipStatus) === 0;
            ...
            emojiOnly: (comment) => {
                var _a, _b, _c, _d, _e, _f;
                return ((_f = (_e = (_d = (_c = (_b = (_a = comment.__data) == null ? void 0 : _a.content) == null ? void 0 : _b.message) == null ? void 0 : _c.replace(/^回复\s?@[^@\s]+\s?:/, "")) == null ? void 0 : _d.replace(/@[^@\s]+/g, " ")) == null ? void 0 : _e.replace(/(\[[^[\]]+\])+/g, " ")) == null ? void 0 : _f.replace(emojiPattern, " ").trim()) === "";
            },
            isUp: (comment) => {
                var _a;
                const mid = (_a = comment.__data) == null ? void 0 : _a.mid;
    ...
    class CommentFilterCommon {
        constructor() {
            ...
            __publicField(this, "commentUsernameKeywordFilter", new CommentUsernameKeywordFilter());
            __publicField(this, "commentContentFilter", new CommentContentFilter());
            __publicField(this, "commentAdFilter", new CommentAdFilter());
            __publicField(this, "commentLevelFilter", new CommentLevelFilter());
            __publicField(this, "commentNoFaceFilter", new CommentNoFaceFilter());
            ...
            __publicField(this, "commentEmojiOnlyFilter", new CommentEmojiOnlyFilter());
            // 白名单
        ...
        init() {
            this.commentUsernameFilter.setParam(BiliCleanerStorage.get(GM_KEYS$9.black.username.valueKey, []));
            this.commentUsernameKeywordFilter.setParam(BiliCleanerStorage.get(GM_KEYS$9.black.usernameKeyword.valueKey, []));
            this.commentContentFilter.setParam(BiliCleanerStorage.get(GM_KEYS$9.black.content.valueKey, []));
            this.commentLevelFilter.setParam(BiliCleanerStorage.get(GM_KEYS$9.black.level.valueKey, 0));
        ...
        async checkRoot(mode) {
            ...
            if (ShadowInstance.shadowStore.has("BILI-COMMENT-THREAD-RENDERER")) {
                ...
                if (mode === "incr") {
                    rootComments = rootComments.filter((v2) => !v2.hasAttribute(settings.filterVisitSign));
                }
            }
        ...
        async checkSub(mode) {
            ...
            if (ShadowInstance.shadowStore.has("BILI-COMMENT-REPLY-RENDERER")) {
                ...
                if (mode === "incr") {
                    subComments = subComments.filter((v2) => !v2.hasAttribute(settings.filterVisitSign));
                }
            }
    ...
    const commentFilterCommonGroups = [{
            ...
            items: [{
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$9.commentUsernameFilter.setParam(
                            BiliCleanerStorage.get(GM_KEYS$9.black.username.valueKey, [])
                        );
                        mainFilter$9.check("full");
                    }
                },
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$9.commentUsernameKeywordFilter.setParam(
                            BiliCleanerStorage.get(GM_KEYS$9.black.usernameKeyword.valueKey, [])
                        );
                        mainFilter$9.check("full");
                    }
                }
        ...
        },
        {
            ...
            items: [{
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$9.commentContentFilter.setParam(BiliCleanerStorage.get(GM_KEYS$9.black.content.valueKey, []));
                        mainFilter$9.check("full");
                    }
                }
            ]
                ...
                menus.push({
                    ...
                    fn: async () => {
                        try {
                            ...
                            mainFilter$9.check("full");
                            const arr = BiliCleanerStorage.get(GM_KEYS$9.black.username.valueKey, []);
                            arr.unshift(username);
                            BiliCleanerStorage.set(GM_KEYS$9.black.username.valueKey, orderedUniq(arr));
                        } catch (err) {
...
.dyn-card-opus__summary span
    ...
    class DynamicFilterDynamic {
        constructor() {
            ...
            __publicField(this, "dynDynVideoFilter", new DynDynVideoFilter());
            __publicField(this, "dynPlaybackFilter", new DynPlaybackFilter());
        }
        init() {
            this.dynUploaderFilter.setParam(BiliCleanerStorage.get(GM_KEYS$8.black.uploader.valueKey, []));
            this.dynDurationFilter.setParam(BiliCleanerStorage.get(GM_KEYS$8.black.duration.valueKey, 0));
            this.dynVideoTitleFilter.setParam(BiliCleanerStorage.get(GM_KEYS$8.black.title.valueKey, []));
            this.dynContentFilter.setParam(BiliCleanerStorage.get(GM_KEYS$8.black.content.valueKey, []));
        }
        async check(mode) {
            if (!this.target) {
                return;
            ...
            if (revertAll) {
                dyns.forEach((v2) => showEle(v2, "style"));
                return;
            }
            if (settings.enableDebugFilter) {
                dyns.forEach((v2) => {
    ...
    const dynamicFilterDynamicGroups = [{
            ...
            items: [{
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$8.dynUploaderFilter.setParam(BiliCleanerStorage.get(GM_KEYS$8.black.uploader.valueKey, []));
                        mainFilter$8.checkFull();
                    }
                }
            ]
        ...
        },
        {
            ...
            items: [{
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$8.dynVideoTitleFilter.setParam(BiliCleanerStorage.get(GM_KEYS$8.black.title.valueKey, []));
                        mainFilter$8.checkFull();
                    }
                }
            ]
        },
        {
            ...
            items: [{
                ...
                },
                {
                    ...
                    saveFn: async () => {
                        mainFilter$8.dynContentFilter.setParam(BiliCleanerStorage.get(GM_KEYS$8.black.content.valueKey, []));
                        mainFilter$8.checkFull();
                    }
                }
            ]
                ...
                menus.push({
                    ...
                    fn: async () => {
                        try {
                            ...
                            mainFilter$8.checkFull();
                            const arr = BiliCleanerStorage.get(GM_KEYS$8.black.uploader.valueKey, []);
                            arr.unshift(uploader);
                            BiliCleanerStorage.set(GM_KEYS$8.black.uploader.valueKey, orderedUniq(arr));
                        } catch (err) {
    ...
    const selectorFns$7 = {
        uploader: (dyn) => {
            var _a, _b;
            return (_b = (_a = dyn.querySelector(".user-name")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim();
        },
        title: (dyn) => {
            var _a, _b;
            return (_b = (_a = dyn.querySelector(".all-in-one-article-title:not(:has(.article-tag))")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim();
        },
        content: (dyn) => {
            var _a, _b;
            return (_b = (_a = dyn.querySelector(".all-in-one-article-title:has(.article-tag)")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.replace("专栏", "").trim();
        }
    };
    class DynamicFilterHeader {
        ...
        async check(mode) {
            ...
            const blackCnt = await coreCheck(dyns, true, "style", blackPairs, []);
            const time = (performance.now() - timer).toFixed(1);
            debugFilter(`DynamicFilterHeader hide ${blackCnt} in ${dyns.length} dyns, mode=${mode}, time=${time}`);
        }
        checkFull() {
            this.check("full").catch((err) => {
        ...
        observe() {
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const id = setInterval(() => {
                    const ele = document.querySelector(".right-entry .v-popover-wrap:nth-of-type(3)");
                    if (ele) {
                        clearInterval(id);
                        debugFilter("DynamicFilterHeader target appear");
                        this.target = ele;
                        this.checkFull();
                        new MutationObserver(() => {
                            this.checkFull();
    ...
    const dynamicFilterHeaderEntry = async () => {
        ...
        if (BiliCleanerStorage.get(GM_KEYS$7.black.uploader.statusKey)) {
            mainFilter$7.dynUploaderFilter.enable();
        }
        if (BiliCleanerStorage.get(GM_KEYS$7.black.title.statusKey)) {
            mainFilter$7.dynVideoTitleFilter.enable();
        }
        if (BiliCleanerStorage.get(GM_KEYS$7.black.content.statusKey)) {
...
.dyn-card-opus__summary span
    ...
    const selectorFns$5 = {
        duration: (video) => {
            var _a, _b;
            const duration = (_b = (_a = video.querySelector(".bili-cover-card__stats .bili-cover-card__stat:last-child span")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim();
            return (duration && convertTimeToSec(duration)) ?? void 0;
        },
        title: (video) => {
            var _a, _b;
            return (_b = (_a = video.querySelector(".bili-video-card__title a")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim();
        },
        pubdate: (video) => {
            var _a, _b, _c;
            const text = (_b = (_a = video.querySelector(".bili-video-card__author .bili-video-card__text:nth-child(2)")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim();
            if (text) {
                const pubdate = (_c = text.split(" · ")[1]) == null ? void 0 : _c.trim();
                if (pubdate) {
        ...
        bvid: (video) => {
            var _a, _b;
            const href2 = ((_a = video.querySelector(".bili-video-card__title a")) == null ? void 0 : _a.getAttribute("href")) || ((_b = video.querySelector(".bili-cover-card")) == null ? void 0 : _b.getAttribute("href"));
    ...
    const videoFilterChannelHandler = (target) => {
        ...
        if (target.closest(".bili-video-card__author")) {
            const uploader = (_c = (_b = (_a = target.closest(".bili-video-card__author")) == null ? void 0 : _a.querySelector(".bili-video-card__text:last-child")) == null ? void 0 : _b.textContent) == null ? void 0 : _c.split(" · ")[0].trim();
            const url = (_d = target.closest(".bili-video-card__author")) == null ? void 0 : _d.href.trim();
        ...
        if (target instanceof HTMLAnchorElement && target.closest(".bili-video-card__title")) {
            const url = (_g = (_f = target.closest(".bili-video-card__title")) == null ? void 0 : _f.querySelector("a")) == null ? void 0 : _g.href;
    ...
    const videoFilterSearchHandler = (target) => {
        ...
        if (target.classList.contains("bili-video-card__info--tit") || target.closest(".bili-video-card__info--tit")) {
            const url = (_f = target.closest("a")) == null ? void 0 : _f.href;
...
.rec-list :is(.video-page-card-small, .video-page-operator-card-small), .recommend-video-card`;
    ...
    const videoFilterVideoHandler = (target) => {
        ...
        const menus = [];
        if (target.closest(".right-container, .recommend-list-container, .up-panel-container") && (target.classList.contains("name") || target.classList.contains("up-name") || ((_a = target.parentElement) == null ? void 0 : _a.classList.contains("up-name")) || target.closest(".staff-info"))) {
    ...
    const _sfc_main$6 = /* @__PURE__ */ e$2.defineComponent({
        ...
        setup(__props) {
            ...
            return (_ctx, _cache) => {
                return e$2.withDirectives((e$2.openBlock(), e$2.createBlock(_sfc_main$d, e$2.mergeProps({
                    title: "评论过滤（全站通用）",
                    widthPercent: 28,
                    heightPercent: 85,
                    minWidth: 360,
                    ...
                    default: e$2.withCtx(() => [
                        (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(e$2.unref(currPageGroups), (group, index) => {
                            return e$2.openBlock(), e$2.createElementBlock("div", {
                                ...
                                e$2.createVNode(_sfc_main$e, e$2.mergeProps({
                                    ref_for: true
                                }, {
                                    title: group.name,
                                    isFold: group.fold
                                        ...
                                        (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(group.items, (item, innerIndex) => {
                                            return e$2.openBlock(), e$2.createElementBlock("div", {
                                                ...
                                                item.type === "switch" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$7, e$2.mergeProps({
                                                    ...
                                                    key: 3,
                                                    ref_for: true
                                                }, item), null, 16)) : item.type === "list" ? (e$2.openBlock(), e$2.createBlock(_sfc_main$a, e$2.mergeProps({
                                                    key: 4,
                                                    ref_for: true
    ...
    const _sfc_main$5 = /* @__PURE__ */ e$2.defineComponent({
                    ...
                    (e$2.openBlock(true), e$2.createElementBlock(e$2.Fragment, null, e$2.renderList(menuList.value, (menu2, index) => {
                        return e$2.openBlock(), e$2.createElementBlock("div", {
                            ...
                            e$2.createElementVNode("div", {
                                onClick: ($event) => {
                                    var _a;
                                    return (_a = menu2.fn()) == null ? void 0 : _a.catch(() => {});
                                },
    ...
    const _sfc_main$4 = /* @__PURE__ */ e$2.defineComponent({
...
https://www.bilibili.com${location.pathname}`;
    ...
    const disableTuneVolume$1 = () => {
        if (!webScroll$1 && !fullScroll$1) {
            window.addEventListener("mousewheel", fn$1, {
                capture: true
            });
            window.addEventListener("DOMMouseScroll", fn$1, {
                capture: true
            });
        }
    };
    const enableTuneVolume$1 = () => {
        if (!(webScroll$1 && fullScroll$1)) {
            window.removeEventListener("mousewheel", fn$1, {
                capture: true
            });
            window.removeEventListener("DOMMouseScroll", fn$1, {
                capture: true
            });
        }
    };
    const toggleFullScreen$1 = () => {
        ...
        switch (fullScreenStatus()) {
            case "ele":
                ...
                if (isWebScreen()) {
                    (_a = _unsafeWindow.player) == null ? void 0 : _a.requestStatue(0);
                }
                break;
            case "f11":
                (_b = _unsafeWindow.player) == null ? void 0 : _b.requestStatue(0);
                break;
            case "not":
                document.documentElement.requestFullscreen().catch(() => {});
                if (!isWebScreen()) {
                    (_c = _unsafeWindow.player) == null ? void 0 : _c.requestStatue(2);
                }
                window.scrollTo(0, 0);
                break;
        }
    ...
    const handleFullScreenDblClick$1 = (e2) => {
        ...
        if (target.closest("#bilibili-player .bpx-player-video-perch") || target.classList.contains("bpx-player-video-perch") && target.closest("#bilibili-player")) {
            e2.stopImmediatePropagation();
            (_a = document.querySelector("#bilibili-player video")) == null ? void 0 : _a.pause();
            toggleFullScreen$1();
        }
    };
...
#user-name a {color: #61666d !important;}`
    ...
    const {
        ...
        name: "bili-cleaner-theme-channel"
    });
    ...
    const enableDarkMode = async () => {
        ...
        if (style == null ? void 0 : style.href.includes("light.css")) {
            style.href = style.href.replace("light.css", "dark.css");
        }
        const cookies = /* @__PURE__ */ useCookies();
    ...
    const disableDarkMode = async () => {
        ...
        const style = document.querySelector("head link#__css-map__");
        if (style == null ? void 0 : style.href.includes("dark.css")) {
    ...
    const _URLHandler = class _URLHandler {
        ...
        hijack() {
            _unsafeWindow.history.replaceState = (data2, unused, url) => {
                try {
                    if (typeof url === "string") {
                        ...
                        return this.origReplaceState.apply(_unsafeWindow.history, [data2, unused, cleanURL]);
                    }
                    return this.origReplaceState.apply(_unsafeWindow.history, [data2, unused, url]);
                } catch (err) {
                    error("URLHandler replaceState error", err);
                    return this.origReplaceState.apply(_unsafeWindow.history, [data2, unused, url]);
                }
            };
            _unsafeWindow.history.pushState = (data2, unused, url) => {
                try {
                    if (typeof url === "string") {
                        if (!url.startsWith(location.origin) && !url.startsWith(location.hostname)) {
                            url = `${location.origin}${url.startsWith("/") ? "" : "/"}${url}`;
                        ...
                        return this.origPushState.apply(_unsafeWindow.history, [data2, unused, cleanURL]);
                    }
                    return this.origPushState.apply(_unsafeWindow.history, [data2, unused, url]);
                } catch (err) {
        ...
        },
        {
            ...
            enableFn: async () => {
                const bv2av = (url) => {
                    ...
                    const BASE = 58n;
                    const data2 = "FcwAPNKTMug3GV5Lj7EJnHpWsx4tb8haYeviqBz6rkCy12mUSDQX9RdoZf";
                    const dec = (bvid) => {
                        const bvidArr = Array.from(bvid);
                        [bvidArr[3], bvidArr[9]] = [bvidArr[9], bvidArr[3]];
                        [bvidArr[4], bvidArr[7]] = [bvidArr[7], bvidArr[4]];
                        bvidArr.splice(0, 3);
                        const tmp = bvidArr.reduce((pre, bvidChar) => pre * BASE + BigInt(data2.indexOf(bvidChar)), 0n);
...
https://${domain}/${avbv}` : `https://${domain}/${avbv}`;
    ...
    const _sfc_main$3 = /* @__PURE__ */ e$2.defineComponent({
    ...
    const _sfc_main$2 = /* @__PURE__ */ e$2.defineComponent({
        __name: "SideBtnView",
        setup(__props) {
    ...
    const _sfc_main$1 = /* @__PURE__ */ e$2.defineComponent({
    ...
    const _sfc_main = /* @__PURE__ */ e$2.defineComponent({
        __name: "App",
        setup(__props) {
            return (_ctx, _cache) => {
        ...
        if (enable) {
            ...
            if (item.enableFn) {
                if (item.enableFnRunAt === "document-end" && document.readyState === "loading") {
                    document.addEventListener("DOMContentLoaded", () => {
                        var _a2;
                        (_a2 = item.enableFn()) == null ? void 0 : _a2.catch(() => {});
                    });
                } else {
                    (_a = item.enableFn()) == null ? void 0 : _a.catch(() => {});
                }
    ...
    const loadNumberItem = (item) => {
        ...
        if (value !== item.disableValue) {
            ...
            (_a = item.fn(value)) == null ? void 0 : _a.catch(() => {});
        }
    };
    ...
    const cleanGMKeys = () => {
        try {
            const keysInUse = /* @__PURE__ */ new Set();
            for (const rule of rules) {
                for (const group of rule.groups) {
                    for (const item of group.items) {
            ...
            const keysInStorage = new Set(_GM_listValues());
