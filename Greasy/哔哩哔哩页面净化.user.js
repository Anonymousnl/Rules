...
// @require			https://registry.npmmirror.com/vue/3.5.42/files/dist/vue.global.prod.js
...
(async function(vue) {
    ...
    var _global$1 = (() => typeof window === "object" && window.window === window ? window : typeof self === "object" && self.self === self ? self : typeof global === "object" && global.global === global ? global : typeof globalThis === "object" ? globalThis : {
        HTMLElement: null
    })();
    ...
    function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
        ...
        const store = (0, vue.reactive)(partialStore);
        pinia._s.set($id, store);
        const setupStore = (pinia._a && pinia._a.runWithContext || fallbackRunWithContext)(() => pinia._e.run(() => (scope = (0, vue.effectScope)()).run(() => setup({
            action
        }))));
            ...
            if ((0, vue.isRef)(prop) && !isComputed(prop) || (0, vue.isReactive)(prop)) {
                if (!isOptionsStore) {
                    if (initialState && shouldHydrate(prop)) {
                        if ((0, vue.isRef)(prop)) prop.value = initialState[key];
    ...
    function d$2(u, e, r) {
        let i = (0, vue.ref)(r == null ? void 0 : r.value),
            f = (0, vue.computed)(() => u.value !== void 0);
        return [(0, vue.computed)(() => f.value ? u.value : i.value), function(t) {
            return f.value || (i.value = t), e == null ? void 0 : e(t);
        }];
    }
    var r$3;
    var n$3 = Symbol("headlessui.useid");
    var o$4 = 0;
    ...
    var N$2 = ((n) => (n[n.First = 1] = "First", n[n.Previous = 2] = "Previous", n[n.Next = 4] = "Next", n[n.Last = 8] = "Last", n[n.WrapAround = 16] = "WrapAround", n[n.NoScroll = 32] = "NoScroll", n))(N$2 || {});
    var T$2 = ((o) => (o[o.Error = 0] = "Error", o[o.Overflow = 1] = "Overflow", o[o.Success = 2] = "Success", o[o.Underflow = 3] = "Underflow", o))(T$2 || {});
    ...
    var N$1 = ((o) => (o[o.None = 0] = "None", o[o.RenderStrategy = 1] = "RenderStrategy", o[o.Static = 2] = "Static", o))(N$1 || {});
    ...
    function y({
        ...
        let {
            as: n,
            ...l
        } = T$1(r, ["unmount", "static"]), a = (m = e.default) == null ? void 0 : m.call(e, o), d = {};
        if (o) {
            let u = !1,
                c = [];
...
`));
                let p = j((h$4 = u.props) != null ? h$4 : {}, l, d),
                    f = (0, vue.cloneVNode)(u, p, !0);
                for (let s in p) s.startsWith("on") && (f.props || (f.props = {}), f.props[s] = p[s]);
                return f;
            }
            return Array.isArray(a) && a.length === 1 ? a[0] : a;
        }
        return (0, vue.h)(n, Object.assign({}, l, d), {
            default: () => a
        });
    }
    ...
    function j(...r) {
        ...
        let t = {},
            e = {};
        for (let i of r)
            for (let n in i) n.startsWith("on") && typeof i[n] == "function" ? (e[n] ?? (e[n] = []), e[n].push(i[n])) : t[n] = i[n];
        ...
        switch (l.focus) {
            case 0:
                for (let e = 0; e < t.length; ++e)
                    if (!n.resolveDisabled(t[e], e, t)) return e;
                return r;
            case 1:
                s === -1 && (s = t.length);
                for (let e = s - 1; e >= 0; --e)
            ...
            case 4:
                for (let e = 0; e < t.length; ++e)
                    if (n.resolveId(t[e], e, t) === l.id) return e;
                return r;
            case 5:
                return null;
            default:
    ...
    function o$1(i, s, t) {
        if (Array.isArray(t))
            for (let [r, n] of t.entries()) o$1(i, f(s, r.toString()), n);
    ...
    (0, vue.defineComponent)({
        ...
        setup(t, {
            ...
            var n;
            let e = (n = t.id) != null ? n : `headlessui-description-${i$4()}`,
                r = w();
            return (0, vue.onMounted)(() => (0, vue.onUnmounted)(r.register(e))), () => {
                ...
                return A$1({
                    ourProps: {
                        ...Object.entries(d).reduce((a, [g, m]) => Object.assign(a, {
                            [g]: (0, vue.unref)(m)
                        }), {}),
                        id: e
                    },
    ...
    var N = (0, vue.defineComponent)({
        ...
        setup(t$2, {
            ...
            let s = (0, vue.ref)(t$2.defaultOpen ? 0 : 1),
                e = (0, vue.ref)(null),
                i$5 = (0, vue.ref)(null),
                n = {
    ...
    var Q = (0, vue.defineComponent)({
        ...
        setup(t, {
            ...
            let e = O("DisclosureButton"),
                i = U(),
                n = (0, vue.computed)(() => i === null ? !1 : i.value === e.panelId.value);
            (0, vue.onMounted)(() => {
    ...
    var V = (0, vue.defineComponent)({
        ...
        setup(t, {
            ...
            let i$6 = l(),
                n = (0, vue.computed)(() => i$6 !== null ? (i$6.value & i.Open) === i.Open : e.disclosureState.value === 0);
            return () => {
                var v;
                let l = {
                        open: e.disclosureState.value === 0,
    ...
    var Ie = (0, vue.defineComponent)({
        ...
        setup(o, {
            ...
            function u(t = (i) => i) {
                let i = p.value !== null ? s.value[p.value] : null,
                    l = O$1(t(s.value.slice()), (O) => o$3(O.dataRef.domRef)),
                    d = i ? l.indexOf(i) : null;
                return d === -1 && (d = null), {
                    options: l,
                    activeOptionIndex: d
                };
            }
            let D = (0, vue.computed)(() => o.multiple ? 1 : 0),
                [y, L] = d$2((0, vue.computed)(() => o.modelValue), (t) => w("update:modelValue", t), (0, vue.computed)(() => o.defaultValue)),
                M = (0, vue.computed)(() => y.value === void 0 ? u$5(D.value, {
                    [1]: [],
                    [0]: void 0
                }) : y.value),
                k = {
                    ...
                    search(t) {
                        ...
                        let O = (p.value !== null ? s.value.slice(p.value + l).concat(s.value.slice(0, p.value + l)) : s.value).find((I) => I.dataRef.textValue.startsWith(m.value) && !I.dataRef.disabled),
                            h = O ? s.value.indexOf(O) : -1;
                    ...
                    select(t) {
                        o.disabled || L(u$5(D.value, {
                            [0]: () => t,
                            [1]: () => {
                                let i = (0, vue.toRaw)(k.value.value).slice(),
                                    l = (0, vue.toRaw)(t),
                                    d = i.findIndex((O) => k.compare(l, (0, vue.toRaw)(O)));
            ...
            return (0, vue.onMounted)(() => {
                ...
                return (0, vue.h)(vue.Fragment, [...t != null && M.value != null ? e$1({
                    [t]: M.value
                }).map(([I, Q]) => (0, vue.h)(f$2, E$1({
                    features: u$2.Hidden,
                    key: I,
                    as: "input",
                    type: "hidden",
    ...
    (0, vue.defineComponent)({
        ...
        setup(o, {
            ...
            var f;
            let w = (f = o.id) != null ? f : `headlessui-listbox-label-${i$4()}`,
                n = A("ListboxLabel");

            function e() {
                var v;
                (v = o$3(n.buttonRef)) == null || v.focus({
                    preventScroll: !0
                });
            }
            return () => {
    ...
    var je = (0, vue.defineComponent)({
        ...
        setup(o, {
            ...
            var p;
            let n = (p = o.id) != null ? p : `headlessui-listbox-button-${i$4()}`,
                e = A("ListboxButton");
            w({
                el: e.buttonRef,
                $el: e.buttonRef
                ...
                switch (a.key) {
                    ...
                    case o$2.ArrowDown:
                        a.preventDefault(), e.openListbox(), (0, vue.nextTick)(() => {
                            var u;
                            (u = o$3(e.optionsRef)) == null || u.focus({
                                preventScroll: !0
                            }), e.value.value || e.goToOption(c.First);
                        });
                        break;
                    case o$2.ArrowUp:
                        a.preventDefault(), e.openListbox(), (0, vue.nextTick)(() => {
            ...
            function s$3(a) {
                e.disabled.value || (e.listboxState.value === 0 ? (e.closeListbox(), (0, vue.nextTick)(() => {
                    var u;
                    return (u = o$3(e.buttonRef)) == null ? void 0 : u.focus({
                        preventScroll: !0
                    });
                })) : (a.preventDefault(), e.openListbox(), me(() => {
                    var u;
                    return (u = o$3(e.optionsRef)) == null ? void 0 : u.focus({
                        preventScroll: !0
                    });
                })));
            }
    ...
    var Ae = (0, vue.defineComponent)({
        ...
        setup(o, {
            ...
            var p;
            let n = (p = o.id) != null ? p : `headlessui-listbox-options-${i$4()}`,
                e = A("ListboxOptions"),
                f = (0, vue.ref)(null);
            w({
                el: e.optionsRef,
            ...
            function v(a) {
                switch (f.value && clearTimeout(f.value), a.key) {
                    case o$2.Space:
                        if (e.searchQuery.value !== "") return a.preventDefault(), a.stopPropagation(), e.search(a.key);
                    case o$2.Enter:
                    ...
                    case o$2.Home:
                    case o$2.PageUp:
                        return a.preventDefault(), a.stopPropagation(), e.goToOption(c.First);
                    case o$2.End:
                    case o$2.PageDown:
                        return a.preventDefault(), a.stopPropagation(), e.goToOption(c.Last);
                    case o$2.Escape:
            ...
            let s = l(),
                m = (0, vue.computed)(() => s !== null ? (s.value & i.Open) === i.Open : e.listboxState.value === 0);
            return () => {
                var y, L;
                let a = {
                        open: e.listboxState.value === 0
    ...
    var Fe = (0, vue.defineComponent)({
        ...
        setup(o, {
            ...
            var C;
            let n = (C = o.id) != null ? C : `headlessui-listbox-option-${i$4()}`,
                e = A("ListboxOption"),
                f = (0, vue.ref)(null);
            w({
                el: f,
            ...
            let v = (0, vue.computed)(() => e.activeOptionIndex.value !== null ? e.options.value[e.activeOptionIndex.value].id === n : !1),
                s = (0, vue.computed)(() => u$5(e.mode.value, {
            ...
            (0, vue.onMounted)(() => e.registerOption(n, a)), (0, vue.onUnmounted)(() => e.unregisterOption(n)), (0, vue.onMounted)(() => {
                ...
                e.listboxState.value === 0 && v.value && e.activationTrigger.value !== 0 && (0, vue.nextTick)(() => {
                    var t, i;
                    return (i = (t = o$3(f)) == null ? void 0 : t.scrollIntoView) == null ? void 0 : i.call(t, {
                        block: "nearest"
                    });
                });
            });
            ...
            function u(t) {
                ...
                e.select(o.value), e.mode.value === 0 && (e.closeListbox(), (0, vue.nextTick)(() => {
                    var i;
                    return (i = o$3(e.buttonRef)) == null ? void 0 : i.focus({
                        preventScroll: !0
                    });
                }));
            }
    ...
    var K = (0, vue.defineComponent)({
        ...
        setup(t, {
            ...
            var r;
            let e = (r = t.id) != null ? r : `headlessui-label-${i$4()}`,
                o = d();
            return (0, vue.onMounted)(() => (0, vue.onUnmounted)(o.register(e))), () => {
                let {
                    ...
                    ...Object.entries(c).reduce((b, [g, m]) => Object.assign(b, {
                        [g]: (0, vue.unref)(m)
                    }), {}),
                    id: e
                };
            ...
            let r = (0, vue.ref)(null),
                f = E({
                    ...
                    props: {
                        ...
                        onClick(t) {
                            r.value && (t.currentTarget.tagName === "LABEL" && t.preventDefault(), r.value.click(), r.value.focus({
                                preventScroll: !0
                            }));
                        }
                    }
    ...
    var ue = (0, vue.defineComponent)({
        ...
        setup(l, {
            ...
            var h$2;
            let p = (h$2 = l.id) != null ? h$2 : `headlessui-switch-${i$4()}`,
                n = (0, vue.inject)(C, null),
                [t, s$2] = d$2((0, vue.computed)(() => l.modelValue), (e) => c("update:modelValue", e), (0, vue.computed)(() => l.defaultChecked));

            function m() {
                s$2(!t.value);
            }
            let E = (0, vue.ref)(null),
                o = n === null ? E : n.switchRef,
                L = s((0, vue.computed)(() => ({
                    as: l.as,
                    type: i.type
                })), o);
    ...
    var DisclosureComp_default = (0, vue.defineComponent)({
        ...
        setup(__props) {
            return (_ctx, _cache) => {
                return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_1$11, [(0, vue.createVNode)((0, vue.unref)(N), {
                    "default-open": !__props.isFold
                }, {
                    default: (0, vue.withCtx)(({
                        open
                    }) => [(0, vue.createVNode)((0, vue.unref)(Q), {
                        class: (0, vue.normalizeClass)(["flex w-full justify-between rounded-lg px-4 py-1.5 text-left font-bold outline-hidden", {
                        ...
                        default: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("span", null, (0, vue.toDisplayString)(__props.title || "Disclosure Title"), 1), (0, vue.createVNode)((0, vue.unref)(render), {
    ...
    var calcQuality = (ratio) => {
        const ans = -178.481 / (1 + Math.pow(ratio / .3829, .6463)) + 168.6;
        return ans > 0 ? ans : 0;
    };
    ...
    var tokenizeVideoRelativityText = (value, segmenter) => {
    ...
    var toTokenSet = (tokens) => new Set(tokens);
    var toBigramSet = (tokens) => {
        const tokenBigrams = bigram(tokens);
        return new Set(tokenBigrams.map((pair) => pair.join("\0")));
    };
    var calcTokenCoverage = (queryTokens, fieldTokens) => {
    ...
    var calcBigramCoverage = (queryTokens, fieldTokens) => {
        const queryBigramSet = toBigramSet(queryTokens);
        if (!queryBigramSet.size) return 0;
        const fieldBigramSet = toBigramSet(fieldTokens);
        return Array.from(queryBigramSet).filter((pair) => fieldBigramSet.has(pair)).length / queryBigramSet.size;
    };
    var calcVideoRelativityFieldScore = (queryTokens, fieldTokens) => {
        const unigramCoverage = calcTokenCoverage(queryTokens, fieldTokens);
        if (queryTokens.length < 2) return unigramCoverage;
        const bigramCoverage = calcBigramCoverage(queryTokens, fieldTokens);
        const {
            unigramCoverage: unigramWeight,
            bigramProximity: bigramWeight
        } = VIDEO_RELATIVITY_PARAMS.scoreWeights;
        return unigramCoverage * (unigramWeight + bigramWeight * bigramCoverage);
    };
    var calcVideoRelativityTagsScore = (queryTokens, tags, segmenter) => {
        const tagTokens = tags.map((tag) => tokenizeVideoRelativityText(tag, segmenter));
        const unigramCoverage = calcTokenCoverage(queryTokens, tagTokens.flat());
        if (queryTokens.length < 2) return unigramCoverage;
        const queryBigramSet = toBigramSet(queryTokens);
    ...
    var calcVideoRelativity = (keyword, title, description, author, tags, hitColumns) => {
        if (!Array.isArray(hitColumns)) return;
        if (hitColumns.length > 0) return 1;
        keyword = normalizeText(keyword);
        title = normalizeText(title);
        description = normalizeText(description);
        author = normalizeText(author);
        tags = tags.map((tag) => normalizeText(tag));
        if (title.includes(keyword) || author.includes(keyword) || tags.includes(keyword)) return 1;
        ...
        const descriptionScore = calcVideoRelativityFieldScore(queryTokens, tokenizeVideoRelativityText(description, segmenter));
        ...
        const finalScore = titleWeight * titleScore + tagsWeight * tagsScore + authorWeight * authorScore + descriptionWeight * descriptionScore;
    ...
    function throttleFilter(...args) {
        ...
        let leading;
        let rejectOnCancel;
        if (!(0, vue.isRef)(args[0]) && typeof args[0] === "object")({
            delay: ms,
            trailing = true,
            leading = true,
    ...
    function watchDebounced(source, cb, options = {}) {
        const {
            debounce = 0, maxWait = void 0, ...watchOptions
        } = options;
    ...
    function watchThrottled(source, cb, options = {}) {
        const {
            throttle = 0, trailing = true, leading = true, ...watchOptions
        } = options;
        return watchWithFilter(source, cb, {
            ...watchOptions,
    ...
    function useMutationObserver(target, callback, options = {}) {
        const {
            window = defaultWindow, ...mutationOptions
        } = options;
        let observer;
    ...
    function useMediaQuery(query, options = {}) {
        const {
            window = defaultWindow, ssrWidth = useSSRWidth()
        } = options;
    ...
    function useStorage(key, defaults, storage, options = {}) {
        ...
        const {
            flush = "pre", deep = true, listenToStorageChanges = true, writeDefaults = true, mergeDefaults = false, shallow, window = defaultWindow, eventFilter, onError = (e) => {
                console.error(e);
            }, initOnMounted
        } = options;
        ...
        const {
            pause: pauseWatch,
            resume: resumeWatch
        } = watchPausable(data, (newValue) => write(newValue), {
            flush,
            deep,
            eventFilter
        });
        (0, vue.watch)(keyComputed, () => update(), {
            flush
        });
        ...
        if (window && listenToStorageChanges)
            if (storage instanceof Storage) useEventListener(window, "storage", onStorageEvent, {
                passive: true
            });
...
`)
    ...
    function useResizeObserver(target, callback, options = {}) {
        const {
            window = defaultWindow, ...observerOptions
        } = options;
        let observer;
    ...
    function useElementBounding(target, options = {}) {
        const {
            reset = true, windowResize = true, windowScroll = true, immediate = true, updateTiming = "sync"
        } = options;
    ...
    function useWindowSize(options = {}) {
        const {
            window = defaultWindow, initialWidth = Number.POSITIVE_INFINITY, initialHeight = Number.POSITIVE_INFINITY, listenOrientation = true, includeScrollbar = true, type = "inner"
        } = options;
        ...
        setup(__props) {
            return (_ctx, _cache) => {
                return __props.description?.length ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_1$9, [(0, vue.createElementVNode)("div", _hoisted_2$6, [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(__props.description, (line, index) => {
                    return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
                        key: index
                    }, [(0, vue.createElementVNode)("p", null, [_cache[0] || (_cache[0] = (0, vue.createElementVNode)("span", {
                        class: "mr-1"
                    }, "•", -1)), (0, vue.createTextVNode)((0, vue.toDisplayString)(line), 1)])]);
    ...
    var EditorDialog_default = (0, vue.defineComponent)({
        ...
        setup(__props, {
            ...
            return (_ctx, _cache) => {
                return isEditorShow.value ? ((0, vue.openBlock)(), (0, vue.createBlock)(PanelComp_default, (0, vue.mergeProps)({
                    key: 0
                }, {
                    ...
                    default: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("div", _hoisted_1$8, [currentItem.value?.editorDescription?.length ? ((0, vue.openBlock)(), (0, vue.createBlock)(DescriptionComp_default, {
                        ...
                        [vue.vModelText, editorData.value]
                    ])])]),
                    _: 1
    ...
    var _hoisted_1$7 = {
        class: "flex w-full py-1 hover:bg-blue-50/50"
    };
    var _hoisted_2$5 = {
        ...
        setup(__props) {
            ...
            (0, vue.watch)(selectedOption, (newSelected) => {
                ...
                if (value !== item.disableValue) {
                    ...
                    for (const option of item.options)
                        if (option.value === value && option.fn) option.fn()?.catch(() => {});
            ...
            return (_ctx, _cache) => {
                return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, null, [(0, vue.createElementVNode)("div", _hoisted_1$6, [(0, vue.createElementVNode)("div", _hoisted_2$4, (0, vue.toDisplayString)(__props.name), 1), (0, vue.createVNode)((0, vue.unref)(Ie), {
                    ...
                    default: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("div", _hoisted_3$2, [(0, vue.createVNode)((0, vue.unref)(je), {
                        ...
                        default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(Ae), {
                            ...
                            default: (0, vue.withCtx)(() => [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)((0, vue.unref)(options), (option, index) => {
                                return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(Fe), {
                                    ...
                                    default: (0, vue.withCtx)(({
                                        ...
                                        class: (0, vue.normalizeClass)([active ? "bg-purple-100 text-black" : "text-gray-900", "relative cursor-default py-2 pr-4 pl-10 transition-colors duration-200"])
                                    }, [(0, vue.createElementVNode)("span", {
                                        class: (0, vue.normalizeClass)([selected ? "font-medium" : "font-normal", "block truncate"])
                                    }, (0, vue.toDisplayString)(option.name), 3), selected ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("span", _hoisted_6, [(0, vue.createVNode)((0, vue.unref)(render$2), {
                                        class: "h-5 w-5",
                                        "aria-hidden": "true"
            ...
            return (_ctx, _cache) => {
                return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, null, [(0, vue.createElementVNode)("div", _hoisted_1$5, [
                    ...
                    (0, vue.withDirectives)((0, vue.createElementVNode)("input", {
                        ...
                        [vue.vModelText, currValue.value]
                    ]),
    ...
    var _hoisted_1$4 = {
        class: "mt-1 mb-0.5 flex items-center py-1 text-black"
    };
    ...
    var SwitchComp_default = (0, vue.defineComponent)({
        ...
        setup(__props) {
            ...
            return (_ctx, _cache) => {
                return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, null, [(0, vue.createVNode)((0, vue.unref)(oe), {
                    class: "m-0.5 h-fit w-full rounded-lg py-1 hover:bg-blue-50/50"
                }, {
                    default: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("div", _hoisted_1$3, [(0, vue.createVNode)((0, vue.unref)(de), {
                        ...
                        default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(ue), {
                            ...
                            default: (0, vue.withCtx)(() => [(0, vue.createElementVNode)("span", {
                                class: (0, vue.normalizeClass)([enabled.value ? "translate-x-6" : "translate-x-1", "inline-block h-4 w-4 transform rounded-full bg-white transition-transform"])
                            }, null, 2)]),
                            _: 1
    ...
    var coreCheck = async (elements, enableFilterVisitSign = true, hideMode, blackPairs, whitePairs, forceBlackPairs, noThrottle) => {
        ...
        return await throttledCheck(elements, enableFilterVisitSign, hideMode, blackPairs, whitePairs, forceBlackPairs) ?? new Set();
    };
    var r = String.raw;
    var e = r`\p{Emoji}(?:\p{EMod}|[\u{E0020}-\u{E007E}]+\u{E007F}|\uFE0F?\u20E3?)`;
    ...
    var ShadowInstance = class Shadow {
        ...
        constructor() {
            try {
                if (isPageVideo() || isPageBangumi() || isPageSpace() || isPageDynamic() || isPagePlaylist() || isPageFestival()) this.hook();
            } catch (err) {
        ...
        hook() {
            ...
            Element.prototype.attachShadow = function(init) {
                ...
                if (self.observerStore.has(tag))
                    for (const [observer, config] of self.observerStore.get(tag)) observer.observe(shadowRoot, config);
                return shadowRoot;
            };
        ...
        addShadowObserver(tag, observer, config) {
            ...
            else this.observerStore.set(tag, new Set([
                [observer, config]
            ]));
            if (this.shadowStore.size) this.shadowStore.get(tag)?.forEach((node) => {
    ...
    var CommentChainFilter = class extends BooleanFilter {};
    ...
    var commentRpidLevelMap = new Map();
    var selectorFns$10 = {
        root: {
            username: (comment) => {
            ...
            isLink: (comment) => {
                ...
                if (jump_url) {
                    for (const k of Object.keys(jump_url))
                        if (!jump_url[k]?.pc_url?.includes("search.bilibili.com")) return true;
                }
                return false;
            },
            isMe: (comment) => {
        ...
        sub: {
            rpid: (comment) => {
                return comment.__data?.rpid_str;
            },
            parent: (comment) => {
                return comment.__data?.parent_str;
            },
            isReplyToFiltered: (comment) => {
                const parent = comment.__data?.parent_str;
            ...
            isLink: (comment) => {
                ...
                if (urls) {
                    for (const k of Object.keys(urls))
                        if (!urls[k]?.pc_url?.includes("search.bilibili.com")) return true;
                }
                return false;
            },
            isMe: (comment) => {
    ...
    var updateCommentRpidLevelMap = (comments, hiddenIndexes, initial) => {
        hiddenIndexes.forEach((index) => {
            const comment = comments[index];
            const rpid = selectorFns$10.sub.rpid(comment);
            if (typeof rpid !== "string" || !rpid) return;
            if (initial) {
                const currentLevel = commentRpidLevelMap.get(rpid);
                if (currentLevel === void 0 || currentLevel > 0) commentRpidLevelMap.set(rpid, 0);
                return;
            }
            const parent = selectorFns$10.sub.parent(comment);
            if (typeof parent !== "string") return;
            const parentLevel = commentRpidLevelMap.get(parent);
            if (parentLevel === void 0) return;
            const level = parentLevel + 1;
            const currentLevel = commentRpidLevelMap.get(rpid);
            if (currentLevel === void 0 || level < currentLevel) commentRpidLevelMap.set(rpid, level);
        });
    };
    ...
    var CommentFilterCommon = class {
        ...
        async checkRoot(mode) {
            ...
            this.commentBotFilter.isEnable && forceBlackPairs.push([this.commentBotFilter, selectorFns$10.root.username]);
            const rootBlackIdxSet = await coreCheck(rootComments, true, "style", blackPairs, whitePairs, forceBlackPairs, true);
            const time = (performance.now() - timer).toFixed(1);
            logger.debug(`CommentFilterCommon hide ${rootBlackIdxSet.size} in ${rootComments.length} root comments, mode=${mode}, time=${time}`);
        }
        async checkSub(mode) {
            const timer = performance.now();
            if (mode === "full") commentRpidLevelMap.clear();
            let revertAll = false;
            if (!(this.commentUsernameFilter.isEnable || this.commentUsernameKeywordFilter.isEnable || this.commentContentFilter.isEnable || this.commentAdFilter.isEnable || this.commentLevelFilter.isEnable || this.commentNoFaceFilter.isEnable || this.commentBotFilter.isEnable || this.commentCallBotFilter.isEnable || this.commentCallUserFilter.isEnable || this.commentCallUserNoReplyFilter.isEnable || this.commentCallUserOnlyFilter.isEnable || this.commentCallUserOnlyNoReplyFilter.isEnable || this.commentEmojiOnlyFilter.isEnable || this.commentChainFilter.isEnable)) revertAll = true;
            let subComments = [];
            ...
            const subBlackIdxSet = await coreCheck(subComments, false, "style", blackPairs, whitePairs, forceBlackPairs, true);
            updateCommentRpidLevelMap(subComments, subBlackIdxSet, true);
            let chainBlackIdxSet = new Set();
            if (this.commentChainFilter.isEnable && this.commentChainLevel > 0)
                for (let round = 1; round <= this.commentChainLevel; round++) {
                    const chainBlackPairs = [...blackPairs, [this.commentChainFilter, selectorFns$10.sub.isReplyToFiltered]];
                    chainBlackIdxSet = await coreCheck(subComments, false, "style", chainBlackPairs, whitePairs, forceBlackPairs, true);
                    updateCommentRpidLevelMap(subComments, chainBlackIdxSet, false);
                }
            const time = (performance.now() - timer).toFixed(1);
            logger.debug(`CommentFilterCommon hide ${new Set([...subBlackIdxSet, ...chainBlackIdxSet]).size} in ${subComments.length} sub comments, mode=${mode}, time=${time}`);
        }
        check(mode) {
    ...
    var commentFilterCommonGroups = [{
        ...
        },
        {
            ...
            items: [{
                type: "switch",
                id: GM_KEYS$10.black.chain.statusKey,
                name: "启用 链式过滤（实验功能）",
                description: [
                    "连坐机制，回复评论一并被过滤",
                    "只对二级评论生效",
                ...
                noStyle: true,
                enableFn: () => {
                    mainFilter$10.commentChainFilter.enable();
                    mainFilter$10.check("full");
                },
                disableFn: () => {
                    mainFilter$10.commentChainFilter.disable();
                    mainFilter$10.check("full");
                }
            }, {
                type: "number",
                id: GM_KEYS$10.black.chain.valueKey,
                noStyle: true,
                name: "设定 连坐层级 (0~10)",
                minValue: 0,
                maxValue: 10,
                ...
                disableValue: 0,
                fn: (value) => {
                    mainFilter$10.commentChainLevel = Math.min(10, Math.max(0, value));
    ...
    var commentFilterCommonHandler = (target) => {
        if (!(isPageVideo() || isPagePlaylist() || isPageBangumi() || isPageDynamic() || isPageSpace() || isPageFestival())) return [];
        const menus = [];
...
.dyn-card-opus__summary span
    ...
    var DynamicFilterDynamic = class {
        ...
        async check(mode) {
            ...
            const time = (performance.now() - timer).toFixed(1);
            logger.debug(`DynamicFilterDynamic hide ${blackIdxSet.size} in ${filteredDyns.length} dyns, mode=${mode}, time=${time}`);
        }
        checkFull() {
...
.dyn-card-opus__summary span
    ...
    var DynamicFilterSpace = class {
        ...
        async check(mode) {
            ...
            const blackIdxSet = await coreCheck(filteredDyns, true, "sign", blackPairs, whitePairs);
            const time = (performance.now() - timer).toFixed(1);
            logger.debug(`DynamicFilterSpace hide ${blackIdxSet.size} in ${filteredDyns.length} dyns, mode=${mode}, time=${time}`);
        }
        checkFull() {
            this.check("full").catch((err) => {
    ...
    var VideoRelativityFilter = class extends NumberMinFilter {};
    ...
    var VideoFilterChannel = class {
        ...
        async check(mode) {
            ...
            const time = (performance.now() - timer).toFixed(1);
            logger.debug(`VideoFilterChannel hide ${blackIdxSet.size} in ${videos.length} videos, mode=${mode}, time=${time}`);
        }
        checkFull() {
            this.check("full").catch((err) => {
    ...
    var VideoFilterHomepage = class {
        ...
        async check(mode) {
            ...
            const blackIdxSet = await coreCheck(videos, true, "sign", blackPairs, whitePairs, forceBlackPairs);
            const time = (performance.now() - timer).toFixed(1);
            logger.debug(`VideoFilterHomepage hide ${blackIdxSet.size} in ${videos.length} videos, mode=${mode}, time=${time}`);
        }
        checkFull() {
            this.check("full").catch((err) => {
    ...
    var VideoFilterPopular = class {
        ...
        async check(mode) {
            ...
            const blackIdxSet = await coreCheck(videos, true, "sign", blackPairs, whitePairs, forceBlackPairs);
            const time = (performance.now() - timer).toFixed(1);
            logger.debug(`VideoFilterPopular hide ${blackIdxSet.size} in ${videos.length} videos, mode=${mode}, time=${time}`);
        }
        checkFull() {
            this.check("full").catch((err) => {
    ...
    var toRelativityItem = (data) => {
        if (typeof data?.bvid !== "string" || !data.bvid) return;
        return {
            title: typeof data.title === "string" ? data.title.replace(/<[^>]+>/g, "") : "",
    ...
    var relativityMap = new Map();
    var relativityHookEnabled = false;
    var relativityHookRegistered = false;
    var registerRelativityFetchHook = () => {
        if (relativityHookRegistered) return;
        relativityHookRegistered = true;
        fetchHook.addPostFn(async (input, init, resp) => {
            if (!relativityHookEnabled) return;
            try {
                const url = typeof input === "string" ? input : input instanceof URL ? input.href : input.url;
                if ((init?.method ?? "GET").toUpperCase() !== "GET" || !url.includes("api.bilibili.com") || !url.includes("/search/type")) return;
                if (new URL(url, location.origin).searchParams.get("search_type") !== "video") return;
                const result = (await resp?.clone().json())?.data?.result;
                if (!Array.isArray(result)) return;
                result.forEach((item) => {
                    const relativityItem = toRelativityItem(item);
                    if (relativityItem) relativityMap.set(item.bvid, relativityItem);
                });
    ...
    var getFirstPageVideoItem = (bvid) => {
        const result = _unsafeWindow.__pinia?.searchResponse?.searchAllResponse?.result;
        if (!Array.isArray(result)) return;
        for (let i = result.length - 1; i >= 0; i--) {
            const data = result[i]?.data;
            if (result[i]?.result_type === "video" && Array.isArray(data)) return data.find((item) => item?.bvid === bvid);
        }
    };
    var getCardVideoItem = (video) => {
        const info = video.querySelector(".bili-video-card")?.__VUE__?.[0]?.props?.info;
    ...
    var selectorFns$3 = {
        ...
        relativity: (video) => {
            if (video.closest(".user-list")) return;
            const keyword = new URLSearchParams(location.search).get("keyword")?.trim();
            const bvid = selectorFns$3.bvid(video);
            if (!keyword || typeof bvid !== "string") return;
            const data = relativityMap.get(bvid) ?? toRelativityItem(getFirstPageVideoItem(bvid)) ?? getCardVideoItem(video);
            if (!data) return;
            const relativity = calcVideoRelativity(keyword, data.title, data.description, data.author, data.tag.split(",").filter(Boolean), data.hit_columns);
            return relativity === void 0 ? void 0 : relativity * 100;
        },
        uploader: (video) => {
    ...
    var VideoFilterSearch = class {
        ...
        async check(mode) {
            if (!this.target) return;
            let revertAll = false;
            if (!(this.videoBvidFilter.isEnable || this.videoDurationFilter.isEnable || this.videoTitleFilter.isEnable || this.videoUploaderFilter.isEnable || this.videoUploaderKeywordFilter.isEnable || this.videoRelativityFilter.isEnable)) revertAll = true;
            const timer = performance.now();
            ...
            if (config_default.isDebugMode) videos.forEach((v) => {
                logger.debug([
                    ...
                    `relativity: ${selectorFns$3.relativity(v)}`
                ].join("\n"));
            });
            const blackPairs = [];
            ...
            this.videoRelativityFilter.isEnable && blackPairs.push([this.videoRelativityFilter, selectorFns$3.relativity]);
            const whitePairs = [];
            ...
            const blackIdxSet = await coreCheck(videos, true, "sign", blackPairs, whitePairs, forceBlackPairs);
            const time = (performance.now() - timer).toFixed(1);
            logger.debug(`VideoFilterSearch hide ${blackIdxSet.size} in ${videos.length} videos, mode=${mode}, time=${time}`);
        }
    ...
    var videoFilterSearchGroups = [{
            ...
            items: [{
                type: "switch",
                id: GM_KEYS$3.black.relativity.statusKey,
                name: "启用 相关性过滤（实验功能）",
                description: [
                    "不稳定功能，刷新生效",
                    "保留搜索命中项，未命中时按相似度筛查",
                ...
                noStyle: true,
                enableFn: () => {
                    relativityHookEnabled = true;
                    registerRelativityFetchHook();
                    mainFilter$3.videoRelativityFilter.enable();
                    mainFilter$3.checkFull();
                },
                disableFn: () => {
                    relativityHookEnabled = false;
                    relativityMap.clear();
                    mainFilter$3.videoRelativityFilter.disable();
                    mainFilter$3.checkFull();
                }
            }, {
                type: "number",
                id: GM_KEYS$3.black.relativity.valueKey,
                name: "相关度阈值百分比",
                ...
                addonText: "%",
                fn: (value) => {
                    mainFilter$3.videoRelativityFilter.setParam(value);
                    mainFilter$3.checkFull();
                }
            }]
        },
    ...
    var VideoFilterSpace = class {
        ...
        async check(mode) {
            ...
            const blackIdxSet = await coreCheck(videos, true, "sign", blackPairs, whitePairs, forceBlackPairs);
            const time = (performance.now() - timer).toFixed(1);
            logger.debug(`VideoFilterSpace hide ${blackIdxSet.size} in ${videos.length} videos, mode=${mode}, time=${time}`);
        }
        checkFull() {
            this.check("full").catch((err) => {
...
.rec-list :is(.video-page-card-small, .video-page-operator-card-small), .recommend-video-card`));
    ...
    var commentFilters = [{
        ...
        checkFn: () => isPageVideo() || isPageBangumi() || isPagePlaylist() || isPageDynamic() || isPageSpace() || isPageFestival()
    }];
    var dynamicFilters = [{
            name: "动态页 动态过滤",
    ...
    var useCommentFilterPanelStore = defineStore("CommentFilterPanel", () => {
        ...
        const isPageValid = () => {
            return isPageVideo() || isPageBangumi() || isPageDynamic() || isPageSpace() || isPagePlaylist() || isPageFestival();
        };
        return {
            isShow,
            show,
    ...
    var CommentFilterPanelView_default = (0, vue.defineComponent)({
        ...
        setup(__props) {
            ...
            for (const commentFilter of commentFilters)
                if (commentFilter.checkFn()) currPageGroups = [...currPageGroups, ...commentFilter.groups];
            return (_ctx, _cache) => {
                return (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(PanelComp_default, (0, vue.mergeProps)({
                    ...
                    default: (0, vue.withCtx)(() => [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)((0, vue.unref)(currPageGroups), (group, index) => {
                        return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
                            key: index
                        }, [(0, vue.createVNode)(DisclosureComp_default, (0, vue.mergeProps)({
                            ref_for: true
                        }, {
                            title: group.name,
                            isFold: group.fold
                            ...
                            default: (0, vue.withCtx)(() => [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(group.items, (item, innerIndex) => {
                                return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
                                    ...
                                    onEdit: handleEdit
                                }), null, 16)) : item.type === "list" ? ((0, vue.openBlock)(), (0, vue.createBlock)(ListComp_default, (0, vue.mergeProps)({
                                    key: 4,
                                    ref_for: true
                    ...
                    [vue.vShow, (0, vue.unref)(store).isShow]
                ]);
            };
        }
    });
            ...
            return (_ctx, _cache) => {
                return show.value ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
                    ...
                    return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
                        ...
                        class: "mr-0.5"
                    }, "◎", -1)), (0, vue.createTextVNode)(" " + (0, vue.toDisplayString)(menu.name), 1)], 8, _hoisted_1$2), index < menuList.value.length - 1 ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("hr", _hoisted_2$1)) : (0, vue.createCommentVNode)("", true)]);
    ...
    var DynamicFilterPanelView_default = (0, vue.defineComponent)({
        ...
        setup(__props) {
            ...
            for (const dynamicFilter of dynamicFilters)
                if (dynamicFilter.checkFn()) currPageGroups = [...currPageGroups, ...dynamicFilter.groups];
            return (_ctx, _cache) => {
                return (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(PanelComp_default, (0, vue.mergeProps)({
                    title: "动态过滤",
                    widthPercent: 28,
    ...
    var handleKeyFPress$1 = (e) => {
        if (e.key.toLocaleLowerCase() !== "f" || e.ctrlKey || e.altKey || e.metaKey) return;
        ...
        },
        {
            ...
            items: [{
                ...
                },
                {
                    ...
                    enableFn: () => {
                        window.addEventListener("keydown", handleKeyFPress$1, true);
                    },
                    disableFn: () => {
                        window.removeEventListener("keydown", handleKeyFPress$1, true);
                    }
                },
                {
                    type: "switch",
            ...
            items: [{
                ...
                },
                {
                    ...
                    enableFn: async () => {
                        ...
                        if (isRcmdHide$1) return;
                        isRcmdHide$1 = true;
                        let cnt = 0;
                        const id = setInterval(() => {
                            const inputEl = document.querySelector("input.nav-search-input");
                            const btnEl = document.querySelector(".nav-search-btn");
                            if (inputEl && btnEl) {
                                clearInterval(id);
                                inputEl.placeholder = "";
                                inputEl.title = "";
...
.right-entry__main .favorite-entry`);
                            ...
                            if (anchor) {
                                ...
                                window.addEventListener("scroll", function() {
                                    ...
                                    if (scrollTop > lastScrollTop) {
                                        if (innerHeight - anchor.getBoundingClientRect().top > -innerHeight * .75 && !isPreload) {
                ...
                observer = new MutationObserver((mutations) => {
                    for (const mutation of mutations)
                        for (const node of mutation.addedNodes)
                            if (node instanceof HTMLStyleElement && node.id === "skin-css") node.disabled = true;
                });
                waitForHead().then(() => {
    ...
    var isRcmdHide = false;
    var liveHeaderCenterItems = [{
            type: "switch",
        ...
        },
        {
            ...
            enableFn: async () => {
                if (!isPageLive()) return;
                if (isRcmdHide) return;
                isRcmdHide = true;
                let cnt = 0;
                const id = setInterval(() => {
                    const inputEl = document.querySelector(".search-bar .nav-search-content");
                    const btnEl = document.querySelector(".search-bar .search-btn");
                    if (inputEl && btnEl) {
                        clearInterval(id);
                        inputEl.placeholder = "";
                        inputEl.title = "";
    ...
    var handleKeyGPress = (e) => {
        if (e.key.toLocaleLowerCase() !== "g" || e.ctrlKey || e.altKey || e.metaKey) return;
        if (isEditableEvent(e)) return;
        e.stopImmediatePropagation();
        e.preventDefault();
    };
    ...
    var rules = [{
        ...
        },
        {
            ...
            isSpecial: true,
            checkFn: () => isPageVideo() || isPageBangumi() || isPageDynamic() || isPageSpace() || isPagePlaylist() || isPageFestival()
        },
        {
            name: "common",
            groups: commonGroups,
    ...
    var loadRuleStyle = () => {
        for (const rule of rules)
            if (rule.checkFn() && rule.style) try {
    ...
    var RulePanelView_default = (0, vue.defineComponent)({
        ...
        setup(__props) {
            ...
            const currRules = [];
            for (const rule of rules)
                if (rule.checkFn()) currRules.push(rule);
            return (_ctx, _cache) => {
                return (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(PanelComp_default, (0, vue.mergeProps)({
                    ...
                    default: (0, vue.withCtx)(() => [((0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(currRules, (rule, i) => {
                        return (0, vue.createElementVNode)("div", {
                            key: i
                        }, [((0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(rule.groups, (group, j) => {
                            return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", {
                                key: j
                            }, [(0, vue.createVNode)(DisclosureComp_default, (0, vue.mergeProps)({
                                ref_for: true
    ...
    var ArticleFilterPanelView_default = (0, vue.defineComponent)({
        ...
        setup(__props) {
            ...
            for (const articleFilter of articleFilters)
                if (articleFilter.checkFn()) currPageGroups = [...currPageGroups, ...articleFilter.groups];
            return (_ctx, _cache) => {
                return (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(PanelComp_default, (0, vue.mergeProps)({
                    title: "专栏过滤",
                    widthPercent: 28,
    ...
    var _hoisted_2 = {
        class: "text-center text-[13px] leading-4 select-none"
    };
    var _hoisted_3 = {
        class: "text-center text-[13px] leading-4 select-none"
    };
    ...
    var VideoFilterPanelView_default = (0, vue.defineComponent)({
        ...
        setup(__props) {
            ...
            for (const videoFilter of videoFilters)
                if (videoFilter.checkFn()) currPageGroups = [...currPageGroups, ...videoFilter.groups];
            return (_ctx, _cache) => {
                return (0, vue.withDirectives)(((0, vue.openBlock)(), (0, vue.createBlock)(PanelComp_default, (0, vue.mergeProps)({
                    title: "视频过滤",
                    widthPercent: 28,
        ...
        for (const rule of rules)
            if (rule.checkFn())
                for (const group of rule.groups)
                    for (const item of group.items) try {
                        switch (item.type) {
                            case "switch":
                                loadSwitchItem(item);
                                break;
    ...
    var loadFilters = () => {
        ...
        for (const filter of filters)
            if (filter.checkFn()) try {
                filter.entry();
                for (const group of filter.groups)
                    for (const item of group.items) switch (item.type) {
                        case "switch":
                            loadSwitchItem(item);
                            break;
                        case "number":
            ...
            useMagicKeys({
                ...
                onEventFired(e) {
                    if (e.type === "keydown" && e.altKey && e.key.toLocaleLowerCase() === "b") {
                        e.preventDefault();
                        document.querySelectorAll("style.bili-cleaner-css").forEach((node) => node.disabled = !node.disabled);
                    }
                }
            });
        } catch (err) {
    ...
    var redirect = () => {
        if (location.host === "www.bilibili.com" && location.pathname === "/index.html") window.location.replace("https://www.bilibili.com/");
    };
    var main = () => {
