...
(function() {
    ...
    // 默认开启
    let hideGiftBar = GM_getValue(CONFIG_KEY_GIFT_BAR, true);
...
#player-wrap [class*="Speaker"]:not([class*="ChatSpeaker"]), #player-wrap [class*="speaker"]:not(#J_RoomChatSpeaker):not([class*="ChatSpeaker"]),
.room-player-wrap [class*="Speaker"]:not([class*="ChatSpeaker"]), .room-player-wrap [class*="speaker"]:not(#J_RoomChatSpeaker):not([class*="ChatSpeaker"]),
...
/* 保护弹幕输入框容器不被误伤 */
#J_RoomChatSpeaker, [class*="ChatSpeaker"], #pub_msg_input {
...
<span style="color:#ff8800; font-size:16px;">🐅</span> 虎牙纯净版设置
</span>
