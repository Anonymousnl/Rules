...
(() => {
    ...
    var ConfigManager = class {
        constructor() {
            ...
            this.sessionButtonStates = {
                ...this.defaultButtonStates
            };
            this.config = {
                skipLive: {
                    enabled: this.getDefaultEnabledState("skipLive"),
                    key: "skipLive"
                },
                autoHighRes: {
                    enabled: this.getDefaultEnabledState("autoHighRes"),
                    key: "autoHighRes"
                },
                autoCleanScreen: {
                ...
                skipAd: {
                    enabled: this.getDefaultEnabledState("skipAd"),
                    key: "skipAd"
                },
                onlyResolution: {
...
`;
        ...
        getDefaultToggleRowHtml(item, currentState) {
            const {
                visible,
                enabled
            } = this.parseDefaultToggleState(currentState || "disabled");
...
`;
        ...
        renderSummaryCards(summary) {
            const items = [{
                ...
                {
                    label: "\u5237\u89C6\u9891\u65F6\u957F",
                    value: this.formatDuration(summary.watchTimeSec || 0)
                },
                {
                    label: "\u5E73\u5747\u6BCF\u6761\u65F6\u957F",
                    value: this.formatDuration(this.getAverageWatchTime(summary))
                },
                {
                    label: "\u8DF3\u8FC7\u76F4\u64AD",
                    value: summary.skipLiveCount || 0
                },
                {
                    label: "\u8DF3\u8FC7\u5E7F\u544A",
                    value: summary.skipAdCount || 0
                },
                {
                    label: "\u5173\u952E\u5B57\u5C4F\u853D",
                    value: summary.blockKeywordCount || 0
                },
                {
                    label: "AI\u70B9\u8D5E",
                    value: summary.aiLikeCount || 0
                },
                {
                    label: "\u6781\u901F\u8DF3\u8FC7",
                    value: summary.speedSkipCount || 0
                }
            ];
...
`;
        ...
        showAiPreferenceDialog() {
            ...
            const zhipuModels = [{
                    ...
                    label: "GLM-4.6V-Flash (\u514D\u8D39, \u9AD8\u5CF0\u671F\u4E0D\u7A33\u5B9A)"
                },
                {
                    value: "glm-4.6v-flashx",
                    label: "GLM-4.6V-FlashX (\u4ED8\u8D39,\u6BD4GLM-4.6V\u54CD\u5E94\u5FEB)"
                },
                {
                    value: "glm-4.6v",
                    label: "GLM-4.6V (\u4ED8\u8D39)"
            ...
            const response = await fetch("https://open.bigmodel.cn/api/paas/v4/chat/completions", {
                ...
                body: JSON.stringify({
                    ...
                    messages: [{
                        ...
                        content: [{
                                type: "text",
                                text: `\u8FD9\u662F${content}\u5417?\u56DE\u7B54\u300E\u662F\u300F\u6216\u8005\u300E\u4E0D\u662F\u300F,\u4E0D\u8981\u8BF4\u4EFB\u4F55\u591A\u4F59\u7684\u5B57\u7B26`
                            },
                            {
                                type: "image_url",
                                image_url: {
...
`;
        ...
        tryOpenQualityMenu(playerRoot) {
            ...
            plugin.dispatchEvent(new MouseEvent("mouseenter", {
                bubbles: true
            }));
            plugin.dispatchEvent(new MouseEvent("mouseover", {
                bubbles: true
            }));
