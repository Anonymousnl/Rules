const path1 = "\/2\/groups\/timeline";
const path2 = "\/2\/statuses\/unread";
const path3 = "\/2\/statuses\/extend";
const path4 = "\/2\/comments\/build_comments";
const path5 = "\/2\/photo\/recommend_list";
const path6 = "\/2\/stories\/video_stream";
const path7 = "\/2\/statuses\/positives\/get";
const path8 = "\/2\/stories\/home_list";
const path9 = "\/2\/profile\/statuses";
const path10 = "\/2\/statuses\/friends\/timeline";
const path11 = "\/2\/service\/picfeed";
const path12 = "\/2\/fangle\/timeline";
const path13 = "\/2\/searchall";
const path14 = "\/2\/cardlist";
const path15 = "\/2\/statuses\/video_timeline";
const path16 = "\/2\/page";
const path17 = "\/2\/statuses\/friends_timeline";
const path18 = "\/2\/!\/photos\/pic_recommend_status";
const path19 = "\/2\/statuses\/video_mixtimeline";
const path20 = "\/2\/video\/tiny_stream_video_list";
const path21 = "\/2\/photo\/info";
const path22 = "\/2\/!\/live\/media_homelist";
const path23 = "\/2\/!\/remind\/unread_count";
...
if (url.indexOf(path1) != -1 || url.indexOf(path2) != -1 || url.indexOf(path10) != -1 || url.indexOf(path15) != -1 || url.indexOf(path17) != -1 || url.indexOf(path20) != -1) {
    ...
    obj.data = [];
    body = JSON.stringify(obj);
} else if (url.indexOf(path9) != -1 ||url.indexOf(path12) != -1 ||url.indexOf(path13) != -1 ||url.indexOf(path14) != -1 ||url.indexOf(path16) != -1) {
    let obj = JSON.parse(body);
