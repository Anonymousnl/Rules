...
if(url.includes("/aos/perception/publicTravel/beforeNavi")) {
	...
	const items = ["CouponBanner", // 高德红包
		...
		"houseList", "houseOfficeBrandIntroduction", "houseOfficeInfo", "houseOfficeNotice", "houseOfficeService", "houseShelf", // 小区在售房源
		"house_apart_info", "house_buying_agent", "house_coupon", "house_cp_clues", "house_cpt_coupon", "house_cpt_grab", "house_price", "house_price_v2", // 小区房屋售价
		...
		// "realtorRealStep",
		"renthouse", "rentSaleHouse", // 小区买卖房屋
		"rentsaleagencyv2", "rentsaleagencyv3", "rentsalehouse", "residentialOwners", // 小区业主
		"reviews", // 用户评价
