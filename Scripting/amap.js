...
if(url.includes("/boss/car/order/content_info")) {
	...
	const items = [
		...
		// "DIYMap", // DIY地图
		// "GuiJi", // 轨迹
		"Naviendpage_Searchwords", "SplashScreenControl", "TipsTaxiButton",
		...
		// "hotcity", // 热门城市
		"hotel_activity", "hotel_fillin_opt", "hotel_loop", "hotel_portal", "hotel_tipsicon", "hotsaleConfig", // 酒店限时抢购
		// "icon_show",
		// "info_env_setting",
		// "ip_square",
		// "ip_square_share",
		...
		"navi_end", // 导航结束 领油滴
		// "nearby",
		"nearby_business_popup", "nearby_map_entry_guide", "nearby_map_pull_down_guide",
		// "newcommentreply",
		// "nore_rec",
		...
		"routeresult_banner", "search_homepage", "search_keyword", "search_moni", "search_perf", "search_poi_recommend", "search_service_adcode", "search_word", "small_biz_b2b_kb", // 入驻高德
		"small_biz_case", // 推广
	...
	const items = ["CouponBanner", // 高德红包
		...
		"image_banner", "legSameIndustryRecEntrance", // 全城最热景点推荐
		...
		"smallOrListBizRec", "surroundOldSellHouse", // 同城二手房
		"surroundRentHouse", // 附近租房
		"surround_facility", "surround_facility_new", "surround_house_tab", "surround_oldsellhouse", "surround_renthouse", "surround_rentoffice", "surround_selloffice",
