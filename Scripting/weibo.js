...
function removePhpScreenAds(e) {
	if(!e.ads) return e;
	for(let t of (e.show_push_splash_ad = !1, e.background_delay_display_time = 31536000, e.lastAdShow_delay_display_time = 31536000, e.realtime_ad_video_stall_time = 0, e.realtime_ad_timeout_duration = 0, e.ads)) t.displaytime = 0, t.displayintervel = 31536000, t.allowdaydisplaynum = 0, t.displaynum = 0, t.displaytime = 1, t.begintime = "2040-01-01 00:00:00", t.endtime = "2040-01-01 23:59:59";
	return e
}
